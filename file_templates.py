...
def get_meta_package_build_rs_text(package_name, package_details):
    """
    This function returns the contents of the build.rs file present in the meta_package_crate
    :param 1 : package_name(meta_package_crate name)
    :param 2 : package_details(meta_package_crate details)
    :return: build.rs content in the form of text
    """
    text="""
