...
def generate_meta_package_crate(package_name, package_details):
    ...
    check_call('cargo check --target=thumbv7em-none-eabihf --target=thumbv6m-none-eabi')
    check_call('cargo doc --target=thumbv7em-none-eabihf --target=thumbv6m-none-eabi --no-deps')
