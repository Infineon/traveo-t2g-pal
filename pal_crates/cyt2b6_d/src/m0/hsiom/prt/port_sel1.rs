...
#[doc = "Field `IO4_SEL` reader - Selects the peripheral connections of Pin 4. See PORT_SEL0 for connection details."]
pub type IO4_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `IO4_SEL` writer - Selects the peripheral connections of Pin 4. See PORT_SEL0 for connection details."]
pub type IO4_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PORT_SEL1_SPEC, u8, u8, 5, O>;
#[doc = "Field `IO5_SEL` reader - Selects the peripheral connections of Pin 4."]
pub type IO5_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `IO5_SEL` writer - Selects the peripheral connections of Pin 4."]
pub type IO5_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PORT_SEL1_SPEC, u8, u8, 5, O>;
#[doc = "Field `IO6_SEL` reader - Selects the peripheral connections of Pin 5."]
pub type IO6_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `IO6_SEL` writer - Selects the peripheral connections of Pin 5."]
pub type IO6_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PORT_SEL1_SPEC, u8, u8, 5, O>;
#[doc = "Field `IO7_SEL` reader - Selects the peripheral connections of Pin 6."]
pub type IO7_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `IO7_SEL` writer - Selects the peripheral connections of Pin 6."]
pub type IO7_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PORT_SEL1_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4 - Selects the peripheral connections of Pin 4. See PORT_SEL0 for connection details."]
    #[inline(always)]
    pub fn io4_sel(&self) -> IO4_SEL_R {
        IO4_SEL_R::new((self.bits & 0x1f) as u8)
    }
    #[doc = "Bits 8:12 - Selects the peripheral connections of Pin 4."]
    #[inline(always)]
    pub fn io5_sel(&self) -> IO5_SEL_R {
        IO5_SEL_R::new(((self.bits >> 8) & 0x1f) as u8)
    }
    #[doc = "Bits 16:20 - Selects the peripheral connections of Pin 5."]
    #[inline(always)]
    pub fn io6_sel(&self) -> IO6_SEL_R {
        IO6_SEL_R::new(((self.bits >> 16) & 0x1f) as u8)
    }
    #[doc = "Bits 24:28 - Selects the peripheral connections of Pin 6."]
    #[inline(always)]
