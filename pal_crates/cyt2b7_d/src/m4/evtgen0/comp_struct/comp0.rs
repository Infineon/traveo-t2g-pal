...
#[doc = "Field `INT32` reader - This value is a 32-bit unsigned integer in the range \\[0, 2^32-1\\]. The comparator 'comp0_out' output is activated when the Active counter 'counter_int\\[31:0\\]' becomes greater or equal to COMP0. Note: SW must ensure that COMP_CTL.COMP_EN\\[0\\]
is '0' when COMP0 is written."]
pub type INT32_R = crate::FieldReader<u32, u32>;
#[doc = "Field `INT32` writer - This value is a 32-bit unsigned integer in the range \\[0, 2^32-1\\]. The comparator 'comp0_out' output is activated when the Active counter 'counter_int\\[31:0\\]' becomes greater or equal to COMP0. Note: SW must ensure that COMP_CTL.COMP_EN\\[0\\]
is '0' when COMP0 is written."]
pub type INT32_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMP0_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - This value is a 32-bit unsigned integer in the range \\[0, 2^32-1\\]. The comparator 'comp0_out' output is activated when the Active counter 'counter_int\\[31:0\\]' becomes greater or equal to COMP0. Note: SW must ensure that COMP_CTL.COMP_EN\\[0\\]
is '0' when COMP0 is written."]
    #[inline(always)]
