...
pub type GROUP_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TR_CMD_SPEC, u8, u8, 5, O>;
...
pub type TR_EDGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TR_CMD_SPEC, bool, O>;
