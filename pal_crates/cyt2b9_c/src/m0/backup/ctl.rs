...
#[repr(u8)]
pub enum CLK_SEL_A {
    #[doc = "0: Watch-crystal oscillator input, available in Active, DeepSleep and Hibernate"]
    WCO = 0,
    ...
    ALTBAK = 1,
    #[doc = "2: Internal Low frequency Oscillator, available in Active, DeepSleep and Hibernate. For Hibernate operation CLK_ILO_CONFIG. ILO_BACKUP must be set."]
    ILO = 2,
    #[doc = "3: N/A"]
    RSVD = 3,
}
...
impl<'a, const O: u8> CLK_SEL_W<'a, O> {
    #[doc = "Watch-crystal oscillator input, available in Active, DeepSleep and Hibernate"]
    #[inline(always)]
    ...
    #[doc = "Internal Low frequency Oscillator, available in Active, DeepSleep and Hibernate. For Hibernate operation CLK_ILO_CONFIG. ILO_BACKUP must be set."]
    #[inline(always)]
