...
#[doc = "Field `INTR_MASK` reader - Mask for corresponding field in the INTR register"]
pub type INTR_MASK_R = crate::BitReader<bool>;
#[doc = "Field `INTR_MASK` writer - Mask for corresponding field in the INTR register"]
pub type INTR_MASK_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - Mask for corresponding field in the INTR register"]
    #[inline(always)]
    pub fn intr_mask(&self) -> INTR_MASK_R {
        INTR_MASK_R::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Mask for corresponding field in the INTR register"]
    #[inline(always)]
    #[must_use]
    pub fn intr_mask(&mut self) -> INTR_MASK_W<0> {
        INTR_MASK_W::new(self)
    }
