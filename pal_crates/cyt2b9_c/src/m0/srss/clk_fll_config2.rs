...
pub type LOCK_TOL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LOCK_TOL` writer - Lock tolerance sets the error threshold for when the FLL output is considered locked to the reference input. A high tolerance can be used to lock more quickly or allow less accuracy. The tolerance is the allowed difference between the count value for the ideal formula and the measured value. 0: tolerate error of 1 count value 1: tolerate error of 2 count values ... 255: tolerate error of 256 count values"]
pub type LOCK_TOL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLK_FLL_CONFIG2_SPEC, u8, u8, 8, O>;
#[doc = "Field `UPDATE_TOL` reader - Update tolerance sets the error threshold for when the FLL will update the CCO frequency settings. The update tolerance is the allowed difference between the count value for the ideal formula and the measured value. UPDATE_TOL should be less than LOCK_TOL."]
pub type UPDATE_TOL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `UPDATE_TOL` writer - Update tolerance sets the error threshold for when the FLL will update the CCO frequency settings. The update tolerance is the allowed difference between the count value for the ideal formula and the measured value. UPDATE_TOL should be less than LOCK_TOL."]
pub type UPDATE_TOL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLK_FLL_CONFIG2_SPEC, u8, u8, 8, O>;
impl R {
    ...
    #[doc = "Bits 16:23 - Lock tolerance sets the error threshold for when the FLL output is considered locked to the reference input. A high tolerance can be used to lock more quickly or allow less accuracy. The tolerance is the allowed difference between the count value for the ideal formula and the measured value. 0: tolerate error of 1 count value 1: tolerate error of 2 count values ... 255: tolerate error of 256 count values"]
    #[inline(always)]
    pub fn lock_tol(&self) -> LOCK_TOL_R {
        LOCK_TOL_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - Update tolerance sets the error threshold for when the FLL will update the CCO frequency settings. The update tolerance is the allowed difference between the count value for the ideal formula and the measured value. UPDATE_TOL should be less than LOCK_TOL."]
    #[inline(always)]
    pub fn update_tol(&self) -> UPDATE_TOL_R {
        UPDATE_TOL_R::new(((self.bits >> 24) & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bits 0:12 - Control bits for reference divider. Set the divide value before enabling the FLL, and do not change it while FLL is enabled. 0: illegal (undefined behavior) 1: divide by 1 ... 8191: divide by 8191"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn update_tol(&mut self) -> UPDATE_TOL_W<24> {
        UPDATE_TOL_W::new(self)
    }
