...
#[doc = "Field `TIMER_SEL` reader - Select source for TIMERCLK. The output of this mux can be further divided using TIMER_DIV. It takes four cycles of the originally selected clock to switch away from it. Do not disable the original clock during this time."]
pub type TIMER_SEL_R = crate::BitReader<TIMER_SEL_A>;
#[doc = "Select source for TIMERCLK. The output of this mux can be further divided using TIMER_DIV. It takes four cycles of the originally selected clock to switch away from it. Do not disable the original clock during this time.\n\nValue on reset: 0"]
...
#[doc = "Field `TIMER_SEL` writer - Select source for TIMERCLK. The output of this mux can be further divided using TIMER_DIV. It takes four cycles of the originally selected clock to switch away from it. Do not disable the original clock during this time."]
...
impl R {
    #[doc = "Bit 0 - Select source for TIMERCLK. The output of this mux can be further divided using TIMER_DIV. It takes four cycles of the originally selected clock to switch away from it. Do not disable the original clock during this time."]
    #[inline(always)]
