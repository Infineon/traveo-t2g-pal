...
#[doc = "Field `UPPER_LIMIT` reader - Upper limit for this MCWDT subcounter. See UPPER_ACTION."]
pub type UPPER_LIMIT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `UPPER_LIMIT` writer - Upper limit for this MCWDT subcounter. See UPPER_ACTION."]
pub type UPPER_LIMIT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, UPPER_LIMIT_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Upper limit for this MCWDT subcounter. See UPPER_ACTION."]
    #[inline(always)]
    pub fn upper_limit(&self) -> UPPER_LIMIT_R {
        UPPER_LIMIT_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Upper limit for this MCWDT subcounter. See UPPER_ACTION."]
...
#[doc = "`reset()` method sets UPPER_LIMIT to value 0"]
