...
#[doc = "Field `EINT0` reader - Enable Interrupt Line 0 0= Interrupt line m_ttcan_int0 disabled 1= Interrupt line m_ttcan_int0 enabled"]
pub type EINT0_R = crate::BitReader<bool>;
#[doc = "Field `EINT0` writer - Enable Interrupt Line 0 0= Interrupt line m_ttcan_int0 disabled 1= Interrupt line m_ttcan_int0 enabled"]
pub type EINT0_W<'a, const O: u8> = crate::BitWriter<'a, u32, ILE_SPEC, bool, O>;
#[doc = "Field `EINT1` reader - Enable Interrupt Line 1 0= Interrupt line m_ttcan_int1 disabled 1= Interrupt line m_ttcan_int1 enabled"]
pub type EINT1_R = crate::BitReader<bool>;
#[doc = "Field `EINT1` writer - Enable Interrupt Line 1 0= Interrupt line m_ttcan_int1 disabled 1= Interrupt line m_ttcan_int1 enabled"]
pub type EINT1_W<'a, const O: u8> = crate::BitWriter<'a, u32, ILE_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - Enable Interrupt Line 0 0= Interrupt line m_ttcan_int0 disabled 1= Interrupt line m_ttcan_int0 enabled"]
    #[inline(always)]
    pub fn eint0(&self) -> EINT0_R {
        EINT0_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Enable Interrupt Line 1 0= Interrupt line m_ttcan_int1 disabled 1= Interrupt line m_ttcan_int1 enabled"]
    #[inline(always)]
