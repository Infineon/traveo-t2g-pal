...
pub struct RegisterBlock {
    ...
    #[doc = "0x28 - SPI transmitter control"]
    pub spi_tx_ctrl: SPI_TX_CTRL,
    #[doc = "0x2c - SPI receiver control"]
...
#[doc = "SPI status"]
pub mod spi_status;
#[doc = "SPI_TX_CTRL (rw) register accessor: an alias for `Reg<SPI_TX_CTRL_SPEC>`"]
pub type SPI_TX_CTRL = crate::Reg<spi_tx_ctrl::SPI_TX_CTRL_SPEC>;
#[doc = "SPI transmitter control"]
pub mod spi_tx_ctrl;
#[doc = "SPI_RX_CTRL (rw) register accessor: an alias for `Reg<SPI_RX_CTRL_SPEC>`"]
pub type SPI_RX_CTRL = crate::Reg<spi_rx_ctrl::SPI_RX_CTRL_SPEC>;
