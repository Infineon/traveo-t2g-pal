...
pub type TC_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, O>;
#[doc = "Field `CC0_MATCH` reader - Write with '1' to set corresponding bit in interrupt request register."]
pub type CC0_MATCH_R = crate::BitReader<bool>;
#[doc = "Field `CC0_MATCH` writer - Write with '1' to set corresponding bit in interrupt request register."]
pub type CC0_MATCH_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, O>;
#[doc = "Field `CC1_MATCH` reader - Write with '1' to set corresponding bit in interrupt request register."]
pub type CC1_MATCH_R = crate::BitReader<bool>;
#[doc = "Field `CC1_MATCH` writer - Write with '1' to set corresponding bit in interrupt request register."]
pub type CC1_MATCH_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, O>;
impl R {
