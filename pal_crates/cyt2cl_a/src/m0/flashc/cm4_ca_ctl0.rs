...
pub type RAM_ECC_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CM4_CA_CTL0_SPEC, bool, O>;
...
pub type RAM_ECC_INJ_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CM4_CA_CTL0_SPEC, bool, O>;
#[doc = "Field `WAY` reader - Specifies the cache way for which cache information is provided in CM4_CA_STATUS0/1/2."]
pub type WAY_R = crate::FieldReader<u8, u8>;
#[doc = "Field `WAY` writer - Specifies the cache way for which cache information is provided in CM4_CA_STATUS0/1/2."]
pub type WAY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CM4_CA_CTL0_SPEC, u8, u8, 2, O>;
#[doc = "Field `SET_ADDR` reader - Specifies the cache set for which cache information is provided in CM4_CA_STATUS0/1/2."]
pub type SET_ADDR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SET_ADDR` writer - Specifies the cache set for which cache information is provided in CM4_CA_STATUS0/1/2."]
...
pub type CA_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CM4_CA_CTL0_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bits 16:17 - Specifies the cache way for which cache information is provided in CM4_CA_STATUS0/1/2."]
    #[inline(always)]
    pub fn way(&self) -> WAY_R {
        WAY_R::new(((self.bits >> 16) & 3) as u8)
    }
    #[doc = "Bits 24:26 - Specifies the cache set for which cache information is provided in CM4_CA_STATUS0/1/2."]
    #[inline(always)]
