...
#[doc = "Field `AUTO_DEACTIVATE` reader - Specifies behavior when 'fade out' has completed: '0': Destination does NOT get deactivated. '1': Destination gets deactivated; i.e. HW clears DST_FIFO_CTL.ACTIVE to '0'."]
pub type AUTO_DEACTIVATE_R = crate::BitReader<bool>;
#[doc = "Field `AUTO_DEACTIVATE` writer - Specifies behavior when 'fade out' has completed: '0': Destination does NOT get deactivated. '1': Destination gets deactivated; i.e. HW clears DST_FIFO_CTL.ACTIVE to '0'."]
...
#[doc = "Field `PACE` writer - Specifies the pace/speed of 'fade in' and 'fade out': '0': The same CODE value is used (0+1) times. '1': The same CODE value is used (1+1) times. ... '1023': The same CODE value is used (1023+1) times. A fade in from 'mute' to 0 dB takes 1024*116 = 118,784 PCM samples. At a PCM sample frequency Fs of 48 kHz, this translates into 118,784/48,000 = 2.474 seconds."]
pub type PACE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DST_FADE_CMD_SPEC, u16, u16, 10, O>;
impl R {
    ...
    #[doc = "Bit 8 - Specifies behavior when 'fade out' has completed: '0': Destination does NOT get deactivated. '1': Destination gets deactivated; i.e. HW clears DST_FIFO_CTL.ACTIVE to '0'."]
    #[inline(always)]
