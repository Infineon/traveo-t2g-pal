...
#[doc = "Field `SAMPLE_TIME` reader - Sample time (aperture) in ADC clock cycles. Minimum is 1 (0 gives the same result as 1), minimum time needed for proper settling is at least 300ns, i.e. 6 clock cycles at the max frequency of 20MHz."]
pub type SAMPLE_TIME_R = crate::FieldReader<u16, u16>;
#[doc = "Field `SAMPLE_TIME` writer - Sample time (aperture) in ADC clock cycles. Minimum is 1 (0 gives the same result as 1), minimum time needed for proper settling is at least 300ns, i.e. 6 clock cycles at the max frequency of 20MHz."]
...
impl R {
    ...
    #[doc = "Bits 16:27 - Sample time (aperture) in ADC clock cycles. Minimum is 1 (0 gives the same result as 1), minimum time needed for proper settling is at least 300ns, i.e. 6 clock cycles at the max frequency of 20MHz."]
    #[inline(always)]
