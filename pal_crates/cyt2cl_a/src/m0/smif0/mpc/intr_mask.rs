...
#[doc = "Field `VIOLATION` reader - Mask for corresponding field in INTR register."]
pub type VIOLATION_R = crate::BitReader<bool>;
#[doc = "Field `VIOLATION` writer - Mask for corresponding field in INTR register."]
pub type VIOLATION_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
impl R {
