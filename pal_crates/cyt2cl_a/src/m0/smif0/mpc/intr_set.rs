...
#[doc = "Field `VIOLATION` reader - SW write this field with '1' to set INTR register (a write of '0' has no effect)."]
pub type VIOLATION_R = crate::BitReader<bool>;
#[doc = "Field `VIOLATION` writer - SW write this field with '1' to set INTR register (a write of '0' has no effect)."]
pub type VIOLATION_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - SW write this field with '1' to set INTR register (a write of '0' has no effect)."]
    #[inline(always)]
