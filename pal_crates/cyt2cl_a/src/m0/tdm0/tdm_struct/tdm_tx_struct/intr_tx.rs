...
#[doc = "Field `FIFO_OVERFLOW` reader - HW sets this field to '1', when writing to a full TX FIFO (TX_FIFO_STATUS.USED is '128')."]
pub type FIFO_OVERFLOW_R = crate::BitReader<bool>;
#[doc = "Field `FIFO_OVERFLOW` writer - HW sets this field to '1', when writing to a full TX FIFO (TX_FIFO_STATUS.USED is '128')."]
pub type FIFO_OVERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_TX_SPEC, bool, O>;
#[doc = "Field `FIFO_UNDERFLOW` reader - HW sets this field to '1', when reading from an (almost) empty TX FIFO (TX_FIFO_STATUS.USED &lt; 'number of enabled channels per frame'). This is referred to as an underflow event. Note: HW ensures that either all or none of the frame's channels are transmitted. In a TX FIFO underflow situation, HW replays previous PCM data or uses a constant PCM data value of '0'."]
...
impl R {
    ...
    #[doc = "Bit 1 - HW sets this field to '1', when writing to a full TX FIFO (TX_FIFO_STATUS.USED is '128')."]
    #[inline(always)]
