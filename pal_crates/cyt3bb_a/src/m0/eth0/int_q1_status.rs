#[doc = "Register `INT_Q1_STATUS` reader"]
pub struct R(crate::R<INT_Q1_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INT_Q1_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INT_Q1_STATUS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INT_Q1_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Field `AMBA_ERROR` reader - Transmit frame corruption due to AMBA (AXI/AHB) error set if an error occurs whilst midway through reading transmit frame from the external memory, including HRESP (AHB), RRESP and BRESP errors (AXI) and buffers exhausted mid frame"]
...
impl R {
    ...
    #[doc = "Bit 6 - Transmit frame corruption due to AMBA (AXI/AHB) error set if an error occurs whilst midway through reading transmit frame from the external memory, including HRESP (AHB), RRESP and BRESP errors (AXI) and buffers exhausted mid frame"]
    #[inline(always)]
...
pub struct INT_Q1_STATUS_SPEC;
impl crate::RegisterSpec for INT_Q1_STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [int_q1_status::R](R) reader structure"]
impl crate::Readable for INT_Q1_STATUS_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets INT_Q1_STATUS to value 0"]
impl crate::Resettable for INT_Q1_STATUS_SPEC {
