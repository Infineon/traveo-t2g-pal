#[doc = "Register `SCREENING_TYPE_1_REGISTER_8` reader"]
pub struct R(crate::R<SCREENING_TYPE_1_REGISTER_8_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCREENING_TYPE_1_REGISTER_8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCREENING_TYPE_1_REGISTER_8_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCREENING_TYPE_1_REGISTER_8_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCREENING_TYPE_1_REGISTER_8` writer"]
pub struct W(crate::W<SCREENING_TYPE_1_REGISTER_8_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCREENING_TYPE_1_REGISTER_8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCREENING_TYPE_1_REGISTER_8_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCREENING_TYPE_1_REGISTER_8_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type QUEUE_NUMBER_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SCREENING_TYPE_1_REGISTER_8_SPEC, u8, u8, 4, O>;
...
pub type DSTC_MATCH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SCREENING_TYPE_1_REGISTER_8_SPEC, u8, u8, 8, O>;
...
pub type UDP_PORT_MATCH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SCREENING_TYPE_1_REGISTER_8_SPEC, u16, u16, 16, O>;
...
pub type DSTC_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SCREENING_TYPE_1_REGISTER_8_SPEC, bool, O>;
...
pub struct SCREENING_TYPE_1_REGISTER_8_SPEC;
impl crate::RegisterSpec for SCREENING_TYPE_1_REGISTER_8_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [screening_type_1_register_8::R](R) reader structure"]
impl crate::Readable for SCREENING_TYPE_1_REGISTER_8_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [screening_type_1_register_8::W](W) writer structure"]
impl crate::Writable for SCREENING_TYPE_1_REGISTER_8_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SCREENING_TYPE_1_REGISTER_8 to value 0"]
impl crate::Resettable for SCREENING_TYPE_1_REGISTER_8_SPEC {
