...
pub type STOP_BG_REQ_W<'a, const O: u8> = crate::BitWriter<'a, u8, BGAP_CTRL_R_SPEC, bool, O>;
...
pub type CONTINUE_REQ_W<'a, const O: u8> = crate::BitWriter<'a, u8, BGAP_CTRL_R_SPEC, bool, O>;
#[doc = "Field `RD_WAIT_CTRL` reader - N/A"]
pub type RD_WAIT_CTRL_R = crate::BitReader<bool>;
#[doc = "Field `RD_WAIT_CTRL` writer - N/A"]
pub type RD_WAIT_CTRL_W<'a, const O: u8> = crate::BitWriter<'a, u8, BGAP_CTRL_R_SPEC, bool, O>;
...
pub type INT_AT_BGAP_W<'a, const O: u8> = crate::BitWriter<'a, u8, BGAP_CTRL_R_SPEC, bool, O>;
impl R {
