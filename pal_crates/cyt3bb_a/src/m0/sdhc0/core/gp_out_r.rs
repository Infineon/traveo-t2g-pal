...
pub type CARD_DETECT_EN_R = crate::BitReader<bool>;
...
pub type CARD_DETECT_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, GP_OUT_R_SPEC, bool, O>;
...
pub type CARD_MECH_WRITE_PROT_EN_R = crate::BitReader<bool>;
...
pub type CARD_MECH_WRITE_PROT_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GP_OUT_R_SPEC, bool, O>;
...
pub type LED_CTRL_OE_R = crate::BitReader<bool>;
...
pub type LED_CTRL_OE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GP_OUT_R_SPEC, bool, O>;
...
pub type CARD_CLOCK_OE_R = crate::BitReader<bool>;
...
pub type CARD_CLOCK_OE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GP_OUT_R_SPEC, bool, O>;
...
pub type CARD_IF_PWR_EN_OE_R = crate::BitReader<bool>;
...
pub type CARD_IF_PWR_EN_OE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GP_OUT_R_SPEC, bool, O>;
...
pub type IO_VOLT_SEL_OE_R = crate::BitReader<bool>;
...
pub type IO_VOLT_SEL_OE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GP_OUT_R_SPEC, bool, O>;
#[doc = "Field `CARD_CLOCK_OUT_DLY` reader - N/A"]
pub type CARD_CLOCK_OUT_DLY_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CARD_CLOCK_OUT_DLY` writer - N/A"]
pub type CARD_CLOCK_OUT_DLY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GP_OUT_R_SPEC, u8, u8, 2, O>;
...
pub type CARD_CLOCK_IN_DLY_R = crate::FieldReader<u8, u8>;
...
pub type CARD_CLOCK_IN_DLY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GP_OUT_R_SPEC, u8, u8, 2, O>;
impl R {
