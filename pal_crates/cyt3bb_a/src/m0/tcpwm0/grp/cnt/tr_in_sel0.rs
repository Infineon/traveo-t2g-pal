...
#[doc = "Field `COUNT_SEL` reader - Selects one of the 256 input triggers as a count trigger. In QUAD mode, this is the first phase (phi A). Default setting selects input trigger 1, which is always '1'."]
pub type COUNT_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COUNT_SEL` writer - Selects one of the 256 input triggers as a count trigger. In QUAD mode, this is the first phase (phi A). Default setting selects input trigger 1, which is always '1'."]
