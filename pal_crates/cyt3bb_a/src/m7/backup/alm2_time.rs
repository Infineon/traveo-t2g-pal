...
#[doc = "Field `ALM_SEC` reader - Alarm seconds, 0-59"]
pub type ALM_SEC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ALM_SEC` writer - Alarm seconds, 0-59"]
pub type ALM_SEC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ALM2_TIME_SPEC, u8, u8, 6, O>;
...
pub type ALM_SEC_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, ALM2_TIME_SPEC, bool, O>;
#[doc = "Field `ALM_MIN` reader - Alarm minutes, 0-59"]
pub type ALM_MIN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ALM_MIN` writer - Alarm minutes, 0-59"]
pub type ALM_MIN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ALM2_TIME_SPEC, u8, u8, 6, O>;
...
pub type ALM_MIN_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, ALM2_TIME_SPEC, bool, O>;
#[doc = "Field `ALM_HOUR` reader - Alarm hours, value depending on 12/24HR mode 24HR: \\[4:0\\]=0-23 12HR: \\[4\\]:0=AM, 1=PM, \\[3:0\\]=1-12"]
pub type ALM_HOUR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ALM_HOUR` writer - Alarm hours, value depending on 12/24HR mode 24HR: \\[4:0\\]=0-23 12HR: \\[4\\]:0=AM, 1=PM, \\[3:0\\]=1-12"]
pub type ALM_HOUR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ALM2_TIME_SPEC, u8, u8, 5, O>;
...
pub type ALM_HOUR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, ALM2_TIME_SPEC, bool, O>;
#[doc = "Field `ALM_DAY` reader - Alarm Day of the week, 1-7 It is up to the user to define the meaning of the values, but 1=Monday is recommended"]
pub type ALM_DAY_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ALM_DAY` writer - Alarm Day of the week, 1-7 It is up to the user to define the meaning of the values, but 1=Monday is recommended"]
pub type ALM_DAY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ALM2_TIME_SPEC, u8, u8, 3, O>;
...
pub type ALM_DAY_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, ALM2_TIME_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:5 - Alarm seconds, 0-59"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:13 - Alarm minutes, 0-59"]
    #[inline(always)]
    pub fn alm_min(&self) -> ALM_MIN_R {
        ALM_MIN_R::new(((self.bits >> 8) & 0x3f) as u8)
    }
    ...
    #[doc = "Bits 16:20 - Alarm hours, value depending on 12/24HR mode 24HR: \\[4:0\\]=0-23 12HR: \\[4\\]:0=AM, 1=PM, \\[3:0\\]=1-12"]
    #[inline(always)]
    pub fn alm_hour(&self) -> ALM_HOUR_R {
        ALM_HOUR_R::new(((self.bits >> 16) & 0x1f) as u8)
    }
    ...
    #[doc = "Bits 24:26 - Alarm Day of the week, 1-7 It is up to the user to define the meaning of the values, but 1=Monday is recommended"]
    #[inline(always)]
