...
#[doc = "Field `SSEL_CONTINUOUS` reader - Continuous SPI data transfers enabled ('1') or not ('0'). This field is used in master mode. In slave mode, both continuous and non-continuous SPI data transfers are supported independent of this field. When continuous transfers are enabled individual data frame transfers are not necessarily separated by slave deselection (as indicated by the level or pulse on the SELECT line): if the TX FIFO has multiple data frames, data frames are send out without slave deselection. When continuous transfers are not enabled individual data frame transfers are always separated by slave deselection: independent of the availability of TX FIFO data frames, data frames are sent out with slave deselection."]
pub type SSEL_CONTINUOUS_R = crate::BitReader<bool>;
#[doc = "Field `SSEL_CONTINUOUS` writer - Continuous SPI data transfers enabled ('1') or not ('0'). This field is used in master mode. In slave mode, both continuous and non-continuous SPI data transfers are supported independent of this field. When continuous transfers are enabled individual data frame transfers are not necessarily separated by slave deselection (as indicated by the level or pulse on the SELECT line): if the TX FIFO has multiple data frames, data frames are send out without slave deselection. When continuous transfers are not enabled individual data frame transfers are always separated by slave deselection: independent of the availability of TX FIFO data frames, data frames are sent out with slave deselection."]
...
#[doc = "Field `SSEL_SETUP_DEL` reader - Indicates the SPI SELECT setup delay (between SELECT activation and SPI clock). '0': With this setting the same timing is generated as in the original MXSCB block. CPHA=0: 0.75 SPI clock cycles CPHA=1: 0.25 SPI clock cycles '1': With this setting an additional delay of 1 SPI clock cycle is generated. CPHA=0: 1.75 SPI clock cycles CPHA=1: 1.25 SPI clock cycles Only applies in SPI MOTOROLA submode and when SCLK_CONTINUOUS=0."]
pub type SSEL_SETUP_DEL_R = crate::BitReader<bool>;
#[doc = "Field `SSEL_SETUP_DEL` writer - Indicates the SPI SELECT setup delay (between SELECT activation and SPI clock). '0': With this setting the same timing is generated as in the original MXSCB block. CPHA=0: 0.75 SPI clock cycles CPHA=1: 0.25 SPI clock cycles '1': With this setting an additional delay of 1 SPI clock cycle is generated. CPHA=0: 1.75 SPI clock cycles CPHA=1: 1.25 SPI clock cycles Only applies in SPI MOTOROLA submode and when SCLK_CONTINUOUS=0."]
pub type SSEL_SETUP_DEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_CTRL_SPEC, bool, O>;
#[doc = "Field `SSEL_HOLD_DEL` reader - Indicates the SPI SELECT hold delay (between SPI clock and SELECT deactivation). '0': With this setting the same timing is generated as in the original MXSCB block. CPHA=0: 0.25 SPI clock cycles CPHA=1: 0.75 SPI clock cycles '1': With this setting an additional delay of 1 SPI clock cycle is generated. CPHA=0: 1.25 SPI clock cycles CPHA=1: 1.75 SPI clock cycles Only applies in SPI MOTOROLA submode and when SCLK_CONTINUOUS=0."]
pub type SSEL_HOLD_DEL_R = crate::BitReader<bool>;
#[doc = "Field `SSEL_HOLD_DEL` writer - Indicates the SPI SELECT hold delay (between SPI clock and SELECT deactivation). '0': With this setting the same timing is generated as in the original MXSCB block. CPHA=0: 0.25 SPI clock cycles CPHA=1: 0.75 SPI clock cycles '1': With this setting an additional delay of 1 SPI clock cycle is generated. CPHA=0: 1.25 SPI clock cycles CPHA=1: 1.75 SPI clock cycles Only applies in SPI MOTOROLA submode and when SCLK_CONTINUOUS=0."]
pub type SSEL_HOLD_DEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_CTRL_SPEC, bool, O>;
#[doc = "Field `SSEL_INTER_FRAME_DEL` reader - Indicates the SPI SELECT inter-dataframe delay (between SELECT deactivation and SELECT activation). '0': With this setting the same timing is generated as in the original MXSCB block. 1.5 SPI clock cycles '1': With this setting an additional delay of 1 SPI clock cycle is generated. 2.5 SPI clock cycles Only applies in SPI MOTOROLA submode and when SPI_CTRL.SSEL_CONTINUOUS=0."]
pub type SSEL_INTER_FRAME_DEL_R = crate::BitReader<bool>;
#[doc = "Field `SSEL_INTER_FRAME_DEL` writer - Indicates the SPI SELECT inter-dataframe delay (between SELECT deactivation and SELECT activation). '0': With this setting the same timing is generated as in the original MXSCB block. 1.5 SPI clock cycles '1': With this setting an additional delay of 1 SPI clock cycle is generated. 2.5 SPI clock cycles Only applies in SPI MOTOROLA submode and when SPI_CTRL.SSEL_CONTINUOUS=0."]
pub type SSEL_INTER_FRAME_DEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_CTRL_SPEC, bool, O>;
...
pub enum MODE_A {
    ...
    SPI_TI = 1,
    #[doc = "2: SPI National Semiconductors submode. In master mode, when not transmitting data, SCLK is stable at '0'. In slave mode, when not selected, SCLK is ignored; i.e. it can be either stable or clocking. In master mode, when there is no data to transmit (TX FIFO is empty), Slave SELECT is inactive."]
    SPI_NS = 2,
}
...
impl<'a, const O: u8> MODE_W<'a, O> {
    ...
    #[doc = "SPI National Semiconductors submode. In master mode, when not transmitting data, SCLK is stable at '0'. In slave mode, when not selected, SCLK is ignored; i.e. it can be either stable or clocking. In master mode, when there is no data to transmit (TX FIFO is empty), Slave SELECT is inactive."]
    #[inline(always)]
    pub fn spi_ns(self) -> &'a mut W {
        self.variant(MODE_A::SPI_NS)
    }
}
#[doc = "Field `SSEL` reader - Selects one of the four incoming/outgoing SPI slave select signals: - 0: Slave 0, SSEL\\[0\\]. - 1: Slave 1, SSEL\\[1\\]. - 2: Slave 2, SSEL\\[2\\]. - 3: Slave 3, SSEL\\[3\\]. SCB block should be disabled when changes are made to this field."]
pub type SSEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SSEL` writer - Selects one of the four incoming/outgoing SPI slave select signals: - 0: Slave 0, SSEL\\[0\\]. - 1: Slave 1, SSEL\\[1\\]. - 2: Slave 2, SSEL\\[2\\]. - 3: Slave 3, SSEL\\[3\\]. SCB block should be disabled when changes are made to this field."]
...
impl R {
    #[doc = "Bit 0 - Continuous SPI data transfers enabled ('1') or not ('0'). This field is used in master mode. In slave mode, both continuous and non-continuous SPI data transfers are supported independent of this field. When continuous transfers are enabled individual data frame transfers are not necessarily separated by slave deselection (as indicated by the level or pulse on the SELECT line): if the TX FIFO has multiple data frames, data frames are send out without slave deselection. When continuous transfers are not enabled individual data frame transfers are always separated by slave deselection: independent of the availability of TX FIFO data frames, data frames are sent out with slave deselection."]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - Indicates the SPI SELECT setup delay (between SELECT activation and SPI clock). '0': With this setting the same timing is generated as in the original MXSCB block. CPHA=0: 0.75 SPI clock cycles CPHA=1: 0.25 SPI clock cycles '1': With this setting an additional delay of 1 SPI clock cycle is generated. CPHA=0: 1.75 SPI clock cycles CPHA=1: 1.25 SPI clock cycles Only applies in SPI MOTOROLA submode and when SCLK_CONTINUOUS=0."]
    #[inline(always)]
    pub fn ssel_setup_del(&self) -> SSEL_SETUP_DEL_R {
        SSEL_SETUP_DEL_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - Indicates the SPI SELECT hold delay (between SPI clock and SELECT deactivation). '0': With this setting the same timing is generated as in the original MXSCB block. CPHA=0: 0.25 SPI clock cycles CPHA=1: 0.75 SPI clock cycles '1': With this setting an additional delay of 1 SPI clock cycle is generated. CPHA=0: 1.25 SPI clock cycles CPHA=1: 1.75 SPI clock cycles Only applies in SPI MOTOROLA submode and when SCLK_CONTINUOUS=0."]
    #[inline(always)]
    pub fn ssel_hold_del(&self) -> SSEL_HOLD_DEL_R {
        SSEL_HOLD_DEL_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Indicates the SPI SELECT inter-dataframe delay (between SELECT deactivation and SELECT activation). '0': With this setting the same timing is generated as in the original MXSCB block. 1.5 SPI clock cycles '1': With this setting an additional delay of 1 SPI clock cycle is generated. 2.5 SPI clock cycles Only applies in SPI MOTOROLA submode and when SPI_CTRL.SSEL_CONTINUOUS=0."]
    #[inline(always)]
    pub fn ssel_inter_frame_del(&self) -> SSEL_INTER_FRAME_DEL_R {
        SSEL_INTER_FRAME_DEL_R::new(((self.bits >> 14) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ssel_setup_del(&mut self) -> SSEL_SETUP_DEL_W<12> {
        SSEL_SETUP_DEL_W::new(self)
    }
    #[doc = "Bit 13 - Indicates the SPI SELECT hold delay (between SPI clock and SELECT deactivation). '0': With this setting the same timing is generated as in the original MXSCB block. CPHA=0: 0.25 SPI clock cycles CPHA=1: 0.75 SPI clock cycles '1': With this setting an additional delay of 1 SPI clock cycle is generated. CPHA=0: 1.25 SPI clock cycles CPHA=1: 1.75 SPI clock cycles Only applies in SPI MOTOROLA submode and when SCLK_CONTINUOUS=0."]
    #[inline(always)]
    #[must_use]
    pub fn ssel_hold_del(&mut self) -> SSEL_HOLD_DEL_W<13> {
        SSEL_HOLD_DEL_W::new(self)
    }
    #[doc = "Bit 14 - Indicates the SPI SELECT inter-dataframe delay (between SELECT deactivation and SELECT activation). '0': With this setting the same timing is generated as in the original MXSCB block. 1.5 SPI clock cycles '1': With this setting an additional delay of 1 SPI clock cycle is generated. 2.5 SPI clock cycles Only applies in SPI MOTOROLA submode and when SPI_CTRL.SSEL_CONTINUOUS=0."]
    #[inline(always)]
    #[must_use]
    pub fn ssel_inter_frame_del(&mut self) -> SSEL_INTER_FRAME_DEL_W<14> {
        SSEL_INTER_FRAME_DEL_W::new(self)
    }
    #[doc = "Bit 16 - Local loopback control (does NOT affect the information on the pins). Only used in master mode. Not used in National Semiconductors submode. '0': No local loopback '1': the SPI master MISO line is connected to the SPI master MOSI line. In other words, in loopback mode the SPI master receives on MISO what it transmits on MOSI."]
    #[inline(always)]
    #[must_use]
...
#[doc = "`reset()` method sets SPI_CTRL to value 0x0300_0010"]
impl crate::Resettable for SPI_CTRL_SPEC {
    const RESET_VALUE: Self::Ux = 0x0300_0010;
}
