...
#[doc = "Field `BREAK_LEVEL` reader - 0: low level pulse detection, like Break field in LIN protocol 1: high level pulse detection, like IFS field in CXPI protocol, or idle line state in UART"]
...
impl R {
    ...
    #[doc = "Bit 24 - 0: low level pulse detection, like Break field in LIN protocol 1: high level pulse detection, like IFS field in CXPI protocol, or idle line state in UART"]
    #[inline(always)]
