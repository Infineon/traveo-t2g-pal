...
pub type MAN_BOOT_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, BOOT_CTRL_R_SPEC, bool, O>;
...
pub type VALIDATE_BOOT_W<'a, const O: u8> = crate::BitWriter<'a, u16, BOOT_CTRL_R_SPEC, bool, O>;
...
pub type BOOT_ACK_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, BOOT_CTRL_R_SPEC, bool, O>;
...
pub type BOOT_TOUT_CNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, BOOT_CTRL_R_SPEC, u8, u8, 4, O>;
impl R {
