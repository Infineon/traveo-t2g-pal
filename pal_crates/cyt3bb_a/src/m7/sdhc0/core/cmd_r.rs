...
pub type RESP_TYPE_SELECT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, CMD_R_SPEC, u8, u8, 2, O>;
...
pub type SUB_CMD_FLAG_W<'a, const O: u8> = crate::BitWriter<'a, u16, CMD_R_SPEC, bool, O>;
...
pub type CMD_CRC_CHK_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, CMD_R_SPEC, bool, O>;
...
pub type CMD_IDX_CHK_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, CMD_R_SPEC, bool, O>;
...
line - Resume Command Values: - 0x0 (NO_DATA): No Data Present - 0x1 (DATA): Data Present"]
pub type DATA_PRESENT_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u16, CMD_R_SPEC, bool, O>;
...
pub type CMD_TYPE_W<'a, const O: u8> = crate::FieldWriter<'a, u16, CMD_R_SPEC, u8, u8, 2, O>;
...
pub type CMD_INDEX_W<'a, const O: u8> = crate::FieldWriter<'a, u16, CMD_R_SPEC, u8, u8, 6, O>;
impl R {
