...
pub type COMPLETION_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
...
pub type SRC_BUS_ERROR_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
...
pub type DST_BUS_ERROR_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
#[doc = "Field `SRC_MISAL` reader - Mask for INTR.SRC_MISAL interrupt."]
pub type SRC_MISAL_R = crate::BitReader<bool>;
#[doc = "Field `SRC_MISAL` writer - Mask for INTR.SRC_MISAL interrupt."]
pub type SRC_MISAL_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
#[doc = "Field `DST_MISAL` reader - Mask for INTR.DST_MISAL interrupt."]
pub type DST_MISAL_R = crate::BitReader<bool>;
#[doc = "Field `DST_MISAL` writer - Mask for INTR.DST_MISAL interrupt."]
pub type DST_MISAL_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
...
pub type CURR_PTR_NULL_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
...
pub type ACTIVE_CH_DISABLED_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
...
pub type DESCR_BUS_ERROR_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
impl R {
