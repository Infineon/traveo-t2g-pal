#[doc = "Register `INT_Q2_DISABLE` writer"]
pub struct W(crate::W<INT_Q2_DISABLE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INT_Q2_DISABLE_SPEC>;
    #[inline(always)]
...
impl From<crate::W<INT_Q2_DISABLE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INT_Q2_DISABLE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DISABLE_RECEIVE_COMPLETE_INTERRUPT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INT_Q2_DISABLE_SPEC, bool, O>;
...
pub type DISABLE_RETRY_LIMIT_EXCEEDED_OR_LATE_COLLISION_INTERRUPT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INT_Q2_DISABLE_SPEC, bool, O>;
#[doc = "Field `DISABLE_TRANSMIT_FRAME_CORRUPTION_DUE_TO_AMBA_ERROR_INTERRUPT` writer - Disable Transmit frame corruption due to AMBA (AXI/AHB) error interrupt"]
...
impl W {
    ...
    #[doc = "Bit 6 - Disable Transmit frame corruption due to AMBA (AXI/AHB) error interrupt"]
    #[inline(always)]
    #[must_use]
...
#[doc = "Writing a 1 to the relevant bit location disables that particular interrupt. This register is write only and when read will return zero.\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [int_q2_disable](index.html) module"]
pub struct INT_Q2_DISABLE_SPEC;
impl crate::RegisterSpec for INT_Q2_DISABLE_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [int_q2_disable::W](W) writer structure"]
impl crate::Writable for INT_Q2_DISABLE_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets INT_Q2_DISABLE to value 0"]
impl crate::Resettable for INT_Q2_DISABLE_SPEC {
