#[doc = "Register `SCREENING_TYPE_1_REGISTER_15` reader"]
pub struct R(crate::R<SCREENING_TYPE_1_REGISTER_15_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCREENING_TYPE_1_REGISTER_15_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCREENING_TYPE_1_REGISTER_15_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCREENING_TYPE_1_REGISTER_15_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCREENING_TYPE_1_REGISTER_15` writer"]
pub struct W(crate::W<SCREENING_TYPE_1_REGISTER_15_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCREENING_TYPE_1_REGISTER_15_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCREENING_TYPE_1_REGISTER_15_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCREENING_TYPE_1_REGISTER_15_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type QUEUE_NUMBER_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SCREENING_TYPE_1_REGISTER_15_SPEC, u8, u8, 4, O>;
...
pub type DSTC_MATCH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SCREENING_TYPE_1_REGISTER_15_SPEC, u8, u8, 8, O>;
...
pub type UDP_PORT_MATCH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SCREENING_TYPE_1_REGISTER_15_SPEC, u16, u16, 16, O>;
...
pub type DSTC_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SCREENING_TYPE_1_REGISTER_15_SPEC, bool, O>;
...
#[doc = "screening type 1 register 15, same as screening_type_1_register_0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [screening_type_1_register_15](index.html) module"]
pub struct SCREENING_TYPE_1_REGISTER_15_SPEC;
impl crate::RegisterSpec for SCREENING_TYPE_1_REGISTER_15_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [screening_type_1_register_15::R](R) reader structure"]
impl crate::Readable for SCREENING_TYPE_1_REGISTER_15_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [screening_type_1_register_15::W](W) writer structure"]
impl crate::Writable for SCREENING_TYPE_1_REGISTER_15_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SCREENING_TYPE_1_REGISTER_15 to value 0"]
impl crate::Resettable for SCREENING_TYPE_1_REGISTER_15_SPEC {
