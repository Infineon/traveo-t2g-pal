...
pub enum VTRIP_SEL0_0_A {
    #[doc = "0: PSoC6:: Input buffer compatible with CMOS and I2C interfaces Traveo II: full encoding is shown in CFG_IN_AUTOLVL.VTRIP_SEL0_1"]
    CMOS = 0,
    #[doc = "1: PSoC6:: Input buffer compatible with TTL and MediaLB interfaces Traveo II: full encoding is shown in CFG_IN_AUTOLVL.VTRIP_SEL0_1"]
    TTL = 1,
}
...
impl<'a, const O: u8> VTRIP_SEL0_0_W<'a, O> {
    #[doc = "PSoC6:: Input buffer compatible with CMOS and I2C interfaces Traveo II: full encoding is shown in CFG_IN_AUTOLVL.VTRIP_SEL0_1"]
    #[inline(always)]
    pub fn cmos(self) -> &'a mut W {
        self.variant(VTRIP_SEL0_0_A::CMOS)
    }
    #[doc = "PSoC6:: Input buffer compatible with TTL and MediaLB interfaces Traveo II: full encoding is shown in CFG_IN_AUTOLVL.VTRIP_SEL0_1"]
    #[inline(always)]
