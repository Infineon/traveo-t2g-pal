...
#[doc = "Clock control"]
pub mod clock_ctl;
#[doc = "CLOCK_STAT (r) register accessor: an alias for `Reg<CLOCK_STAT_SPEC>`"]
pub type CLOCK_STAT = crate::Reg<clock_stat::CLOCK_STAT_SPEC>;
#[doc = "Clock Status"]
pub mod clock_stat;
