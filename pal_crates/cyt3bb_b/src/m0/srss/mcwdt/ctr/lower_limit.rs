...
#[doc = "Field `LOWER_LIMIT` reader - Lower limit for this MCWDT subcounter. See LOWER_ACTION."]
pub type LOWER_LIMIT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LOWER_LIMIT` writer - Lower limit for this MCWDT subcounter. See LOWER_ACTION."]
pub type LOWER_LIMIT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LOWER_LIMIT_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Lower limit for this MCWDT subcounter. See LOWER_ACTION."]
    #[inline(always)]
    pub fn lower_limit(&self) -> LOWER_LIMIT_R {
        LOWER_LIMIT_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Lower limit for this MCWDT subcounter. See LOWER_ACTION."]
