...
#[doc = "Field `TBSA` reader - Tx Buffers Start Address Start address of Tx Buffers section in Message RAM (32-bit word address, see Figure 2)."]
pub type TBSA_R = crate::FieldReader<u16, u16>;
#[doc = "Field `TBSA` writer - Tx Buffers Start Address Start address of Tx Buffers section in Message RAM (32-bit word address, see Figure 2)."]
...
impl R {
    #[doc = "Bits 2:15 - Tx Buffers Start Address Start address of Tx Buffers section in Message RAM (32-bit word address, see Figure 2)."]
    #[inline(always)]
