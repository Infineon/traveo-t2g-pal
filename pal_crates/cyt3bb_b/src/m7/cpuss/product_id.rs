...
pub type FAMILY_ID_R = crate::FieldReader<u16, u16>;
...
#[doc = "Field `MINOR_REV` reader - Minir Revision, starts with 1, increments with metal layer only tape-out (implemented with metal ECO-able tie-off)"]
...
impl R {
    ...
    #[doc = "Bits 20:23 - Minir Revision, starts with 1, increments with metal layer only tape-out (implemented with metal ECO-able tie-off)"]
    #[inline(always)]
