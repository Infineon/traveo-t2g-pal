...
pub type CMD_COMPLETE_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NORMAL_INT_STAT_R_SPEC, bool, O>;
...
pub type BGAP_EVENT_W<'a, const O: u8> = crate::BitWriter<'a, u16, NORMAL_INT_STAT_R_SPEC, bool, O>;
...
pub type DMA_INTERRUPT_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NORMAL_INT_STAT_R_SPEC, bool, O>;
...
pub type BUF_WR_READY_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NORMAL_INT_STAT_R_SPEC, bool, O>;
...
pub type BUF_RD_READY_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NORMAL_INT_STAT_R_SPEC, bool, O>;
...
pub type CARD_INSERTION_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NORMAL_INT_STAT_R_SPEC, bool, O>;
...
pub type CARD_REMOVAL_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NORMAL_INT_STAT_R_SPEC, bool, O>;
...
pub type CQE_EVENT_W<'a, const O: u8> = crate::BitWriter<'a, u16, NORMAL_INT_STAT_R_SPEC, bool, O>;
