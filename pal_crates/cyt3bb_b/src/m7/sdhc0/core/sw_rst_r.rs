...
pub type SW_RST_ALL_W<'a, const O: u8> = crate::BitWriter<'a, u8, SW_RST_R_SPEC, bool, O>;
...
pub type SW_RST_CMD_W<'a, const O: u8> = crate::BitWriter<'a, u8, SW_RST_R_SPEC, bool, O>;
...
pub type SW_RST_DAT_W<'a, const O: u8> = crate::BitWriter<'a, u8, SW_RST_R_SPEC, bool, O>;
impl R {
