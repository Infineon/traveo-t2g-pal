#[doc = "Register `RD_CRC_CTL` reader"]
pub struct R(crate::R<RD_CRC_CTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RD_CRC_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RD_CRC_CTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RD_CRC_CTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RD_CRC_CTL` writer"]
pub struct W(crate::W<RD_CRC_CTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RD_CRC_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RD_CRC_CTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RD_CRC_CTL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `STATUS_CHECK_MASK` reader - Specifies which of the Functional Safety Status field bits are checked. There is 1 mask bit for each Functional Safety Status bit. '0': The associated Functional Safety Status bit is not checked. '1': The associated Functional Safety Status bit is checked. If the received Funciontal Safety Status bit = Functional Safety Status Error Polarity (STATUS_ERROR_POLARITY), then a Functional Safety Status error interrupt and a XIP bus error response is generated."]
pub type STATUS_CHECK_MASK_R = crate::FieldReader<u8, u8>;
#[doc = "Field `STATUS_CHECK_MASK` writer - Specifies which of the Functional Safety Status field bits are checked. There is 1 mask bit for each Functional Safety Status bit. '0': The associated Functional Safety Status bit is not checked. '1': The associated Functional Safety Status bit is checked. If the received Funciontal Safety Status bit = Functional Safety Status Error Polarity (STATUS_ERROR_POLARITY), then a Functional Safety Status error interrupt and a XIP bus error response is generated."]
pub type STATUS_CHECK_MASK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RD_CRC_CTL_SPEC, u8, u8, 8, O>;
#[doc = "Field `STATUS_ERROR_POL` reader - Specifies the polarity of the Functional Safety Status field bits. There is 1 polarity bit for each Functional Safety Status bit. '0': The associated Functional Safety Status bit is active-low. '1': The associated Functional Safety Status bit is active-high."]
pub type STATUS_ERROR_POL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `STATUS_ERROR_POL` writer - Specifies the polarity of the Functional Safety Status field bits. There is 1 polarity bit for each Functional Safety Status bit. '0': The associated Functional Safety Status bit is active-low. '1': The associated Functional Safety Status bit is active-high."]
pub type STATUS_ERROR_POL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RD_CRC_CTL_SPEC, u8, u8, 8, O>;
#[doc = "Field `DATA_CRC_INPUT_SIZE` reader - Number of input data bytes for CRC generation (minus 1), i.e. number of data bytes over which the data CRC field is generated (minus 1): '0': 1 byte ... '255': 256 bytes. Note: For octal data transfer with DDR mode (RD_DATA_CTL.WIDTH='3' and RD_DATA_CTL.DDR_MODE='1') the number of bytes for CRC generation must be even (i.e. DATA_CRC_INPUT_SIZE must be odd)."]
...
pub type CMD_ADDR_CRC_WIDTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RD_CRC_CTL_SPEC, u8, u8, 2, O>;
...
pub type CMD_ADDR_CRC_DDR_MODE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RD_CRC_CTL_SPEC, bool, O>;
...
pub type CMD_ADDR_CRC_INPUT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RD_CRC_CTL_SPEC, bool, O>;
#[doc = "Field `DATA_CRC_CHECK` reader - N/A"]
pub type DATA_CRC_CHECK_R = crate::BitReader<bool>;
#[doc = "Field `DATA_CRC_CHECK` writer - N/A"]
pub type DATA_CRC_CHECK_W<'a, const O: u8> = crate::BitWriter<'a, u32, RD_CRC_CTL_SPEC, bool, O>;
...
pub type CMD_ADDR_CRC_PRESENT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RD_CRC_CTL_SPEC, bool, O>;
#[doc = "Field `DATA_CRC_PRESENT` reader - Presence of data CRC field: '0': not present '1': present Note: Width and data transfer mode (SDR or DDR) of read data CRC fields are the same as for the associated read data fields, i.e. are specified by RD_DATA_CTL.WIDTH and RD_DATA_CTL.DDR_MODE."]
pub type DATA_CRC_PRESENT_R = crate::BitReader<bool>;
#[doc = "Field `DATA_CRC_PRESENT` writer - Presence of data CRC field: '0': not present '1': present Note: Width and data transfer mode (SDR or DDR) of read data CRC fields are the same as for the associated read data fields, i.e. are specified by RD_DATA_CTL.WIDTH and RD_DATA_CTL.DDR_MODE."]
pub type DATA_CRC_PRESENT_W<'a, const O: u8> = crate::BitWriter<'a, u32, RD_CRC_CTL_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:7 - Specifies which of the Functional Safety Status field bits are checked. There is 1 mask bit for each Functional Safety Status bit. '0': The associated Functional Safety Status bit is not checked. '1': The associated Functional Safety Status bit is checked. If the received Funciontal Safety Status bit = Functional Safety Status Error Polarity (STATUS_ERROR_POLARITY), then a Functional Safety Status error interrupt and a XIP bus error response is generated."]
    #[inline(always)]
    pub fn status_check_mask(&self) -> STATUS_CHECK_MASK_R {
        STATUS_CHECK_MASK_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - Specifies the polarity of the Functional Safety Status field bits. There is 1 polarity bit for each Functional Safety Status bit. '0': The associated Functional Safety Status bit is active-low. '1': The associated Functional Safety Status bit is active-high."]
    #[inline(always)]
    pub fn status_error_pol(&self) -> STATUS_ERROR_POL_R {
        STATUS_ERROR_POL_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    ...
    #[doc = "Bit 28 - N/A"]
    #[inline(always)]
    pub fn data_crc_check(&self) -> DATA_CRC_CHECK_R {
        DATA_CRC_CHECK_R::new(((self.bits >> 28) & 1) != 0)
    }
    ...
    #[doc = "Bit 31 - Presence of data CRC field: '0': not present '1': present Note: Width and data transfer mode (SDR or DDR) of read data CRC fields are the same as for the associated read data fields, i.e. are specified by RD_DATA_CTL.WIDTH and RD_DATA_CTL.DDR_MODE."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn status_check_mask(&mut self) -> STATUS_CHECK_MASK_W<0> {
        STATUS_CHECK_MASK_W::new(self)
    }
    #[doc = "Bits 8:15 - Specifies the polarity of the Functional Safety Status field bits. There is 1 polarity bit for each Functional Safety Status bit. '0': The associated Functional Safety Status bit is active-low. '1': The associated Functional Safety Status bit is active-high."]
    #[inline(always)]
    #[must_use]
    pub fn status_error_pol(&mut self) -> STATUS_ERROR_POL_W<8> {
        STATUS_ERROR_POL_W::new(self)
    }
    #[doc = "Bits 16:23 - Number of input data bytes for CRC generation (minus 1), i.e. number of data bytes over which the data CRC field is generated (minus 1): '0': 1 byte ... '255': 256 bytes. Note: For octal data transfer with DDR mode (RD_DATA_CTL.WIDTH='3' and RD_DATA_CTL.DDR_MODE='1') the number of bytes for CRC generation must be even (i.e. DATA_CRC_INPUT_SIZE must be odd)."]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn data_crc_check(&mut self) -> DATA_CRC_CHECK_W<28> {
        DATA_CRC_CHECK_W::new(self)
    }
    #[doc = "Bit 30 - Presence of command / address CRC field: '0': not present '1': present Note: For octal data transfer with DDR mode (RD_CRC_CTL.WIDTH='3' and RD_CRC_CTL.DDR_MODE='1') the command / address CRC byte is sent twice, otherwise the command / address CRC byte is only sent once."]
    #[inline(always)]
    #[must_use]
...
#[doc = "Read Bus CRC control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rd_crc_ctl](index.html) module"]
pub struct RD_CRC_CTL_SPEC;
impl crate::RegisterSpec for RD_CRC_CTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rd_crc_ctl::R](R) reader structure"]
impl crate::Readable for RD_CRC_CTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rd_crc_ctl::W](W) writer structure"]
impl crate::Writable for RD_CRC_CTL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RD_CRC_CTL to value 0xff00"]
impl crate::Resettable for RD_CRC_CTL_SPEC {
