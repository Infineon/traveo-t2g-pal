...
#[doc = "Field `PATH_MUX` reader - Selects a source for clock PATH&lt;i>. Note that not all products support all clock sources. Selecting a clock source that is not supported will result in undefined behavior. It takes four cycles of the originally selected clock to switch away from it. Do not disable the original clock during this time."]
pub type PATH_MUX_R = crate::FieldReader<u8, PATH_MUX_A>;
#[doc = "Selects a source for clock PATH&lt;i>. Note that not all products support all clock sources. Selecting a clock source that is not supported will result in undefined behavior. It takes four cycles of the originally selected clock to switch away from it. Do not disable the original clock during this time.\n\nValue on reset: 0"]
...
pub enum PATH_MUX_A {
    ...
    DSI_MUX = 4,
    #[doc = "5: LPECO - Low-Power External-Crystal Oscillator"]
    LPECO = 5,
}
...
impl PATH_MUX_R {
    ...
    pub fn is_lpeco(&self) -> bool {
        *self == PATH_MUX_A::LPECO
    }
}
#[doc = "Field `PATH_MUX` writer - Selects a source for clock PATH&lt;i>. Note that not all products support all clock sources. Selecting a clock source that is not supported will result in undefined behavior. It takes four cycles of the originally selected clock to switch away from it. Do not disable the original clock during this time."]
...
impl<'a, const O: u8> PATH_MUX_W<'a, O> {
    ...
    #[doc = "LPECO - Low-Power External-Crystal Oscillator"]
    #[inline(always)]
    pub fn lpeco(self) -> &'a mut W {
        self.variant(PATH_MUX_A::LPECO)
    }
}
impl R {
    #[doc = "Bits 0:2 - Selects a source for clock PATH&lt;i>. Note that not all products support all clock sources. Selecting a clock source that is not supported will result in undefined behavior. It takes four cycles of the originally selected clock to switch away from it. Do not disable the original clock during this time."]
    #[inline(always)]
