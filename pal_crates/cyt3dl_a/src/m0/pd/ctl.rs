...
pub enum PWR_MODE_A {
    ...
    RESET = 1,
    #[doc = "2: Power domain is switched off, but specified state is retained. This choice behaves like OFF for domains that do not support retained state at all."]
    RETAINED = 2,
...
impl<'a, const O: u8> PWR_MODE_W<'a, O> {
    ...
    #[doc = "Power domain is switched off, but specified state is retained. This choice behaves like OFF for domains that do not support retained state at all."]
    #[inline(always)]
