...
#[doc = "Field `REVISION` reader - the version number is 0x0002"]
...
impl R {
    ...
    #[doc = "Bits 16:31 - the version number is 0x0002"]
    #[inline(always)]
...
#[doc = "`reset()` method sets ID to value 0x0002_f0f0"]
impl crate::Resettable for ID_SPEC {
    const RESET_VALUE: Self::Ux = 0x0002_f0f0;
}
