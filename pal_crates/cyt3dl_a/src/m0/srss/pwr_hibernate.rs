...
#[doc = "Field `MASK_HIBWDT` reader - When set, HIBERNATE will wakeup for WDT interrupt"]
pub type MASK_HIBWDT_R = crate::BitReader<bool>;
#[doc = "Field `MASK_HIBWDT` writer - When set, HIBERNATE will wakeup for WDT interrupt"]
...
impl R {
    ...
    #[doc = "Bit 19 - When set, HIBERNATE will wakeup for WDT interrupt"]
    #[inline(always)]
