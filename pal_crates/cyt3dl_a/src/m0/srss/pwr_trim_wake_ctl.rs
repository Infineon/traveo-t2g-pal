...
#[doc = "Field `WAKE_DELAY` reader - Wakeup holdoff specifies the number of IMO cycles for power system settling before continuing the wakeup sequence. Fastest wakeup is achieved by using the smallest number allowed for the product."]
pub type WAKE_DELAY_R = crate::FieldReader<u8, u8>;
#[doc = "Field `WAKE_DELAY` writer - Wakeup holdoff specifies the number of IMO cycles for power system settling before continuing the wakeup sequence. Fastest wakeup is achieved by using the smallest number allowed for the product."]
pub type WAKE_DELAY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PWR_TRIM_WAKE_CTL_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - Wakeup holdoff specifies the number of IMO cycles for power system settling before continuing the wakeup sequence. Fastest wakeup is achieved by using the smallest number allowed for the product."]
    #[inline(always)]
