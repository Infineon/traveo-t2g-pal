...
#[doc = "Field `A43` reader - Value for blue input. (format is signed fix-point 3.10)"]
pub type A43_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A43` writer - Value for blue input. (format is signed fix-point 3.10)"]
pub type A43_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ALPHA1_SPEC, u16, u16, 13, O>;
#[doc = "Field `A44` reader - Value for alpha input. (format is signed fix-point 3.10)"]
pub type A44_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A44` writer - Value for alpha input. (format is signed fix-point 3.10)"]
