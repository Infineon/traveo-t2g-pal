...
#[doc = "Field `READACK` writer - Writing a one acknowledges the read of the status registers (ActiveDimensions, Offset, Error)."]
pub type READACK_W<'a, const O: u8> = crate::BitWriter<'a, u32, READACK_SPEC, bool, O>;
impl W {
    #[doc = "Bit 0 - Writing a one acknowledges the read of the status registers (ActiveDimensions, Offset, Error)."]
    #[inline(always)]
    #[must_use]
