...
#[doc = "Field `A21` reader - A21, given in signed fixed-point 26.6 two's complement notation. (format is signed fix-point 26.6)"]
pub type A21_R = crate::FieldReader<u32, u32>;
#[doc = "Field `A21` writer - A21, given in signed fixed-point 26.6 two's complement notation. (format is signed fix-point 26.6)"]
pub type A21_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TRANSFORMATIONMATRIXA21_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - A21, given in signed fixed-point 26.6 two's complement notation. (format is signed fix-point 26.6)"]
    #[inline(always)]
