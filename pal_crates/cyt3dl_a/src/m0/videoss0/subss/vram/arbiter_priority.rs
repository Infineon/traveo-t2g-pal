...
#[doc = "Field `PRIORITY_WR1` reader - Priority for write slave interfaces 1."]
pub type PRIORITY_WR1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PRIORITY_WR1` writer - Priority for write slave interfaces 1."]
pub type PRIORITY_WR1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ARBITER_PRIORITY_SPEC, u8, u8, 2, O>;
...
impl R {
    ...
    #[doc = "Bits 2:3 - Priority for write slave interfaces 1."]
    #[inline(always)]
    pub fn priority_wr1(&self) -> PRIORITY_WR1_R {
        PRIORITY_WR1_R::new(((self.bits >> 2) & 3) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn priority_wr1(&mut self) -> PRIORITY_WR1_W<2> {
        PRIORITY_WR1_W::new(self)
    }
    #[doc = "Bits 8:9 - Priority for read slave interface 0."]
    #[inline(always)]
    #[must_use]
