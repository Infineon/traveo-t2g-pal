...
#[doc = "Field `PALETTEENABLE3` reader - See PaletteEnable0."]
pub type PALETTEENABLE3_R = crate::BitReader<bool>;
#[doc = "Field `PALETTEENABLE3` writer - See PaletteEnable0."]
pub type PALETTEENABLE3_W<'a, const O: u8> =
...
pub type GAMMAREMOVEENABLE3_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LAYERPROPERTY3_SPEC, bool, O>;
#[doc = "Field `PALETTEOFFSET3` reader - see PaletteOffset0."]
pub type PALETTEOFFSET3_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PALETTEOFFSET3` writer - see PaletteOffset0."]
pub type PALETTEOFFSET3_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYERPROPERTY3_SPEC, u16, u16, 11, O>;
#[doc = "Field `PALETTEIDWIDTH3` reader - see PaletteIdWidth0."]
pub type PALETTEIDWIDTH3_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PALETTEIDWIDTH3` writer - see PaletteIdWidth0."]
pub type PALETTEIDWIDTH3_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYERPROPERTY3_SPEC, u8, u8, 3, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn paletteenable3(&self) -> PALETTEENABLE3_R {
        PALETTEENABLE3_R::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn paletteoffset3(&self) -> PALETTEOFFSET3_R {
        PALETTEOFFSET3_R::new(((self.bits >> 16) & 0x07ff) as u16)
    }
    #[doc = "Bits 27:29 - see PaletteIdWidth0."]
    #[inline(always)]
    pub fn paletteidwidth3(&self) -> PALETTEIDWIDTH3_R {
        PALETTEIDWIDTH3_R::new(((self.bits >> 27) & 7) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn paletteenable3(&mut self) -> PALETTEENABLE3_W<0> {
        PALETTEENABLE3_W::new(self)
    }
    #[doc = "Bits 1:2 - See TileMode0."]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn paletteoffset3(&mut self) -> PALETTEOFFSET3_W<16> {
        PALETTEOFFSET3_W::new(self)
    }
    #[doc = "Bits 27:29 - see PaletteIdWidth0."]
    #[inline(always)]
    #[must_use]
    pub fn paletteidwidth3(&mut self) -> PALETTEIDWIDTH3_W<27> {
        PALETTEIDWIDTH3_W::new(self)
    }
    #[doc = "Bit 30 - See ClipWindowEnable0."]
    #[inline(always)]
    #[must_use]
...
#[doc = "`reset()` method sets LAYERPROPERTY3 to value 0x3800_0008"]
