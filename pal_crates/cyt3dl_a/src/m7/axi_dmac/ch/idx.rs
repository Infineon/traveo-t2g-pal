...
#[doc = "Field `Y` reader - Specifies the Y loop index. In the range of \\[0, Y_COUNT\\], with Y_COUNT taken from the current descriptor. Note: HW sets this field to '0' when it loads a descriptor.."]
...
impl R {
    ...
    #[doc = "Bits 16:31 - Specifies the Y loop index. In the range of \\[0, Y_COUNT\\], with Y_COUNT taken from the current descriptor. Note: HW sets this field to '0' when it loads a descriptor.."]
    #[inline(always)]
    pub fn y(&self) -> Y_R {
