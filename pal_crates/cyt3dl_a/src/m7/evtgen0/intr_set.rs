...
#[doc = "Field `COMP0` reader - SW writes a '1' to this field to set the corresponding field in the INTR register."]
pub type COMP0_R = crate::FieldReader<u16, u16>;
#[doc = "Field `COMP0` writer - SW writes a '1' to this field to set the corresponding field in the INTR register."]
pub type COMP0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, INTR_SET_SPEC, u16, u16, 16, O>;
impl R {
