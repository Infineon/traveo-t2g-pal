...
#[doc = "Field `CODE` reader - Gain code in the range \\[0, 115\\]. See SRC_GAIN_CTL.CODE\\[\\]. Note: HW modifies this field during 'fade in' and 'fade out'. For 'fade in' HW will gradually increment the value until it reaches '115'. For 'fade out' HW will gradually decrement the value until it reaches '0'."]
pub type CODE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CODE` writer - Gain code in the range \\[0, 115\\]. See SRC_GAIN_CTL.CODE\\[\\]. Note: HW modifies this field during 'fade in' and 'fade out'. For 'fade in' HW will gradually increment the value until it reaches '115'. For 'fade out' HW will gradually decrement the value until it reaches '0'."]
pub type CODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SRC_FADE_CTL_SPEC, u8, u8, 7, O>;
impl R {
    #[doc = "Bits 0:6 - Gain code in the range \\[0, 115\\]. See SRC_GAIN_CTL.CODE\\[\\]. Note: HW modifies this field during 'fade in' and 'fade out'. For 'fade in' HW will gradually increment the value until it reaches '115'. For 'fade out' HW will gradually decrement the value until it reaches '0'."]
    #[inline(always)]
