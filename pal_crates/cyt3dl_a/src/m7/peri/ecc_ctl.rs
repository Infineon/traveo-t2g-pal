...
pub type WORD_ADDR_R = crate::FieldReader<u16, u16>;
...
pub type WORD_ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ECC_CTL_SPEC, u16, u16, 11, O>;
#[doc = "Field `ECC_EN` reader - Enable ECC: '0': Disabled (on write ECC parity bits will not be correctly written). '1': Enabled."]
pub type ECC_EN_R = crate::BitReader<bool>;
#[doc = "Field `ECC_EN` writer - Enable ECC: '0': Disabled (on write ECC parity bits will not be correctly written). '1': Enabled."]
...
pub type ECC_INJ_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, ECC_CTL_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 16 - Enable ECC: '0': Disabled (on write ECC parity bits will not be correctly written). '1': Enabled."]
    #[inline(always)]
