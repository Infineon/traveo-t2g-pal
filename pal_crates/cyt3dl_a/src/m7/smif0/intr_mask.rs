...
pub type RX_DATA_MMIO_FIFO_UNDERFLOW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
#[doc = "Field `DL_FAIL` reader - Mask bit for corresponding bit in interrupt request register."]
pub type DL_FAIL_R = crate::BitReader<bool>;
#[doc = "Field `DL_FAIL` writer - Mask bit for corresponding bit in interrupt request register."]
pub type DL_FAIL_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
#[doc = "Field `DL_WARNING` reader - Mask bit for corresponding bit in interrupt request register."]
pub type DL_WARNING_R = crate::BitReader<bool>;
#[doc = "Field `DL_WARNING` writer - Mask bit for corresponding bit in interrupt request register."]
pub type DL_WARNING_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
