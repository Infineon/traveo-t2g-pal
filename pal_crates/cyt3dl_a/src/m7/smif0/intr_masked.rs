...
#[doc = "Field `DL_FAIL` reader - Logical and of corresponding request and mask bits."]
pub type DL_FAIL_R = crate::BitReader<bool>;
#[doc = "Field `DL_WARNING` reader - Logical and of corresponding request and mask bits."]
