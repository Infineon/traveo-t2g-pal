...
#[doc = "Field `WDT` reader - Mask for watchdog timer. Clearing this bit will not forward the interrupt to the CPU."]
pub type WDT_R = crate::BitReader<bool>;
#[doc = "Field `WDT` writer - Mask for watchdog timer. Clearing this bit will not forward the interrupt to the CPU."]
pub type WDT_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - Mask for watchdog timer. Clearing this bit will not forward the interrupt to the CPU."]
    #[inline(always)]
