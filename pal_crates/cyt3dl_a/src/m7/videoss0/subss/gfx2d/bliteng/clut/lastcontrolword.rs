...
#[doc = "Field `L_VAL` reader - Value of last received control word. For debug purposes only, read when stable only, otherwise read data might be corrupted."]
pub type L_VAL_R = crate::FieldReader<u32, u32>;
impl R {
    #[doc = "Bits 0:31 - Value of last received control word. For debug purposes only, read when stable only, otherwise read data might be corrupted."]
    #[inline(always)]
