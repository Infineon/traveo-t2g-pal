...
#[doc = "Field `ARBSTARTY` reader - Start point for sample-point interpolation (Y coordinate). (format is signed fix-point 16.5)"]
pub type ARBSTARTY_R = crate::FieldReader<u32, u32>;
#[doc = "Field `ARBSTARTY` writer - Start point for sample-point interpolation (Y coordinate). (format is signed fix-point 16.5)"]
pub type ARBSTARTY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ARBSTARTY_SPEC, u32, u32, 21, O>;
impl R {
    #[doc = "Bits 0:20 - Start point for sample-point interpolation (Y coordinate). (format is signed fix-point 16.5)"]
    #[inline(always)]
