...
#[doc = "Field `SCHEDULERACTIVETB` reader - Task buffer being executed in scheduler. If scheduler is in idle state, the value of this field is not valid."]
...
#[doc = "Field `FETCHEDACTIVETB` reader - Task buffer being fetch last in programmer. If programmer is in idle state, the value of this field is not valid."]
...
impl R {
    ...
    #[doc = "Bits 16:18 - Task buffer being executed in scheduler. If scheduler is in idle state, the value of this field is not valid."]
    #[inline(always)]
    ...
    #[doc = "Bits 20:22 - Task buffer being fetch last in programmer. If programmer is in idle state, the value of this field is not valid."]
    #[inline(always)]
