...
#[doc = "Field `SPLITPOSITION` reader - Index of first column of right display half when ChannelMode is DUAL_SPLIT. - SplitPosition must be less or equal 1280 - (Hact - SplitPosition) must be less or equal 1280 - If (SplitPosition greater than (Hact - SplitPosition)) Htotal greater 2*SplitPosition else Htotal greater (Hact - SplitPosition) - NOTE once setting SplitPosition data_en is needed"]
pub type SPLITPOSITION_R = crate::FieldReader<u16, u16>;
#[doc = "Field `SPLITPOSITION` writer - Index of first column of right display half when ChannelMode is DUAL_SPLIT. - SplitPosition must be less or equal 1280 - (Hact - SplitPosition) must be less or equal 1280 - If (SplitPosition greater than (Hact - SplitPosition)) Htotal greater 2*SplitPosition else Htotal greater (Hact - SplitPosition) - NOTE once setting SplitPosition data_en is needed"]
...
impl R {
    ...
    #[doc = "Bits 16:29 - Index of first column of right display half when ChannelMode is DUAL_SPLIT. - SplitPosition must be less or equal 1280 - (Hact - SplitPosition) must be less or equal 1280 - If (SplitPosition greater than (Hact - SplitPosition)) Htotal greater 2*SplitPosition else Htotal greater (Hact - SplitPosition) - NOTE once setting SplitPosition data_en is needed"]
    #[inline(always)]
