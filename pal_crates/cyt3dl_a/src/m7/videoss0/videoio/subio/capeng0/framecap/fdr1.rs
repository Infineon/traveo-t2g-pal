...
#[doc = "Field `HEIGHT1` reader - Expected frame height of video fields with id 1 (value is Height - 1). It could be configured after mode detection."]
pub type HEIGHT1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `HEIGHT1` writer - Expected frame height of video fields with id 1 (value is Height - 1). It could be configured after mode detection."]
pub type HEIGHT1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FDR1_SPEC, u16, u16, 14, O>;
impl R {
    #[doc = "Bits 16:29 - Expected frame height of video fields with id 1 (value is Height - 1). It could be configured after mode detection."]
    #[inline(always)]
