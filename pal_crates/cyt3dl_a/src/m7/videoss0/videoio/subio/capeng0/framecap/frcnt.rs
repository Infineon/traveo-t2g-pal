...
#[doc = "Field `FRCOUNT` reader - Shows frame counts of video input. It is updated every vsync (for debugging purposes only)."]
pub type FRCOUNT_R = crate::FieldReader<u32, u32>;
impl R {
    #[doc = "Bits 0:31 - Shows frame counts of video input. It is updated every vsync (for debugging purposes only)."]
    #[inline(always)]
