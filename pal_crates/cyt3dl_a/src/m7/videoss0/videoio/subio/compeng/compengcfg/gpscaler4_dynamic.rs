...
#[doc = "Field `GPSCALER4_SRC_SEL` reader - Selection of the source for the src input of the gpscaler4 module"]
pub type GPSCALER4_SRC_SEL_R = crate::FieldReader<u8, GPSCALER4_SRC_SEL_A>;
#[doc = "Selection of the source for the src input of the gpscaler4 module\n\nValue on reset: 0"]
...
#[doc = "Field `GPSCALER4_SRC_SEL` writer - Selection of the source for the src input of the gpscaler4 module"]
...
impl R {
    #[doc = "Bits 0:4 - Selection of the source for the src input of the gpscaler4 module"]
    #[inline(always)]
