...
#[doc = "Field `ETOC` reader - Enable Timeout Counter 0= Timeout Counter disabled 1= Timeout Counter enabled"]
pub type ETOC_R = crate::BitReader<bool>;
#[doc = "Field `ETOC` writer - Enable Timeout Counter 0= Timeout Counter disabled 1= Timeout Counter enabled"]
