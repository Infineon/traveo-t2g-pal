...
pub struct PRT {
    ...
    _reserved15: [u8; 0x04],
    #[doc = "0x60 - Port output buffer configuration register 2"]
    pub cfg_out2: CFG_OUT2,
    #[doc = "0x64 - Port output buffer slew extension configuration register"]
    pub cfg_slew_ext: CFG_SLEW_EXT,
    #[doc = "0x68 - Port output buffer drive sel extension configuration register"]
    pub cfg_drive_ext0: CFG_DRIVE_EXT0,
    #[doc = "0x6c - Port output buffer drive sel extension configuration register"]
    pub cfg_drive_ext1: CFG_DRIVE_EXT1,
}
...
#[doc = "CFG_OUT2 (rw) register accessor: an alias for `Reg<CFG_OUT2_SPEC>`"]
pub type CFG_OUT2 = crate::Reg<cfg_out2::CFG_OUT2_SPEC>;
#[doc = "Port output buffer configuration register 2"]
pub mod cfg_out2;
#[doc = "CFG_SLEW_EXT (rw) register accessor: an alias for `Reg<CFG_SLEW_EXT_SPEC>`"]
pub type CFG_SLEW_EXT = crate::Reg<cfg_slew_ext::CFG_SLEW_EXT_SPEC>;
#[doc = "Port output buffer slew extension configuration register"]
pub mod cfg_slew_ext;
#[doc = "CFG_DRIVE_EXT0 (rw) register accessor: an alias for `Reg<CFG_DRIVE_EXT0_SPEC>`"]
pub type CFG_DRIVE_EXT0 = crate::Reg<cfg_drive_ext0::CFG_DRIVE_EXT0_SPEC>;
#[doc = "Port output buffer drive sel extension configuration register"]
pub mod cfg_drive_ext0;
#[doc = "CFG_DRIVE_EXT1 (rw) register accessor: an alias for `Reg<CFG_DRIVE_EXT1_SPEC>`"]
pub type CFG_DRIVE_EXT1 = crate::Reg<cfg_drive_ext1::CFG_DRIVE_EXT1_SPEC>;
#[doc = "Port output buffer drive sel extension configuration register"]
pub mod cfg_drive_ext1;
