...
#[doc = "Field `DATA_BIT4` reader - Number of delay line taps for the IP's spi_data\\[4\\]
...
#[doc = "Field `DATA_BIT5` reader - Number of delay line taps for the IP's spi_data\\[5\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL) with correctly captured DLP in last read transaction. Legal range: \\[0, 255\\]."]
pub type DATA_BIT5_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DATA_BIT6` reader - Number of delay line taps for the IP's spi_data\\[6\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL) with correctly captured DLP in last read transaction. Legal range: \\[0, 255\\]."]
pub type DATA_BIT6_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DATA_BIT7` reader - Number of delay line taps for the IP's spi_data\\[7\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL) with correctly captured DLP in last read transaction. Legal range: \\[0, 255\\]."]
pub type DATA_BIT7_R = crate::FieldReader<u8, u8>;
impl R {
    #[doc = "Bits 0:7 - Number of delay line taps for the IP's spi_data\\[4\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL) with correctly captured DLP in last read transaction. Legal range: \\[0, 255\\]."]
    #[inline(always)]
    pub fn data_bit4(&self) -> DATA_BIT4_R {
        DATA_BIT4_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - Number of delay line taps for the IP's spi_data\\[5\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL) with correctly captured DLP in last read transaction. Legal range: \\[0, 255\\]."]
    #[inline(always)]
    pub fn data_bit5(&self) -> DATA_BIT5_R {
        DATA_BIT5_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - Number of delay line taps for the IP's spi_data\\[6\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL) with correctly captured DLP in last read transaction. Legal range: \\[0, 255\\]."]
    #[inline(always)]
    pub fn data_bit6(&self) -> DATA_BIT6_R {
        DATA_BIT6_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - Number of delay line taps for the IP's spi_data\\[7\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL) with correctly captured DLP in last read transaction. Legal range: \\[0, 255\\]."]
    #[inline(always)]
