...
#[doc = "Field `DATA_BIT0` reader - Delay line tap selection for the IP's spi_data\\[0\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). A value of 0 selects the receive capture clock source specified by CTL.CLOCK_IF_RX_SEL. All other values select a tap of the clock delay line. When the data learning pattern is enabled this value is set by HW."]
pub type DATA_BIT0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DATA_BIT0` writer - Delay line tap selection for the IP's spi_data\\[0\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). A value of 0 selects the receive capture clock source specified by CTL.CLOCK_IF_RX_SEL. All other values select a tap of the clock delay line. When the data learning pattern is enabled this value is set by HW."]
pub type DATA_BIT0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, INT_CLOCK_DELAY_TAP_SEL0_SPEC, u8, u8, 8, O>;
#[doc = "Field `DATA_BIT1` reader - Delay line tap selection for the IP's spi_data\\[1\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). See DATA_BIT0."]
pub type DATA_BIT1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DATA_BIT1` writer - Delay line tap selection for the IP's spi_data\\[1\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). See DATA_BIT0."]
pub type DATA_BIT1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, INT_CLOCK_DELAY_TAP_SEL0_SPEC, u8, u8, 8, O>;
#[doc = "Field `DATA_BIT2` reader - Delay line tap selection for the IP's spi_data\\[2\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). See DATA_BIT0."]
pub type DATA_BIT2_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DATA_BIT2` writer - Delay line tap selection for the IP's spi_data\\[2\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). See DATA_BIT0."]
pub type DATA_BIT2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, INT_CLOCK_DELAY_TAP_SEL0_SPEC, u8, u8, 8, O>;
#[doc = "Field `DATA_BIT3` reader - Delay line tap selection for the IP's spi_data\\[3\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). See DATA_BIT0."]
pub type DATA_BIT3_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DATA_BIT3` writer - Delay line tap selection for the IP's spi_data\\[3\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). See DATA_BIT0."]
pub type DATA_BIT3_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, INT_CLOCK_DELAY_TAP_SEL0_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - Delay line tap selection for the IP's spi_data\\[0\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). A value of 0 selects the receive capture clock source specified by CTL.CLOCK_IF_RX_SEL. All other values select a tap of the clock delay line. When the data learning pattern is enabled this value is set by HW."]
    #[inline(always)]
