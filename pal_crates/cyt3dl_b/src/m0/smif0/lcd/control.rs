...
pub enum LCD_MODE_A {
    #[doc = "0: Select Low Speed Generator (Works in Active, Sleep and DeepSleep power modes). Low speed clock (clk_lf) or middle speed clock (clk_mf) can be selected for Low Speed Generator."]
    LS = 0,
...
#[doc = "Field `CLOCK_LS_SEL` reader - Low speed (LS) generator clock source selection 1: select clk_mf 0: select clk_lf"]
pub type CLOCK_LS_SEL_R = crate::BitReader<bool>;
#[doc = "Field `CLOCK_LS_SEL` writer - Low speed (LS) generator clock source selection 1: select clk_mf 0: select clk_lf"]
pub type CLOCK_LS_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CONTROL_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 7 - Low speed (LS) generator clock source selection 1: select clk_mf 0: select clk_lf"]
    #[inline(always)]
    pub fn clock_ls_sel(&self) -> CLOCK_LS_SEL_R {
        CLOCK_LS_SEL_R::new(((self.bits >> 7) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clock_ls_sel(&mut self) -> CLOCK_LS_SEL_W<7> {
        CLOCK_LS_SEL_W::new(self)
    }
    #[doc = "Bits 8:11 - The number of COM connections minus 2. So: 0: 2 COM's 1: 3 COM's ... 13: 15 COM's 14: 16 COM's 15: undefined"]
    #[inline(always)]
    #[must_use]
