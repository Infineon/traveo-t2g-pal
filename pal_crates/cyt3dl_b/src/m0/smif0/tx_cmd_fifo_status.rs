...
#[doc = "Field `USED4` reader - Number of entries that are used in the TX command FIFO. Legal range: \\[0, 8\\]."]
pub type USED4_R = crate::FieldReader<u8, u8>;
impl R {
    #[doc = "Bits 0:3 - Number of entries that are used in the TX command FIFO. Legal range: \\[0, 8\\]."]
    #[inline(always)]
