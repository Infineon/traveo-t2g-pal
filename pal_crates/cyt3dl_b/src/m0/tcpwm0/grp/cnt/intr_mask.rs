...
#[doc = "Field `CC0_MATCH` reader - Mask bit for corresponding bit in interrupt request register."]
pub type CC0_MATCH_R = crate::BitReader<bool>;
#[doc = "Field `CC0_MATCH` writer - Mask bit for corresponding bit in interrupt request register."]
pub type CC0_MATCH_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
#[doc = "Field `CC1_MATCH` reader - Mask bit for corresponding bit in interrupt request register."]
pub type CC1_MATCH_R = crate::BitReader<bool>;
#[doc = "Field `CC1_MATCH` writer - Mask bit for corresponding bit in interrupt request register."]
pub type CC1_MATCH_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
impl R {
