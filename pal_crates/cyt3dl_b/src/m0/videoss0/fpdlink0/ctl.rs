...
#[doc = "Field `PD_TX` reader - Power down bit, when high all blocks inside the FPDLink block shall be powered down"]
pub type PD_TX_R = crate::BitReader<PD_TX_A>;
#[doc = "Power down bit, when high all blocks inside the FPDLink block shall be powered down\n\nValue on reset: 1"]
...
#[doc = "Field `PD_TX` writer - Power down bit, when high all blocks inside the FPDLink block shall be powered down"]
...
#[doc = "Field `ENABLED` reader - Enable bit for FPDLink"]
pub type ENABLED_R = crate::BitReader<ENABLED_A>;
#[doc = "Enable bit for FPDLink\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ENABLED_A {
...
#[doc = "Field `ENABLED` writer - Enable bit for FPDLink"]
...
impl R {
    #[doc = "Bit 0 - Power down bit, when high all blocks inside the FPDLink block shall be powered down"]
    #[inline(always)]
    pub fn pd_tx(&self) -> PD_TX_R {
        PD_TX_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 31 - Enable bit for FPDLink"]
    #[inline(always)]
