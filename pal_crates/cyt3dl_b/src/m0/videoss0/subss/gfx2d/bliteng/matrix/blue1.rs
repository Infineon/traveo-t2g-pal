...
#[doc = "Field `A33` reader - Value for blue input. (format is signed fix-point 3.10)"]
pub type A33_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A33` writer - Value for blue input. (format is signed fix-point 3.10)"]
pub type A33_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BLUE1_SPEC, u16, u16, 13, O>;
#[doc = "Field `A34` reader - Value for alpha input. (format is signed fix-point 3.10)"]
pub type A34_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A34` writer - Value for alpha input. (format is signed fix-point 3.10)"]
