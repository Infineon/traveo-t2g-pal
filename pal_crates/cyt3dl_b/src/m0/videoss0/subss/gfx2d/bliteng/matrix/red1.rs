...
#[doc = "Field `A13` reader - Value for blue input. (format is signed fix-point 3.10)"]
pub type A13_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A13` writer - Value for blue input. (format is signed fix-point 3.10)"]
pub type A13_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RED1_SPEC, u16, u16, 13, O>;
#[doc = "Field `A14` reader - Value for alpha input. (format is signed fix-point 3.10)"]
pub type A14_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A14` writer - Value for alpha input. (format is signed fix-point 3.10)"]
