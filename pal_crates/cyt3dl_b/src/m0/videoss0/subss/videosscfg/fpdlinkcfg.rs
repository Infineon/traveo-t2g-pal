...
#[doc = "Field `FPDLINKSEL` reader - Selects the channel mode for the two FPDlink interfaces."]
pub type FPDLINKSEL_R = crate::BitReader<FPDLINKSEL_A>;
#[doc = "Selects the channel mode for the two FPDlink interfaces.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum FPDLINKSEL_A {
    #[doc = "0: FPDlink 0 and 1 are operating independently, driven by the two Display Engine 0 and 1."]
    SINGLE = 0,
    #[doc = "1: FPDlink 0 and 1 are operating synchronously, both driven by Display Engine 0."]
    DUAL = 1,
}
...
#[doc = "Field `FPDLINKSEL` writer - Selects the channel mode for the two FPDlink interfaces."]
pub type FPDLINKSEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, FPDLINKCFG_SPEC, FPDLINKSEL_A, O>;
impl<'a, const O: u8> FPDLINKSEL_W<'a, O> {
    #[doc = "FPDlink 0 and 1 are operating independently, driven by the two Display Engine 0 and 1."]
    #[inline(always)]
    pub fn single(self) -> &'a mut W {
        self.variant(FPDLINKSEL_A::SINGLE)
    }
    #[doc = "FPDlink 0 and 1 are operating synchronously, both driven by Display Engine 0."]
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - Selects the channel mode for the two FPDlink interfaces."]
    #[inline(always)]
