...
#[doc = "Field `CLIPWINDOWXOFFSET4` reader - Horizontal position (X). (format is signed integer)"]
pub type CLIPWINDOWXOFFSET4_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWXOFFSET4` writer - Horizontal position (X). (format is signed integer)"]
pub type CLIPWINDOWXOFFSET4_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLIPWINDOWOFFSET4_SPEC, u16, u16, 15, O>;
#[doc = "Field `CLIPWINDOWYOFFSET4` reader - Vertical position (Y). (format is signed integer)"]
pub type CLIPWINDOWYOFFSET4_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWYOFFSET4` writer - Vertical position (Y). (format is signed integer)"]
