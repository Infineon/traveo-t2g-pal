...
#[doc = "Field `LAYERXOFFSET3` reader - Horizontal offset (X). (format is signed integer)"]
pub type LAYERXOFFSET3_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LAYERXOFFSET3` writer - Horizontal offset (X). (format is signed integer)"]
pub type LAYERXOFFSET3_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYEROFFSET3_SPEC, u16, u16, 15, O>;
#[doc = "Field `LAYERYOFFSET3` reader - Vertical offset (Y). (format is signed integer)"]
pub type LAYERYOFFSET3_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LAYERYOFFSET3` writer - Vertical offset (Y). (format is signed integer)"]
