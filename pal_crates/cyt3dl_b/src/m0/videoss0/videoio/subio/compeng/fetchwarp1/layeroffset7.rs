...
#[doc = "Field `LAYERXOFFSET7` reader - Horizontal offset (X). (format is signed integer)"]
pub type LAYERXOFFSET7_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LAYERXOFFSET7` writer - Horizontal offset (X). (format is signed integer)"]
pub type LAYERXOFFSET7_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYEROFFSET7_SPEC, u16, u16, 15, O>;
#[doc = "Field `LAYERYOFFSET7` reader - Vertical offset (Y). (format is signed integer)"]
pub type LAYERYOFFSET7_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LAYERYOFFSET7` writer - Vertical offset (Y). (format is signed integer)"]
