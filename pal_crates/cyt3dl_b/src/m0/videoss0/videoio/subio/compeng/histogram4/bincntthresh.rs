...
#[doc = "Field `BINCNT_THRESH` reader - Bin counters below this threshold will be reported as 0. This threshold value will also affect the BINCNT_ACCU mode where 0 will be added for all bin counters below the threshold. (format is unsigned integer)"]
pub type BINCNT_THRESH_R = crate::FieldReader<u32, u32>;
#[doc = "Field `BINCNT_THRESH` writer - Bin counters below this threshold will be reported as 0. This threshold value will also affect the BINCNT_ACCU mode where 0 will be added for all bin counters below the threshold. (format is unsigned integer)"]
pub type BINCNT_THRESH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, BINCNTTHRESH_SPEC, u32, u32, 29, O>;
impl R {
    #[doc = "Bits 0:28 - Bin counters below this threshold will be reported as 0. This threshold value will also affect the BINCNT_ACCU mode where 0 will be added for all bin counters below the threshold. (format is unsigned integer)"]
    #[inline(always)]
