#![doc = "Peripheral access API for CYT3DL microcontrollers (generated using svd2rust v0.28.0 (54a7f49 2023-02-14))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
unsafe impl Send for SMIF1 {}
impl SMIF1 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const smif0::RegisterBlock = 0x4043_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const smif0::RegisterBlock {
        Self::PTR
...
impl core::fmt::Debug for SMIF1 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SMIF1").finish()
    }
}
#[doc = "Serial Memory Interface"]
pub use self::smif0 as smif1;
