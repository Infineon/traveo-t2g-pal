...
#[doc = "Field `SSEL_HOLD_DEL` reader - Indicates the SPI SELECT hold delay (between SPI clock edge to sample the last MISO bit, and SELECT deactivation). '0': 0.75 SPI clock cycles '1': 1.75 SPI clock cycles Only applies in SPI MOTOROLA submode and when SCLK_CONTINUOUS=0, CTRL.OVS>=3. above are ideal case at SCB block level, and there is inaccuracy of one clk_scb cycle."]
pub type SSEL_HOLD_DEL_R = crate::BitReader<bool>;
#[doc = "Field `SSEL_HOLD_DEL` writer - Indicates the SPI SELECT hold delay (between SPI clock edge to sample the last MISO bit, and SELECT deactivation). '0': 0.75 SPI clock cycles '1': 1.75 SPI clock cycles Only applies in SPI MOTOROLA submode and when SCLK_CONTINUOUS=0, CTRL.OVS>=3. above are ideal case at SCB block level, and there is inaccuracy of one clk_scb cycle."]
pub type SSEL_HOLD_DEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_CTRL_SPEC, bool, O>;
#[doc = "Field `SSEL_INTER_FRAME_DEL` reader - Indicates the SPI SELECT inter-dataframe delay (between SELECT deactivation and SELECT activation). '0': 1.5 SPI clock cycles '1': 2.5 SPI clock cycles Only applies in SPI MOTOROLA submode and when SPI_CTRL.SSEL_CONTINUOUS=0, CTRL.OVS>=3. above are ideal case at SCB block level, and there is inaccuracy of one clk_scb cycle."]
pub type SSEL_INTER_FRAME_DEL_R = crate::BitReader<bool>;
#[doc = "Field `SSEL_INTER_FRAME_DEL` writer - Indicates the SPI SELECT inter-dataframe delay (between SELECT deactivation and SELECT activation). '0': 1.5 SPI clock cycles '1': 2.5 SPI clock cycles Only applies in SPI MOTOROLA submode and when SPI_CTRL.SSEL_CONTINUOUS=0, CTRL.OVS>=3. above are ideal case at SCB block level, and there is inaccuracy of one clk_scb cycle."]
...
impl R {
    ...
    #[doc = "Bit 13 - Indicates the SPI SELECT hold delay (between SPI clock edge to sample the last MISO bit, and SELECT deactivation). '0': 0.75 SPI clock cycles '1': 1.75 SPI clock cycles Only applies in SPI MOTOROLA submode and when SCLK_CONTINUOUS=0, CTRL.OVS>=3. above are ideal case at SCB block level, and there is inaccuracy of one clk_scb cycle."]
    #[inline(always)]
    pub fn ssel_hold_del(&self) -> SSEL_HOLD_DEL_R {
        SSEL_HOLD_DEL_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Indicates the SPI SELECT inter-dataframe delay (between SELECT deactivation and SELECT activation). '0': 1.5 SPI clock cycles '1': 2.5 SPI clock cycles Only applies in SPI MOTOROLA submode and when SPI_CTRL.SSEL_CONTINUOUS=0, CTRL.OVS>=3. above are ideal case at SCB block level, and there is inaccuracy of one clk_scb cycle."]
    #[inline(always)]
