...
pub type RESET_OCD_DPSLP_LINREG_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RES_CAUSE_SPEC, bool, O>;
#[doc = "Field `RESET_OCD_REGHC` reader - Overcurrent detection from REGHC (if present). If REGHC is not present, hardware will never set this bit. This is a high-voltage cause bit that blocks recording of other high-voltage cause bits, except RESET_PORVDDD. Hardware clears this bit during POR."]
pub type RESET_OCD_REGHC_R = crate::BitReader<bool>;
#[doc = "Field `RESET_OCD_REGHC` writer - Overcurrent detection from REGHC (if present). If REGHC is not present, hardware will never set this bit. This is a high-voltage cause bit that blocks recording of other high-voltage cause bits, except RESET_PORVDDD. Hardware clears this bit during POR."]
pub type RESET_OCD_REGHC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RES_CAUSE_SPEC, bool, O>;
#[doc = "Field `RESET_PMIC` reader - PMIC status triggered a reset. If PMIC control is not present, hardware will never set this bit. This is a high-voltage cause bit that blocks recording of other high-voltage cause bits, except RESET_PORVDDD. Hardware clears this bit during POR."]
pub type RESET_PMIC_R = crate::BitReader<bool>;
#[doc = "Field `RESET_PMIC` writer - PMIC status triggered a reset. If PMIC control is not present, hardware will never set this bit. This is a high-voltage cause bit that blocks recording of other high-voltage cause bits, except RESET_PORVDDD. Hardware clears this bit during POR."]
pub type RESET_PMIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RES_CAUSE_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 25 - Overcurrent detection from REGHC (if present). If REGHC is not present, hardware will never set this bit. This is a high-voltage cause bit that blocks recording of other high-voltage cause bits, except RESET_PORVDDD. Hardware clears this bit during POR."]
    #[inline(always)]
    pub fn reset_ocd_reghc(&self) -> RESET_OCD_REGHC_R {
        RESET_OCD_REGHC_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - PMIC status triggered a reset. If PMIC control is not present, hardware will never set this bit. This is a high-voltage cause bit that blocks recording of other high-voltage cause bits, except RESET_PORVDDD. Hardware clears this bit during POR."]
    #[inline(always)]
    pub fn reset_pmic(&self) -> RESET_PMIC_R {
        RESET_PMIC_R::new(((self.bits >> 26) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reset_ocd_reghc(&mut self) -> RESET_OCD_REGHC_W<25> {
        RESET_OCD_REGHC_W::new(self)
    }
    #[doc = "Bit 26 - PMIC status triggered a reset. If PMIC control is not present, hardware will never set this bit. This is a high-voltage cause bit that blocks recording of other high-voltage cause bits, except RESET_PORVDDD. Hardware clears this bit during POR."]
    #[inline(always)]
    #[must_use]
    pub fn reset_pmic(&mut self) -> RESET_PMIC_W<26> {
        RESET_PMIC_W::new(self)
    }
    #[doc = "Bit 28 - PXRES triggered. This is a high-voltage cause bit that blocks recording of other high-voltage cause bits, except RESET_PORVDDD. Hardware clears this bit during POR. This bit is not blocked by other HV cause bits."]
    #[inline(always)]
    #[must_use]
