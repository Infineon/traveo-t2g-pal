...
#[doc = "Field `LINECOUNTERTB4` reader - Holds the scheduled line of the frame that is being executed in TB4. The value of this register is routed outside CmdSeq."]
pub type LINECOUNTERTB4_R = crate::FieldReader<u16, u16>;
impl R {
    #[doc = "Bits 0:15 - Holds the scheduled line of the frame that is being executed in TB4. The value of this register is routed outside CmdSeq."]
    #[inline(always)]
