...
#[doc = "Field `A12` reader - A12, given in signed fixed-point 26.6 two's complement notation. (format is signed fix-point 26.6)"]
pub type A12_R = crate::FieldReader<u32, u32>;
#[doc = "Field `A12` writer - A12, given in signed fixed-point 26.6 two's complement notation. (format is signed fix-point 26.6)"]
pub type A12_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TRANSFORMATIONMATRIXA12_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - A12, given in signed fixed-point 26.6 two's complement notation. (format is signed fix-point 26.6)"]
    #[inline(always)]
