...
#[doc = "Field `MODE` reader - Mode which switches Dither Unit on/off. (format is unsigned integer)"]
pub type MODE_R = crate::BitReader<MODE_A>;
#[doc = "Mode which switches Dither Unit on/off. (format is unsigned integer)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MODE_A {
    #[doc = "0: Neutral mode. Pixels by-pass the Dither Unit, all other settings are ignored."]
    NEUTRAL = 0,
    #[doc = "1: Dither Unit is active."]
    ACTIVE = 1,
}
...
#[doc = "Field `MODE` writer - Mode which switches Dither Unit on/off. (format is unsigned integer)"]
pub type MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CONTROL_SPEC, MODE_A, O>;
impl<'a, const O: u8> MODE_W<'a, O> {
    #[doc = "Neutral mode. Pixels by-pass the Dither Unit, all other settings are ignored."]
    #[inline(always)]
    pub fn neutral(self) -> &'a mut W {
        self.variant(MODE_A::NEUTRAL)
    }
    #[doc = "Dither Unit is active."]
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - Mode which switches Dither Unit on/off. (format is unsigned integer)"]
    #[inline(always)]
