...
#[doc = "Field `FRAMEWIDTH` reader - Frame width in pixels minus one."]
pub type FRAMEWIDTH_R = crate::FieldReader<u16, u16>;
#[doc = "Field `FRAMEWIDTH` writer - Frame width in pixels minus one."]
pub type FRAMEWIDTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FRAMEDIMENSIONS_SPEC, u16, u16, 14, O>;
#[doc = "Field `FRAMEHEIGHT` reader - Frame height in pixels minus one."]
pub type FRAMEHEIGHT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `FRAMEHEIGHT` writer - Frame height in pixels minus one."]
pub type FRAMEHEIGHT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FRAMEDIMENSIONS_SPEC, u16, u16, 14, O>;
#[doc = "Field `EMPTYFRAME` reader - When enabled output frame is empty. FrameWidth/Height settings have no effect then. Can be used to load shadows or to generate synchronization signals only (frame/sequence complete)."]
pub type EMPTYFRAME_R = crate::BitReader<bool>;
#[doc = "Field `EMPTYFRAME` writer - When enabled output frame is empty. FrameWidth/Height settings have no effect then. Can be used to load shadows or to generate synchronization signals only (frame/sequence complete)."]
pub type EMPTYFRAME_W<'a, const O: u8> = crate::BitWriter<'a, u32, FRAMEDIMENSIONS_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:13 - Frame width in pixels minus one."]
    #[inline(always)]
    pub fn framewidth(&self) -> FRAMEWIDTH_R {
        FRAMEWIDTH_R::new((self.bits & 0x3fff) as u16)
    }
    #[doc = "Bits 16:29 - Frame height in pixels minus one."]
    #[inline(always)]
    pub fn frameheight(&self) -> FRAMEHEIGHT_R {
        FRAMEHEIGHT_R::new(((self.bits >> 16) & 0x3fff) as u16)
    }
    #[doc = "Bit 31 - When enabled output frame is empty. FrameWidth/Height settings have no effect then. Can be used to load shadows or to generate synchronization signals only (frame/sequence complete)."]
    #[inline(always)]
