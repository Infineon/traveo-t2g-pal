...
#[doc = "Field `CONSTANTBLUE` reader - Blue or V (chroma)."]
pub type CONSTANTBLUE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CONSTANTBLUE` writer - Blue or V (chroma)."]
pub type CONSTANTBLUE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONSTANTCOLOR_SPEC, u8, u8, 8, O>;
#[doc = "Field `CONSTANTGREEN` reader - Green or U (chroma)."]
pub type CONSTANTGREEN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CONSTANTGREEN` writer - Green or U (chroma)."]
pub type CONSTANTGREEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONSTANTCOLOR_SPEC, u8, u8, 8, O>;
#[doc = "Field `CONSTANTRED` reader - Red or Y (luma)."]
pub type CONSTANTRED_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CONSTANTRED` writer - Red or Y (luma)."]
