...
#[doc = "Field `LAYERXOFFSET2` reader - Horizontal offset (X). (format is signed integer)"]
pub type LAYERXOFFSET2_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LAYERXOFFSET2` writer - Horizontal offset (X). (format is signed integer)"]
pub type LAYERXOFFSET2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYEROFFSET2_SPEC, u16, u16, 15, O>;
#[doc = "Field `LAYERYOFFSET2` reader - Vertical offset (Y). (format is signed integer)"]
pub type LAYERYOFFSET2_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LAYERYOFFSET2` writer - Vertical offset (Y). (format is signed integer)"]
