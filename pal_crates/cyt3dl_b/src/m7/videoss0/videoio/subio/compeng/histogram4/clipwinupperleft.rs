...
#[doc = "Field `CLIP_X` reader - X coordinate of upper left corner of clip window. (format is unsigned integer)"]
pub type CLIP_X_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIP_X` writer - X coordinate of upper left corner of clip window. (format is unsigned integer)"]
pub type CLIP_X_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLIPWINUPPERLEFT_SPEC, u16, u16, 14, O>;
#[doc = "Field `CLIP_Y` reader - Y coordinate of upper left corner of clip window. (format is unsigned integer)"]
pub type CLIP_Y_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIP_Y` writer - Y coordinate of upper left corner of clip window. (format is unsigned integer)"]
pub type CLIP_Y_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLIPWINUPPERLEFT_SPEC, u16, u16, 14, O>;
impl R {
    #[doc = "Bits 0:13 - X coordinate of upper left corner of clip window. (format is unsigned integer)"]
    #[inline(always)]
    pub fn clip_x(&self) -> CLIP_X_R {
        CLIP_X_R::new((self.bits & 0x3fff) as u16)
    }
    #[doc = "Bits 16:29 - Y coordinate of upper left corner of clip window. (format is unsigned integer)"]
    #[inline(always)]
