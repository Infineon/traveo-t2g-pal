#[doc = "Register `RECEIVE_Q1_PTR` reader"]
pub struct R(crate::R<RECEIVE_Q1_PTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RECEIVE_Q1_PTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RECEIVE_Q1_PTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RECEIVE_Q1_PTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RECEIVE_Q1_PTR` writer"]
pub struct W(crate::W<RECEIVE_Q1_PTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RECEIVE_Q1_PTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RECEIVE_Q1_PTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RECEIVE_Q1_PTR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DMA_RX_DIS_Q_W<'a, const O: u8> = crate::BitWriter<'a, u32, RECEIVE_Q1_PTR_SPEC, bool, O>;
...
pub type DMA_RX_Q_PTR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RECEIVE_Q1_PTR_SPEC, u32, u32, 30, O>;
impl R {
