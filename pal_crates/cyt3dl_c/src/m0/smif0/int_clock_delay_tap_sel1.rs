...
#[doc = "Field `DATA_BIT4` reader - Delay line tap selection for the IP's spi_data\\[4\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). See DATA_BIT0."]
pub type DATA_BIT4_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DATA_BIT4` writer - Delay line tap selection for the IP's spi_data\\[4\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). See DATA_BIT0."]
pub type DATA_BIT4_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, INT_CLOCK_DELAY_TAP_SEL1_SPEC, u8, u8, 8, O>;
#[doc = "Field `DATA_BIT5` reader - Delay line tap selection for the IP's spi_data\\[5\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). See DATA_BIT0."]
pub type DATA_BIT5_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DATA_BIT5` writer - Delay line tap selection for the IP's spi_data\\[5\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). See DATA_BIT0."]
pub type DATA_BIT5_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, INT_CLOCK_DELAY_TAP_SEL1_SPEC, u8, u8, 8, O>;
#[doc = "Field `DATA_BIT6` reader - Delay line tap selection for the IP's spi_data\\[6\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). See DATA_BIT0."]
pub type DATA_BIT6_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DATA_BIT6` writer - Delay line tap selection for the IP's spi_data\\[6\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). See DATA_BIT0."]
pub type DATA_BIT6_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, INT_CLOCK_DELAY_TAP_SEL1_SPEC, u8, u8, 8, O>;
#[doc = "Field `DATA_BIT7` reader - Delay line tap selection for the IP's spi_data\\[7\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). See DATA_BIT0."]
pub type DATA_BIT7_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DATA_BIT7` writer - Delay line tap selection for the IP's spi_data\\[7\\]
(note the mapping of spi_data to IO in DEVICE.CTL.DATA_SEL). See DATA_BIT0."]
