...
pub struct TDM_TX_STRUCT {
    ...
    #[doc = "0x24 - TX route control"]
    pub tx_route_ctl: TX_ROUTE_CTL,
    _reserved5: [u8; 0x58],
...
#[doc = "TX test control"]
pub mod tx_test_ctl;
#[doc = "TX_ROUTE_CTL (rw) register accessor: an alias for `Reg<TX_ROUTE_CTL_SPEC>`"]
pub type TX_ROUTE_CTL = crate::Reg<tx_route_ctl::TX_ROUTE_CTL_SPEC>;
#[doc = "TX route control"]
pub mod tx_route_ctl;
