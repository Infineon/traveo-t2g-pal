...
#[doc = "Field `S_VAL` reader - Value of last received control word on the secondary input. If a 39 bit pixel channel is connected, the mapping is as follows: s_val\\[31:0\\]
...
impl R {
    #[doc = "Bits 0:31 - Value of last received control word on the secondary input. If a 39 bit pixel channel is connected, the mapping is as follows: s_val\\[31:0\\]
= { data\\[37:22\\], data\\[19:12\\], data\\[9:2\\]
}. For debug purposes only, read when stable only, otherwise read data might be corrupted."]
    #[inline(always)]
