...
#[doc = "Field `SETFETCHBURSTLENGTH` reader - Set this to the maximum burst length that should be used on the AXI command fetch interface. Please note that SetFetchBurstLength has to be smaller or equal to MaxFetchBurstLength and it has to be one at the least."]
pub type SETFETCHBURSTLENGTH_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SETFETCHBURSTLENGTH` writer - Set this to the maximum burst length that should be used on the AXI command fetch interface. Please note that SetFetchBurstLength has to be smaller or equal to MaxFetchBurstLength and it has to be one at the least."]
...
pub type SETSTOREBURSTLENGTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, STATICBURSTBUFFERMANAGEMENT_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4 - Set this to the maximum burst length that should be used on the AXI command fetch interface. Please note that SetFetchBurstLength has to be smaller or equal to MaxFetchBurstLength and it has to be one at the least."]
    #[inline(always)]
