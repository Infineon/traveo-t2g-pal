...
pub type ALPHACONSTENABLE5_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LAYERPROPERTY5_SPEC, bool, O>;
#[doc = "Field `ALPHAMASKENABLE5` reader - See AlphaMaskSelect0."]
pub type ALPHAMASKENABLE5_R = crate::BitReader<bool>;
#[doc = "Field `ALPHAMASKENABLE5` writer - See AlphaMaskSelect0."]
pub type ALPHAMASKENABLE5_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LAYERPROPERTY5_SPEC, bool, O>;
...
pub type RGBALPHACONSTENABLE5_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LAYERPROPERTY5_SPEC, bool, O>;
#[doc = "Field `RGBALPHAMASKENABLE5` reader - See RGBAlphaMaskSelect0."]
pub type RGBALPHAMASKENABLE5_R = crate::BitReader<bool>;
#[doc = "Field `RGBALPHAMASKENABLE5` writer - See RGBAlphaMaskSelect0."]
pub type RGBALPHAMASKENABLE5_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LAYERPROPERTY5_SPEC, bool, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn alphamaskenable5(&self) -> ALPHAMASKENABLE5_R {
        ALPHAMASKENABLE5_R::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn rgbalphamaskenable5(&self) -> RGBALPHAMASKENABLE5_R {
        RGBALPHAMASKENABLE5_R::new(((self.bits >> 9) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alphamaskenable5(&mut self) -> ALPHAMASKENABLE5_W<5> {
        ALPHAMASKENABLE5_W::new(self)
    }
    #[doc = "Bit 6 - See AlphaTransSelect0."]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn rgbalphamaskenable5(&mut self) -> RGBALPHAMASKENABLE5_W<9> {
        RGBALPHAMASKENABLE5_W::new(self)
    }
    #[doc = "Bit 10 - See RGBAlphaTransSelect0."]
    #[inline(always)]
    #[must_use]
...
#[doc = "`reset()` method sets LAYERPROPERTY5 to value 0x08"]
