...
#[doc = "Field `CLIP_EN` reader - Switch for clip window. If enabled all pixels outside the clip window are not taken into account. (format is unsigned integer)"]
pub type CLIP_EN_R = crate::BitReader<CLIP_EN_A>;
#[doc = "Switch for clip window. If enabled all pixels outside the clip window are not taken into account. (format is unsigned integer)\n\nValue on reset: 0"]
...
#[doc = "Field `CLIP_EN` writer - Switch for clip window. If enabled all pixels outside the clip window are not taken into account. (format is unsigned integer)"]
...
range can be selected here. (format is unsigned integer)"]
...
are delivered directly at histogram input or when YCrCb components are converted to RGB by the appropriate setting of register field color_space_mode. Luma or luminance counting is delivered in first (component0) histogram. (format is unsigned integer)"]
...
impl R {
    #[doc = "Bit 0 - Switch for clip window. If enabled all pixels outside the clip window are not taken into account. (format is unsigned integer)"]
    #[inline(always)]
