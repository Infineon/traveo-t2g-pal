...
#[doc = "Field `LDATA_POLARITY` reader - Left Data polarity. '0' - No change in Left data. '1' - Invert (2's complement) Left data. The name of this field corresponds to the default setting. The function of this field always inverts bits 31:16 before the data is written into the FIFO. LDATA_SEL does not affect which bits are inverted."]
pub type LDATA_POLARITY_R = crate::BitReader<bool>;
#[doc = "Field `LDATA_POLARITY` writer - Left Data polarity. '0' - No change in Left data. '1' - Invert (2's complement) Left data. The name of this field corresponds to the default setting. The function of this field always inverts bits 31:16 before the data is written into the FIFO. LDATA_SEL does not affect which bits are inverted."]
pub type LDATA_POLARITY_W<'a, const O: u8> = crate::BitWriter<'a, u32, IF_CTL_SPEC, bool, O>;
#[doc = "Field `RDATA_POLARITY` reader - Right Data polarity. '0' - No change in Right data. '1' - Invert (2's complement) Right data. The name of this field corresponds to the default setting. The function of this field always inverts bits 15:0 before the data is written into the FIFO. RDATA_SEL does not affect which bits are inverted."]
pub type RDATA_POLARITY_R = crate::BitReader<bool>;
#[doc = "Field `RDATA_POLARITY` writer - Right Data polarity. '0' - No change in Right data. '1' - Invert (2's complement) Right data. The name of this field corresponds to the default setting. The function of this field always inverts bits 15:0 before the data is written into the FIFO. RDATA_SEL does not affect which bits are inverted."]
...
#[doc = "Field `DAC_EN` reader - DAC Analog Enable. '0' - DAC Opamp and DAC COM analog bias generator is disabled. '1' - DAC Opamp and DAC COM analog bias generator is enabled. Note that after enabling the DAC Analog circuit, it requires 70ms to be stable. The same ramp up time applies when waking up from DeepSleep. DACEN is only valid when ENABLED=1. Note: This bit does not 'silent' the AudioDAC. CTL.ENABLED=0 is required to 'slient' the AudioDAC"]
pub type DAC_EN_R = crate::BitReader<bool>;
#[doc = "Field `DAC_EN` writer - DAC Analog Enable. '0' - DAC Opamp and DAC COM analog bias generator is disabled. '1' - DAC Opamp and DAC COM analog bias generator is enabled. Note that after enabling the DAC Analog circuit, it requires 70ms to be stable. The same ramp up time applies when waking up from DeepSleep. DACEN is only valid when ENABLED=1. Note: This bit does not 'silent' the AudioDAC. CTL.ENABLED=0 is required to 'slient' the AudioDAC"]
...
impl R {
    ...
    #[doc = "Bit 24 - Left Data polarity. '0' - No change in Left data. '1' - Invert (2's complement) Left data. The name of this field corresponds to the default setting. The function of this field always inverts bits 31:16 before the data is written into the FIFO. LDATA_SEL does not affect which bits are inverted."]
    #[inline(always)]
    pub fn ldata_polarity(&self) -> LDATA_POLARITY_R {
        LDATA_POLARITY_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - Right Data polarity. '0' - No change in Right data. '1' - Invert (2's complement) Right data. The name of this field corresponds to the default setting. The function of this field always inverts bits 15:0 before the data is written into the FIFO. RDATA_SEL does not affect which bits are inverted."]
    #[inline(always)]
...
(default setting). '1': data\\[31:16\\]."]
    ...
    #[doc = "Bit 31 - DAC Analog Enable. '0' - DAC Opamp and DAC COM analog bias generator is disabled. '1' - DAC Opamp and DAC COM analog bias generator is enabled. Note that after enabling the DAC Analog circuit, it requires 70ms to be stable. The same ramp up time applies when waking up from DeepSleep. DACEN is only valid when ENABLED=1. Note: This bit does not 'silent' the AudioDAC. CTL.ENABLED=0 is required to 'slient' the AudioDAC"]
    #[inline(always)]
