...
#[doc = "Field `CLOCK_SEL` reader - Interface clock 'clk_if' selection: '0': SRSS clock clk_if_srss. '1'-'3': undefined. '4': Master interface clock 'mixer_tx_mck_in'. '5'-'7': undefined. Note: the application is always required to program this field to a value different from the default."]
pub type CLOCK_SEL_R = crate::FieldReader<u8, CLOCK_SEL_A>;
#[doc = "Interface clock 'clk_if' selection: '0': SRSS clock clk_if_srss. '1'-'3': undefined. '4': Master interface clock 'mixer_tx_mck_in'. '5'-'7': undefined. Note: the application is always required to program this field to a value different from the default.\n\nValue on reset: 7"]
...
#[doc = "Field `CLOCK_SEL` writer - Interface clock 'clk_if' selection: '0': SRSS clock clk_if_srss. '1'-'3': undefined. '4': Master interface clock 'mixer_tx_mck_in'. '5'-'7': undefined. Note: the application is always required to program this field to a value different from the default."]
...
impl R {
    ...
    #[doc = "Bits 8:10 - Interface clock 'clk_if' selection: '0': SRSS clock clk_if_srss. '1'-'3': undefined. '4': Master interface clock 'mixer_tx_mck_in'. '5'-'7': undefined. Note: the application is always required to program this field to a value different from the default."]
    #[inline(always)]
