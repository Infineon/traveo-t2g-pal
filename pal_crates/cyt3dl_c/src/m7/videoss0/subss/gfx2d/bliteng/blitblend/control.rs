...
#[doc = "Field `MODE` reader - Operation mode for BlitBlend"]
pub type MODE_R = crate::BitReader<MODE_A>;
#[doc = "Operation mode for BlitBlend\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MODE_A {
    #[doc = "0: Neutral mode, only route pixels and commands from primary input to output"]
    NEUTRAL = 0,
...
#[doc = "Field `MODE` writer - Operation mode for BlitBlend"]
pub type MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CONTROL_SPEC, MODE_A, O>;
impl<'a, const O: u8> MODE_W<'a, O> {
    #[doc = "Neutral mode, only route pixels and commands from primary input to output"]
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - Operation mode for BlitBlend"]
    #[inline(always)]
