...
#[doc = "Field `KICK` writer - Software kick, forces a kick signal independent of KICK_MODE. Write 1 to send kick."]
pub type KICK_W<'a, const O: u8> = crate::BitWriter<'a, u32, SOFTWAREKICK_SPEC, bool, O>;
impl W {
    #[doc = "Bit 0 - Software kick, forces a kick signal independent of KICK_MODE. Write 1 to send kick."]
    #[inline(always)]
    #[must_use]
