...
#[doc = "Field `START` writer - Writing a 1 to this field will start generating one frame (for debugging purposes only)."]
pub type START_W<'a, const O: u8> = crate::BitWriter<'a, u32, START_SPEC, bool, O>;
impl W {
    #[doc = "Bit 0 - Writing a 1 to this field will start generating one frame (for debugging purposes only)."]
    #[inline(always)]
    #[must_use]
