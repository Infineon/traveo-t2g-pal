...
#[doc = "Field `CLIPWINDOWXOFFSET7` reader - Horizontal position (X). (format is signed integer)"]
pub type CLIPWINDOWXOFFSET7_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWXOFFSET7` writer - Horizontal position (X). (format is signed integer)"]
pub type CLIPWINDOWXOFFSET7_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLIPWINDOWOFFSET7_SPEC, u16, u16, 15, O>;
#[doc = "Field `CLIPWINDOWYOFFSET7` reader - Vertical position (Y). (format is signed integer)"]
pub type CLIPWINDOWYOFFSET7_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWYOFFSET7` writer - Vertical position (Y). (format is signed integer)"]
