...
impl R {
    ...
    #[doc = "Bit 16 - Returns field polarity of the measured frame. This read value of this field is undefined in display stream context; use in storage, content or safety stream context only. (format is unsigned integer)"]
    #[inline(always)]
