...
#[doc = "Field `BECL` reader - Bit Error Corrected Interrupt Line (not used in M_TTCAN)"]
pub type BECL_R = crate::BitReader<bool>;
#[doc = "Field `BECL` writer - Bit Error Corrected Interrupt Line (not used in M_TTCAN)"]
...
impl R {
    ...
    #[doc = "Bit 20 - Bit Error Corrected Interrupt Line (not used in M_TTCAN)"]
    #[inline(always)]
