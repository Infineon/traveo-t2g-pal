...
#[doc = "Field `TTMIE` reader - Trigger Time Mark Event Internal Enable"]
pub type TTMIE_R = crate::BitReader<bool>;
#[doc = "Field `TTMIE` writer - Trigger Time Mark Event Internal Enable"]
...
#[doc = "Field `IWTE` reader - Initialization Watch Trigger Interrupt Enable"]
pub type IWTE_R = crate::BitReader<bool>;
#[doc = "Field `IWTE` writer - Initialization Watch Trigger Interrupt Enable"]
...
#[doc = "Field `AWE_` reader - Application Watchdog Interrupt Enable"]
pub type AWE__R = crate::BitReader<bool>;
#[doc = "Field `AWE_` writer - Application Watchdog Interrupt Enable"]
...
impl R {
    ...
    #[doc = "Bit 5 - Trigger Time Mark Event Internal Enable"]
    #[inline(always)]
