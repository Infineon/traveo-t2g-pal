...
#[doc = "Field `SLOW_WS` reader - Refer RAM0_CTL0 descriotion."]
pub type SLOW_WS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SLOW_WS` writer - Refer RAM0_CTL0 descriotion."]
pub type SLOW_WS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RAM2_CTL0_SPEC, u8, u8, 2, O>;
#[doc = "Field `FAST_WS` reader - Refer RAM0_CTL0 descriotion."]
pub type FAST_WS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FAST_WS` writer - Refer RAM0_CTL0 descriotion."]
pub type FAST_WS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RAM2_CTL0_SPEC, u8, u8, 2, O>;
#[doc = "Field `ECC_EN` reader - Refer RAM0_CTL0 descriotion."]
pub type ECC_EN_R = crate::BitReader<bool>;
#[doc = "Field `ECC_EN` writer - Refer RAM0_CTL0 descriotion."]
pub type ECC_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RAM2_CTL0_SPEC, bool, O>;
#[doc = "Field `ECC_AUTO_CORRECT` reader - Refer RAM0_CTL0 descriotion."]
pub type ECC_AUTO_CORRECT_R = crate::BitReader<bool>;
#[doc = "Field `ECC_AUTO_CORRECT` writer - Refer RAM0_CTL0 descriotion."]
pub type ECC_AUTO_CORRECT_W<'a, const O: u8> = crate::BitWriter<'a, u32, RAM2_CTL0_SPEC, bool, O>;
...
pub type ECC_INJ_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RAM2_CTL0_SPEC, bool, O>;
...
pub type ECC_CHECK_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, RAM2_CTL0_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:1 - Refer RAM0_CTL0 descriotion."]
    #[inline(always)]
    pub fn slow_ws(&self) -> SLOW_WS_R {
        SLOW_WS_R::new((self.bits & 3) as u8)
    }
    #[doc = "Bits 8:9 - Refer RAM0_CTL0 descriotion."]
    #[inline(always)]
    pub fn fast_ws(&self) -> FAST_WS_R {
        FAST_WS_R::new(((self.bits >> 8) & 3) as u8)
    }
    #[doc = "Bit 16 - Refer RAM0_CTL0 descriotion."]
    #[inline(always)]
    pub fn ecc_en(&self) -> ECC_EN_R {
        ECC_EN_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - Refer RAM0_CTL0 descriotion."]
    #[inline(always)]
