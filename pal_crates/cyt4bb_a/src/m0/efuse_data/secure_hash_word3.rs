...
#[doc = "Field `HASH_WORD3` reader - Secure 128 bits HASH word 3 that is used for authentication in SECURE protection state."]
pub type HASH_WORD3_R = crate::FieldReader<u32, u32>;
#[doc = "Field `HASH_WORD3` writer - Secure 128 bits HASH word 3 that is used for authentication in SECURE protection state."]
pub type HASH_WORD3_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SECURE_HASH_WORD3_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Secure 128 bits HASH word 3 that is used for authentication in SECURE protection state."]
    #[inline(always)]
