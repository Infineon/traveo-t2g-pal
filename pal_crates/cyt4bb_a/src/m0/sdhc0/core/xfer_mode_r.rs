...
pub type DMA_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, XFER_MODE_R_SPEC, bool, O>;
...
pub type BLOCK_COUNT_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, XFER_MODE_R_SPEC, bool, O>;
...
pub type AUTO_CMD_ENABLE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, XFER_MODE_R_SPEC, u8, u8, 2, O>;
...
pub type DATA_XFER_DIR_W<'a, const O: u8> = crate::BitWriter<'a, u16, XFER_MODE_R_SPEC, bool, O>;
...
pub type MULTI_BLK_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u16, XFER_MODE_R_SPEC, bool, O>;
...
pub type RESP_TYPE_W<'a, const O: u8> = crate::BitWriter<'a, u16, XFER_MODE_R_SPEC, bool, O>;
...
pub type RESP_ERR_CHK_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, XFER_MODE_R_SPEC, bool, O>;
...
pub type RESP_INT_DISABLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, XFER_MODE_R_SPEC, bool, O>;
impl R {
