...
pub type ECO_DIV_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CLK_ECO_CONFIG_SPEC, bool, O>;
#[doc = "Field `ECO_EN` reader - Master enable for ECO oscillator. Configure the settings in CLK_ECO_CONFIG2 to work with the selected crystal, before enabling ECO."]
pub type ECO_EN_R = crate::BitReader<bool>;
#[doc = "Field `ECO_EN` writer - Master enable for ECO oscillator. Configure the settings in CLK_ECO_CONFIG2 to work with the selected crystal, before enabling ECO."]
...
impl R {
    ...
    #[doc = "Bit 31 - Master enable for ECO oscillator. Configure the settings in CLK_ECO_CONFIG2 to work with the selected crystal, before enabling ECO."]
    #[inline(always)]
