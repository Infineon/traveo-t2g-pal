...
pub type REGHC_TRANS_USE_OCD_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PWR_REGHC_CTL_SPEC, bool, O>;
#[doc = "Field `REGHC_CONFIGURED` reader - Indicates the REGHC has been configured. This is used to know if REGHC should be enabled in response to a debug power up request. Do not change REGHC settings after this bit is set high."]
pub type REGHC_CONFIGURED_R = crate::BitReader<bool>;
#[doc = "Field `REGHC_CONFIGURED` writer - Indicates the REGHC has been configured. This is used to know if REGHC should be enabled in response to a debug power up request. Do not change REGHC settings after this bit is set high."]
...
impl R {
    ...
    #[doc = "Bit 31 - Indicates the REGHC has been configured. This is used to know if REGHC should be enabled in response to a debug power up request. Do not change REGHC settings after this bit is set high."]
    #[inline(always)]
