...
#[doc = "Field `COMP0` reader - Mask bit for corresponding field in the INTR register."]
pub type COMP0_R = crate::FieldReader<u16, u16>;
#[doc = "Field `COMP0` writer - Mask bit for corresponding field in the INTR register."]
pub type COMP0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, INTR_MASK_SPEC, u16, u16, 16, O>;
impl R {
