...
pub type CMD_TOUT_ERR_SIGNAL_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, ERROR_INT_SIGNAL_EN_R_SPEC, bool, O>;
...
pub type VENDOR_ERR_SIGNAL_EN1_R = crate::BitReader<bool>;
...
pub type VENDOR_ERR_SIGNAL_EN2_R = crate::BitReader<bool>;
...
pub type VENDOR_ERR_SIGNAL_EN3_R = crate::BitReader<bool>;
