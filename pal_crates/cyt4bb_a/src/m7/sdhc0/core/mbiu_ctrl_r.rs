...
pub type UNDEFL_INCR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, MBIU_CTRL_R_SPEC, bool, O>;
...
pub type BURST_INCR4_EN_R = crate::BitReader<bool>;
...
pub type BURST_INCR4_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, MBIU_CTRL_R_SPEC, bool, O>;
...
pub type BURST_INCR8_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, MBIU_CTRL_R_SPEC, bool, O>;
...
pub type BURST_INCR16_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, MBIU_CTRL_R_SPEC, bool, O>;
impl R {
