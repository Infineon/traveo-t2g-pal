...
pub type CODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RD_CMD_CTL_SPEC, u8, u8, 8, O>;
#[doc = "Field `CODEH` reader - Command high byte code. This field specifies the most significant command byte, sent before the least significant command byte (CODE). It is only used when PRESENT2 = '2'."]
pub type CODEH_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CODEH` writer - Command high byte code. This field specifies the most significant command byte, sent before the least significant command byte (CODE). It is only used when PRESENT2 = '2'."]
pub type CODEH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RD_CMD_CTL_SPEC, u8, u8, 8, O>;
...
pub type WIDTH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RD_CMD_CTL_SPEC, u8, u8, 2, O>;
#[doc = "Field `DDR_MODE` reader - Mode of transfer rate: '0': SDR mode '1': DDR mode"]
pub type DDR_MODE_R = crate::BitReader<bool>;
#[doc = "Field `DDR_MODE` writer - Mode of transfer rate: '0': SDR mode '1': DDR mode"]
pub type DDR_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RD_CMD_CTL_SPEC, bool, O>;
#[doc = "Field `PRESENT2` reader - Presence of command field: '0': not present '1': present (1 Byte) '2': present (2 Byte for OPI) Note: For octal data transfer with DDR mode (WIDTH='3' and DDR_MODE='1') either the HB protocol needs to be selected (by ADDR_CTL.SIZE3='7') or this field needs to be set to PRESENT2='2'."]
pub type PRESENT2_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PRESENT2` writer - Presence of command field: '0': not present '1': present (1 Byte) '2': present (2 Byte for OPI) Note: For octal data transfer with DDR mode (WIDTH='3' and DDR_MODE='1') either the HB protocol needs to be selected (by ADDR_CTL.SIZE3='7') or this field needs to be set to PRESENT2='2'."]
pub type PRESENT2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RD_CMD_CTL_SPEC, u8, u8, 2, O>;
impl R {
    ...
    #[doc = "Bits 8:15 - Command high byte code. This field specifies the most significant command byte, sent before the least significant command byte (CODE). It is only used when PRESENT2 = '2'."]
    #[inline(always)]
    ...
    #[doc = "Bit 18 - Mode of transfer rate: '0': SDR mode '1': DDR mode"]
    #[inline(always)]
    pub fn ddr_mode(&self) -> DDR_MODE_R {
        DDR_MODE_R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bits 30:31 - Presence of command field: '0': not present '1': present (1 Byte) '2': present (2 Byte for OPI) Note: For octal data transfer with DDR mode (WIDTH='3' and DDR_MODE='1') either the HB protocol needs to be selected (by ADDR_CTL.SIZE3='7') or this field needs to be set to PRESENT2='2'."]
    #[inline(always)]
