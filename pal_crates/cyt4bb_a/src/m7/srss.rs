...
pub struct RegisterBlock {
    ...
    _reserved56: [u8; 0x0730],
    #[doc = "0x2050 - XRES DFT Key firmware controlled test mode entry register"]
    pub tst_xres_key: TST_XRES_KEY,
...
#[doc = "400MHz PLL Configuration Register"]
pub mod clk_pll400m;
#[doc = "TST_XRES_KEY (rw) register accessor: an alias for `Reg<TST_XRES_KEY_SPEC>`"]
pub type TST_XRES_KEY = crate::Reg<tst_xres_key::TST_XRES_KEY_SPEC>;
#[doc = "XRES DFT Key firmware controlled test mode entry register"]
pub mod tst_xres_key;
