#[doc = "Register `DMA_RXBUF_SIZE_Q1` reader"]
pub struct R(crate::R<DMA_RXBUF_SIZE_Q1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_RXBUF_SIZE_Q1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_RXBUF_SIZE_Q1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_RXBUF_SIZE_Q1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA_RXBUF_SIZE_Q1` writer"]
pub struct W(crate::W<DMA_RXBUF_SIZE_Q1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA_RXBUF_SIZE_Q1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA_RXBUF_SIZE_Q1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA_RXBUF_SIZE_Q1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DMA_RX_Q_BUF_SIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMA_RXBUF_SIZE_Q1_SPEC, u8, u8, 8, O>;
impl R {
...
#[doc = "Receive Buffer queue 1 Size\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dma_rxbuf_size_q1](index.html) module"]
pub struct DMA_RXBUF_SIZE_Q1_SPEC;
impl crate::RegisterSpec for DMA_RXBUF_SIZE_Q1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dma_rxbuf_size_q1::R](R) reader structure"]
impl crate::Readable for DMA_RXBUF_SIZE_Q1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_rxbuf_size_q1::W](W) writer structure"]
impl crate::Writable for DMA_RXBUF_SIZE_Q1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DMA_RXBUF_SIZE_Q1 to value 0x18"]
impl crate::Resettable for DMA_RXBUF_SIZE_Q1_SPEC {
