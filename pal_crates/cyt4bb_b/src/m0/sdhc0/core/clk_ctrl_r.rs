...
pub type INTERNAL_CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, CLK_CTRL_R_SPEC, bool, O>;
...
pub type SD_CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, CLK_CTRL_R_SPEC, bool, O>;
...
pub type PLL_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, CLK_CTRL_R_SPEC, bool, O>;
...
pub type CLK_GEN_SELECT_W<'a, const O: u8> = crate::BitWriter<'a, u16, CLK_CTRL_R_SPEC, bool, O>;
...
pub type UPPER_FREQ_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, CLK_CTRL_R_SPEC, u8, u8, 2, O>;
...
pub type FREQ_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u16, CLK_CTRL_R_SPEC, u8, u8, 8, O>;
impl R {
