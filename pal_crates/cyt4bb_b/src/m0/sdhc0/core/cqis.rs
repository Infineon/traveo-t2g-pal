...
pub type GCE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CQIS_SPEC, bool, O>;
#[doc = "Field `ICCE` reader - N/A"]
pub type ICCE_R = crate::BitReader<bool>;
#[doc = "Field `ICCE` writer - N/A"]
pub type ICCE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CQIS_SPEC, bool, O>;
impl R {
