...
pub type CMD_COMPLETE_STAT_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NORMAL_INT_STAT_EN_R_SPEC, bool, O>;
...
pub type INT_A_STAT_EN_R = crate::BitReader<bool>;
#[doc = "Field `INT_A_STAT_EN` writer - N/A"]
pub type INT_A_STAT_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NORMAL_INT_STAT_EN_R_SPEC, bool, O>;
#[doc = "Field `INT_B_STAT_EN` reader - N/A"]
pub type INT_B_STAT_EN_R = crate::BitReader<bool>;
#[doc = "Field `INT_B_STAT_EN` writer - N/A"]
pub type INT_B_STAT_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NORMAL_INT_STAT_EN_R_SPEC, bool, O>;
#[doc = "Field `INT_C_STAT_EN` reader - N/A"]
pub type INT_C_STAT_EN_R = crate::BitReader<bool>;
#[doc = "Field `INT_C_STAT_EN` writer - N/A"]
pub type INT_C_STAT_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NORMAL_INT_STAT_EN_R_SPEC, bool, O>;
...
pub type FX_EVENT_STAT_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NORMAL_INT_STAT_EN_R_SPEC, bool, O>;
