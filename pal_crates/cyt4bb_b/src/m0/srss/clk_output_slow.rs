...
pub enum SLOW_SEL0_A {
    ...
    NC = 0,
    #[doc = "1: Internal Low Speed Oscillator (ILO0)"]
    ILO0 = 1,
    ...
    PILO = 8,
    #[doc = "9: Internal Low Speed Oscillator (ILO1), if present on the product."]
    ILO1 = 9,
    #[doc = "10: ECO Prescaler (ECO_PRESCALER)"]
    ECO_PRESCALER = 10,
    #[doc = "11: LPECO"]
    LPECO = 11,
    #[doc = "12: LPECO Prescaler (LPECO_PRESCALER)"]
    LPECO_PRESCALER = 12,
}
...
impl SLOW_SEL0_R {
    ...
    pub fn variant(&self) -> Option<SLOW_SEL0_A> {
        match self.bits {
            ...
            9 => Some(SLOW_SEL0_A::ILO1),
            10 => Some(SLOW_SEL0_A::ECO_PRESCALER),
            11 => Some(SLOW_SEL0_A::LPECO),
            12 => Some(SLOW_SEL0_A::LPECO_PRESCALER),
            _ => None,
        }
    }
...
impl<'a, const O: u8> SLOW_SEL0_W<'a, O> {
    ...
    #[doc = "Internal Low Speed Oscillator (ILO0)"]
    #[inline(always)]
    pub fn ilo0(self) -> &'a mut W {
        self.variant(SLOW_SEL0_A::ILO0)
    }
    ...
    #[doc = "Internal Low Speed Oscillator (ILO1), if present on the product."]
    #[inline(always)]
    pub fn ilo1(self) -> &'a mut W {
        self.variant(SLOW_SEL0_A::ILO1)
    }
    #[doc = "ECO Prescaler (ECO_PRESCALER)"]
    #[inline(always)]
    pub fn eco_prescaler(self) -> &'a mut W {
        self.variant(SLOW_SEL0_A::ECO_PRESCALER)
    }
    #[doc = "LPECO"]
    #[inline(always)]
    pub fn lpeco(self) -> &'a mut W {
        self.variant(SLOW_SEL0_A::LPECO)
    }
    #[doc = "LPECO Prescaler (LPECO_PRESCALER)"]
    #[inline(always)]
    pub fn lpeco_prescaler(self) -> &'a mut W {
        self.variant(SLOW_SEL0_A::LPECO_PRESCALER)
    }
}
...
impl SLOW_SEL1_R {
    ...
    pub fn variant(&self) -> Option<SLOW_SEL1_A> {
        match self.bits {
            ...
            9 => Some(SLOW_SEL1_A::ILO1),
            10 => Some(SLOW_SEL1_A::ECO_PRESCALER),
            11 => Some(SLOW_SEL1_A::LPECO),
            12 => Some(SLOW_SEL1_A::LPECO_PRESCALER),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `NC`"]
    ...
    #[inline(always)]
    pub fn is_ilo1(&self) -> bool {
        *self == SLOW_SEL1_A::ILO1
    }
    #[doc = "Checks if the value of the field is `ECO_PRESCALER`"]
    #[inline(always)]
    pub fn is_eco_prescaler(&self) -> bool {
        *self == SLOW_SEL1_A::ECO_PRESCALER
    }
    #[doc = "Checks if the value of the field is `LPECO`"]
    #[inline(always)]
    pub fn is_lpeco(&self) -> bool {
        *self == SLOW_SEL1_A::LPECO
    }
    #[doc = "Checks if the value of the field is `LPECO_PRESCALER`"]
    #[inline(always)]
    pub fn is_lpeco_prescaler(&self) -> bool {
        *self == SLOW_SEL1_A::LPECO_PRESCALER
    }
}
...
impl<'a, const O: u8> SLOW_SEL1_W<'a, O> {
    ...
    #[inline(always)]
    pub fn ilo1(self) -> &'a mut W {
        self.variant(SLOW_SEL1_A::ILO1)
    }
    #[doc = "ECO Prescaler (ECO_PRESCALER)"]
    #[inline(always)]
    pub fn eco_prescaler(self) -> &'a mut W {
        self.variant(SLOW_SEL1_A::ECO_PRESCALER)
    }
    #[doc = "LPECO"]
    #[inline(always)]
    pub fn lpeco(self) -> &'a mut W {
        self.variant(SLOW_SEL1_A::LPECO)
    }
    #[doc = "LPECO Prescaler (LPECO_PRESCALER)"]
    #[inline(always)]
    pub fn lpeco_prescaler(self) -> &'a mut W {
        self.variant(SLOW_SEL1_A::LPECO_PRESCALER)
    }
}
impl R {
