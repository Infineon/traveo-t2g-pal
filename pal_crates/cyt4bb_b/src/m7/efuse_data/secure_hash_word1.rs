...
#[doc = "Field `HASH_WORD1` reader - Secure 128 bits HASH word 1 that is used for authentication in SECURE protection state."]
pub type HASH_WORD1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `HASH_WORD1` writer - Secure 128 bits HASH word 1 that is used for authentication in SECURE protection state."]
pub type HASH_WORD1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SECURE_HASH_WORD1_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Secure 128 bits HASH word 1 that is used for authentication in SECURE protection state."]
    #[inline(always)]
