#[doc = "Register `SCREENING_TYPE_2_REGISTER_7` reader"]
pub struct R(crate::R<SCREENING_TYPE_2_REGISTER_7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCREENING_TYPE_2_REGISTER_7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCREENING_TYPE_2_REGISTER_7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCREENING_TYPE_2_REGISTER_7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCREENING_TYPE_2_REGISTER_7` writer"]
pub struct W(crate::W<SCREENING_TYPE_2_REGISTER_7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCREENING_TYPE_2_REGISTER_7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCREENING_TYPE_2_REGISTER_7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCREENING_TYPE_2_REGISTER_7_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type QUEUE_NUMBER_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SCREENING_TYPE_2_REGISTER_7_SPEC, u8, u8, 4, O>;
...
pub type VLAN_PRIORITY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SCREENING_TYPE_2_REGISTER_7_SPEC, u8, u8, 3, O>;
...
pub type RSVD_7_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SCREENING_TYPE_2_REGISTER_7_SPEC, bool, O>;
...
pub type COMPARE_A_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SCREENING_TYPE_2_REGISTER_7_SPEC, u8, u8, 5, O>;
...
#[doc = "screening type 2 register 7, same as screening_type_2_register_0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [screening_type_2_register_7](index.html) module"]
pub struct SCREENING_TYPE_2_REGISTER_7_SPEC;
impl crate::RegisterSpec for SCREENING_TYPE_2_REGISTER_7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [screening_type_2_register_7::R](R) reader structure"]
impl crate::Readable for SCREENING_TYPE_2_REGISTER_7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [screening_type_2_register_7::W](W) writer structure"]
impl crate::Writable for SCREENING_TYPE_2_REGISTER_7_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SCREENING_TYPE_2_REGISTER_7 to value 0"]
impl crate::Resettable for SCREENING_TYPE_2_REGISTER_7_SPEC {
