...
#[doc = "Field `LOCKED` reader - FLL Lock Indicator"]
pub type LOCKED_R = crate::BitReader<bool>;
#[doc = "Field `UNLOCK_OCCURRED` reader - This bit sets whenever the FLL is enabled and goes out of lock. This bit stays set until cleared by firmware."]
pub type UNLOCK_OCCURRED_R = crate::BitReader<bool>;
#[doc = "Field `UNLOCK_OCCURRED` writer - This bit sets whenever the FLL is enabled and goes out of lock. This bit stays set until cleared by firmware."]
...
impl R {
    ...
    #[doc = "Bit 1 - This bit sets whenever the FLL is enabled and goes out of lock. This bit stays set until cleared by firmware."]
    #[inline(always)]
