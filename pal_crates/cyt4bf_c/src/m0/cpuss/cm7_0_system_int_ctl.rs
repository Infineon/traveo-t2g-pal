#[doc = "Register `CM7_0_SYSTEM_INT_CTL[%s]` reader"]
pub struct R(crate::R<CM7_0_SYSTEM_INT_CTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CM7_0_SYSTEM_INT_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CM7_0_SYSTEM_INT_CTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CM7_0_SYSTEM_INT_CTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CM7_0_SYSTEM_INT_CTL[%s]` writer"]
pub struct W(crate::W<CM7_0_SYSTEM_INT_CTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CM7_0_SYSTEM_INT_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CM7_0_SYSTEM_INT_CTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CM7_0_SYSTEM_INT_CTL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CPU_INT_IDX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CM7_0_SYSTEM_INT_CTL_SPEC, u8, u8, 4, O>;
...
pub type CPU_INT_VALID_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CM7_0_SYSTEM_INT_CTL_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:3 - CPU interrupt index (legal range \\[0, 15\\]). This field specifies to which CPU interrupt the system interrupt is mapped. E.g., if CPU_INT_IDX is '6', the system interrupt is mapped to CPU interrupt '6'. Note: it is possible to map multiple system interrupts to the same CPU interrupt. It is advised to assign different priorities to the CPU interrupts and to assign system interrupts to CPU interrupts accordingly."]
    #[inline(always)]
...
#[doc = "CM7 0 system interrupt control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cm7_0_system_int_ctl](index.html) module"]
pub struct CM7_0_SYSTEM_INT_CTL_SPEC;
impl crate::RegisterSpec for CM7_0_SYSTEM_INT_CTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cm7_0_system_int_ctl::R](R) reader structure"]
impl crate::Readable for CM7_0_SYSTEM_INT_CTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cm7_0_system_int_ctl::W](W) writer structure"]
impl crate::Writable for CM7_0_SYSTEM_INT_CTL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CM7_0_SYSTEM_INT_CTL[%s]
to value 0"]
impl crate::Resettable for CM7_0_SYSTEM_INT_CTL_SPEC {
