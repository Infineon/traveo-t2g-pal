...
pub type DATA_REVERSE_R = crate::BitReader<bool>;
...
pub type DATA_REVERSE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRC_CTL_SPEC, bool, O>;
...
pub type REM_REVERSE_R = crate::BitReader<bool>;
...
pub type REM_REVERSE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRC_CTL_SPEC, bool, O>;
impl R {
