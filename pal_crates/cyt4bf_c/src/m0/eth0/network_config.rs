...
#[doc = "Field `DATA_BUS_WIDTH` reader - Data bus width - set according to AMBA (AXI) or external FIFO data bus width. The reset value for this can be changed by defining a new value for gem_dma_bus_width_def in gem_defs. Only valid bus widths may be written if the system is configured to a maximum width less than 128-bits. 00: 32 bit data bus width 01: 64 bit AMBA (AXI) data bus width 10: 128 bit AMBA (AXI) data bus width 11: 128 bit AMBA (AXI) data bus width. Note. The reset value of this field is equal to the gem_dma_bus_width_def define, which is user configurable. MXETH only supports 64b DMA data bus width, so must set it 1."]
pub type DATA_BUS_WIDTH_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DATA_BUS_WIDTH` writer - Data bus width - set according to AMBA (AXI) or external FIFO data bus width. The reset value for this can be changed by defining a new value for gem_dma_bus_width_def in gem_defs. Only valid bus widths may be written if the system is configured to a maximum width less than 128-bits. 00: 32 bit data bus width 01: 64 bit AMBA (AXI) data bus width 10: 128 bit AMBA (AXI) data bus width 11: 128 bit AMBA (AXI) data bus width. Note. The reset value of this field is equal to the gem_dma_bus_width_def define, which is user configurable. MXETH only supports 64b DMA data bus width, so must set it 1."]
...
impl R {
    ...
    #[doc = "Bits 21:22 - Data bus width - set according to AMBA (AXI) or external FIFO data bus width. The reset value for this can be changed by defining a new value for gem_dma_bus_width_def in gem_defs. Only valid bus widths may be written if the system is configured to a maximum width less than 128-bits. 00: 32 bit data bus width 01: 64 bit AMBA (AXI) data bus width 10: 128 bit AMBA (AXI) data bus width 11: 128 bit AMBA (AXI) data bus width. Note. The reset value of this field is equal to the gem_dma_bus_width_def define, which is user configurable. MXETH only supports 64b DMA data bus width, so must set it 1."]
    #[inline(always)]
