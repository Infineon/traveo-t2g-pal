...
pub type BUFF_INV_R = crate::BitReader<bool>;
...
pub type BUFF_INV_W<'a, const O: u8> = crate::BitWriter<'a, u32, FLASH_CMD_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - Invalidation of ALL caches (for CM0+) and ALL buffers. SW writes a '1' to clear the caches. HW sets this field to '0' when the operation is completed. The operation takes a maximum of three clock cycles on the slowest of the clk_slow and clk_fast clocks. The caches LRU structures are also reset to their default state."]
    #[inline(always)]
