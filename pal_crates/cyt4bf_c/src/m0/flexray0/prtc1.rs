...
pub type RXW_R = crate::FieldReader<u16, RXW_A>;
#[doc = "Wakeup Symbol Receive Window Length (gdWakeupSymbolRxWindow) Configures the number of bit times used by the node to test the duration of the received wakeup pattern. Must be identical in all nodes of a cluster. Valid values are 76 to 301 bit times.\n\nValue on reset: 76"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u16)]
pub enum RXW_A {
    #[doc = "76: N/A"]
...
impl From<RXW_A> for u16 {
    #[inline(always)]
    fn from(variant: RXW_A) -> Self {
        variant as _
    }
}
impl RXW_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<RXW_A> {
        match self.bits {
            76 => Some(RXW_A::MIN),
            301 => Some(RXW_A::MAX),
            _ => None,
...
pub type RXW_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PRTC1_SPEC, u16, RXW_A, 9, O>;
impl<'a, const O: u8> RXW_W<'a, O> {
    #[doc = "N/A"]
    #[inline(always)]
    pub fn min(self) -> &'a mut W {
        self.variant(RXW_A::MIN)
    }
    #[doc = "N/A"]
    #[inline(always)]
    pub fn max(self) -> &'a mut W {
        self.variant(RXW_A::MAX)
    }
}
