#[doc = "Register `RDHS1_MIR` reader"]
pub struct R(crate::R<RDHS1_MIR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RDHS1_MIR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RDHS1_MIR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RDHS1_MIR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Read Header Section 1 (mirror)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rdhs1_mir](index.html) module"]
pub struct RDHS1_MIR_SPEC;
impl crate::RegisterSpec for RDHS1_MIR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rdhs1_mir::R](R) reader structure"]
impl crate::Readable for RDHS1_MIR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RDHS1_MIR to value 0"]
impl crate::Resettable for RDHS1_MIR_SPEC {
