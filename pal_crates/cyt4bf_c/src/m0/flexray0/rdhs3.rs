#[doc = "Register `RDHS3` reader"]
pub struct R(crate::R<RDHS3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RDHS3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RDHS3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RDHS3_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Read Header Section 3\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rdhs3](index.html) module"]
pub struct RDHS3_SPEC;
impl crate::RegisterSpec for RDHS3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rdhs3::R](R) reader structure"]
impl crate::Readable for RDHS3_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RDHS3 to value 0"]
impl crate::Resettable for RDHS3_SPEC {
