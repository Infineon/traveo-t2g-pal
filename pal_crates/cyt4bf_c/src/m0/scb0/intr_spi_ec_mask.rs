...
pub type WAKE_UP_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SPI_EC_MASK_SPEC, bool, O>;
...
pub type EZ_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SPI_EC_MASK_SPEC, bool, O>;
...
pub type EZ_WRITE_STOP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INTR_SPI_EC_MASK_SPEC, bool, O>;
