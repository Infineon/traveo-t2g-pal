...
pub type CMD_COMPLETE_SIGNAL_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NORMAL_INT_SIGNAL_EN_R_SPEC, bool, O>;
...
pub type INT_A_SIGNAL_EN_R = crate::BitReader<bool>;
#[doc = "Field `INT_A_SIGNAL_EN` writer - N/A"]
pub type INT_A_SIGNAL_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NORMAL_INT_SIGNAL_EN_R_SPEC, bool, O>;
#[doc = "Field `INT_B_SIGNAL_EN` reader - N/A"]
pub type INT_B_SIGNAL_EN_R = crate::BitReader<bool>;
#[doc = "Field `INT_B_SIGNAL_EN` writer - N/A"]
pub type INT_B_SIGNAL_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NORMAL_INT_SIGNAL_EN_R_SPEC, bool, O>;
#[doc = "Field `INT_C_SIGNAL_EN` reader - N/A"]
pub type INT_C_SIGNAL_EN_R = crate::BitReader<bool>;
#[doc = "Field `INT_C_SIGNAL_EN` writer - N/A"]
pub type INT_C_SIGNAL_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, NORMAL_INT_SIGNAL_EN_R_SPEC, bool, O>;
