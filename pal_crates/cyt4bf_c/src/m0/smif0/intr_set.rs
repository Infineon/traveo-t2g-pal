...
pub type RX_DATA_MMIO_FIFO_UNDERFLOW_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, O>;
#[doc = "Field `DL_FAIL` reader - Write with '1' to set corresponding bit in interrupt request register."]
pub type DL_FAIL_R = crate::BitReader<bool>;
#[doc = "Field `DL_FAIL` writer - Write with '1' to set corresponding bit in interrupt request register."]
pub type DL_FAIL_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, O>;
#[doc = "Field `DL_WARNING` reader - Write with '1' to set corresponding bit in interrupt request register."]
pub type DL_WARNING_R = crate::BitReader<bool>;
#[doc = "Field `DL_WARNING` writer - Write with '1' to set corresponding bit in interrupt request register."]
pub type DL_WARNING_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, O>;
