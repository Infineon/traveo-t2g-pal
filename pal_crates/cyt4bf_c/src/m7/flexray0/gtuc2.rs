...
pub type MPC_R = crate::FieldReader<u16, MPC_A>;
#[doc = "Macrotick Per Cycle (gMacroPerCycle) Configures the duration of one communication cycle in macroticks. The cycle length must be identical in all nodes of a cluster. Valid values are 10 to 16000 MT.\n\nValue on reset: 10"]
...
impl From<MPC_A> for u16 {
    #[inline(always)]
    fn from(variant: MPC_A) -> Self {
        variant as _
    }
}
impl MPC_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<MPC_A> {
        match self.bits {
            10 => Some(MPC_A::MIN),
            16000 => Some(MPC_A::MAX),
            _ => None,
        }
    }
...
pub type MPC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GTUC2_SPEC, u16, MPC_A, 14, O>;
impl<'a, const O: u8> MPC_W<'a, O> {
    #[doc = "N/A"]
    #[inline(always)]
    pub fn min(self) -> &'a mut W {
        self.variant(MPC_A::MIN)
    }
    #[doc = "N/A"]
    #[inline(always)]
    pub fn max(self) -> &'a mut W {
        self.variant(MPC_A::MAX)
    }
}
