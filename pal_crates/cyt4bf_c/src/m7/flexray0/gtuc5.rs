...
pub type DCA_R = crate::FieldReader<u8, DCA_A>;
#[doc = "Delay Compensation Channel A (pDelayCompensation\\[A\\]) Used to compensate for reception delays on the indicated channel. This covers assumed propagation delay up to cPropagationDelayMax for microticks in the range of 0.0125 to 0.05us. In practice, the minimum of the propagation delays of all sync nodes should be applied. Valid values are 0 to 200 uT.\n\nValue on reset: 0"]
...
impl From<DCA_A> for u8 {
    #[inline(always)]
    fn from(variant: DCA_A) -> Self {
        variant as _
    }
}
impl DCA_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<DCA_A> {
        match self.bits {
            200 => Some(DCA_A::MAX),
            _ => None,
        }
...
pub type DCA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GTUC5_SPEC, u8, DCA_A, 8, O>;
impl<'a, const O: u8> DCA_W<'a, O> {
    #[doc = "N/A"]
    #[inline(always)]
    pub fn max(self) -> &'a mut W {
        self.variant(DCA_A::MAX)
    }
}
...
pub type DCB_R = crate::FieldReader<u8, DCB_A>;
#[doc = "Delay Compensation Channel B (pDelayCompensation\\[B\\]) Used to compensate for reception delays on the indicated channel. This covers assumed propagation delay up to cPropagationDelayMax for microticks in the range of 0.0125 to 0.05us. In practice, the minimum of the propagation delays of all sync nodes should be applied. Valid values are 0 to 200 uT.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum DCB_A {
    #[doc = "200: N/A"]
...
impl From<DCB_A> for u8 {
    #[inline(always)]
    fn from(variant: DCB_A) -> Self {
        variant as _
    }
}
impl DCB_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<DCB_A> {
        match self.bits {
            200 => Some(DCB_A::MAX),
            _ => None,
        }
...
pub type DCB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GTUC5_SPEC, u8, DCB_A, 8, O>;
impl<'a, const O: u8> DCB_W<'a, O> {
    #[doc = "N/A"]
    #[inline(always)]
    pub fn max(self) -> &'a mut W {
        self.variant(DCB_A::MAX)
    }
}
...
pub type DEC_R = crate::FieldReader<u8, DEC_A>;
#[doc = "Decoding Correction (pDecodingCorrection) Configures the decoding correction value used to determine the primary time reference point. Valid values are 14 to 143 uT.\n\nValue on reset: 14"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum DEC_A {
    #[doc = "14: N/A"]
...
impl From<DEC_A> for u8 {
    #[inline(always)]
    fn from(variant: DEC_A) -> Self {
        variant as _
    }
}
impl DEC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<DEC_A> {
        match self.bits {
            14 => Some(DEC_A::MIN),
            143 => Some(DEC_A::MAX),
            _ => None,
...
pub type DEC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GTUC5_SPEC, u8, DEC_A, 8, O>;
impl<'a, const O: u8> DEC_W<'a, O> {
    #[doc = "N/A"]
    #[inline(always)]
    pub fn min(self) -> &'a mut W {
        self.variant(DEC_A::MIN)
    }
    #[doc = "N/A"]
    #[inline(always)]
    pub fn max(self) -> &'a mut W {
        self.variant(DEC_A::MAX)
    }
}
impl R {
