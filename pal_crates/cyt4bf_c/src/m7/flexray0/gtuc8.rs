...
pub type NMS_R = crate::FieldReader<u16, NMS_A>;
#[doc = "Number of Minislots (gNumberOfMinislots) Configures the number of minislots within the dynamic segment of a cycle. The number of minislots must be identical in all nodes of a cluster. Valid values are 0 to 7986.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u16)]
pub enum NMS_A {
    #[doc = "7986: N/A"]
...
impl From<NMS_A> for u16 {
    #[inline(always)]
    fn from(variant: NMS_A) -> Self {
        variant as _
    }
}
impl NMS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<NMS_A> {
        match self.bits {
            7986 => Some(NMS_A::MAX),
            _ => None,
        }
...
pub type NMS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GTUC8_SPEC, u16, NMS_A, 13, O>;
impl<'a, const O: u8> NMS_W<'a, O> {
    #[doc = "N/A"]
    #[inline(always)]
    pub fn max(self) -> &'a mut W {
        self.variant(NMS_A::MAX)
    }
}
impl R {
