#[doc = "Register `IBCR_MIR` reader"]
pub struct R(crate::R<IBCR_MIR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IBCR_MIR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IBCR_MIR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IBCR_MIR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IBCR_MIR` writer"]
pub struct W(crate::W<IBCR_MIR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IBCR_MIR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IBCR_MIR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IBCR_MIR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type IBRH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IBCR_MIR_SPEC, u8, u8, 7, O>;
...
#[doc = "Input Buffer Command Request (mirror)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ibcr_mir](index.html) module"]
pub struct IBCR_MIR_SPEC;
impl crate::RegisterSpec for IBCR_MIR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ibcr_mir::R](R) reader structure"]
impl crate::Readable for IBCR_MIR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ibcr_mir::W](W) writer structure"]
impl crate::Writable for IBCR_MIR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IBCR_MIR to value 0"]
impl crate::Resettable for IBCR_MIR_SPEC {
