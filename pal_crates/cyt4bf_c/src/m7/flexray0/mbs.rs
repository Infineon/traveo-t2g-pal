#[doc = "Register `MBS` reader"]
pub struct R(crate::R<MBS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MBS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MBS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MBS_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Message Buffer Status\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mbs](index.html) module"]
pub struct MBS_SPEC;
impl crate::RegisterSpec for MBS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [mbs::R](R) reader structure"]
impl crate::Readable for MBS_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets MBS to value 0"]
impl crate::Resettable for MBS_SPEC {
