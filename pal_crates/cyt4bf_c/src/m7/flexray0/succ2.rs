...
pub type LT_R = crate::FieldReader<u32, LT_A>;
#[doc = "Listen Timeout (pdListenTimeout) Configures wakeup / startup listen timeout in uT. The range for pdListenTimeout is 1284 to 1283846 uT.\n\nValue on reset: 1284"]
...
impl From<LT_A> for u32 {
    #[inline(always)]
    fn from(variant: LT_A) -> Self {
        variant as _
    }
}
impl LT_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<LT_A> {
        match self.bits {
            1284 => Some(LT_A::MIN),
            1283846 => Some(LT_A::MAX),
            _ => None,
        }
    }
...
pub type LT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SUCC2_SPEC, u32, LT_A, 21, O>;
impl<'a, const O: u8> LT_W<'a, O> {
    #[doc = "N/A"]
    #[inline(always)]
    pub fn min(self) -> &'a mut W {
        self.variant(LT_A::MIN)
    }
    #[doc = "N/A"]
    #[inline(always)]
    pub fn max(self) -> &'a mut W {
        self.variant(LT_A::MAX)
    }
}
