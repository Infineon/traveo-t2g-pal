...
pub struct RegisterBlock {
    ...
    pub prt9: PRT,
    _reserved10: [u8; 0x0c],
    #[doc = "0xa00..0xaf4 - Programmable IO port registers"]
    pub prt10: PRT,
    _reserved11: [u8; 0x0c],
    #[doc = "0xb00..0xbf4 - Programmable IO port registers"]
    pub prt11: PRT,
    _reserved12: [u8; 0x0c],
    #[doc = "0xc00..0xcf4 - Programmable IO port registers"]
    pub prt12: PRT,
    _reserved13: [u8; 0x0c],
    #[doc = "0xd00..0xdf4 - Programmable IO port registers"]
    pub prt13: PRT,
    _reserved14: [u8; 0x0c],
    #[doc = "0xe00..0xef4 - Programmable IO port registers"]
    pub prt14: PRT,
    _reserved15: [u8; 0x0c],
    #[doc = "0xf00..0xff4 - Programmable IO port registers"]
    pub prt15: PRT,
    _reserved16: [u8; 0x0c],
    #[doc = "0x1000..0x10f4 - Programmable IO port registers"]
    pub prt16: PRT,
    _reserved17: [u8; 0x0c],
    #[doc = "0x1100..0x11f4 - Programmable IO port registers"]
    pub prt17: PRT,
}
