...
#[doc = "Field `USER_OUT_WIDTH` reader - Takes the value of the `gem_user_out_width DEFINE if `gem_user_io is set. If 'gem_user_io is not set, the value is 0x01"]
pub type USER_OUT_WIDTH_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USER_IN_WIDTH` reader - Takes the value of the `gem_user_in_width DEFINE `gem_user_io. If 'gem_user_io is not set, the value is 0x01"]
...
#[doc = "Field `AXI_CACHE_VALUE` reader - Takes the value of the `gem_axi_awcache_value DEFINE"]
...
impl R {
    ...
    #[doc = "Bits 10:14 - Takes the value of the `gem_user_out_width DEFINE if `gem_user_io is set. If 'gem_user_io is not set, the value is 0x01"]
    #[inline(always)]
    pub fn user_out_width(&self) -> USER_OUT_WIDTH_R {
        USER_OUT_WIDTH_R::new(((self.bits >> 10) & 0x1f) as u8)
    }
    #[doc = "Bits 15:19 - Takes the value of the `gem_user_in_width DEFINE `gem_user_io. If 'gem_user_io is not set, the value is 0x01"]
    #[inline(always)]
    ...
    #[doc = "Bits 28:31 - Takes the value of the `gem_axi_awcache_value DEFINE"]
    #[inline(always)]
