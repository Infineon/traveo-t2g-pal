#[doc = "Register `MBS_MIR2` reader"]
pub struct R(crate::R<MBS_MIR2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MBS_MIR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MBS_MIR2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MBS_MIR2_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Message Buffer Status (2nd mirror)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mbs_mir2](index.html) module"]
pub struct MBS_MIR2_SPEC;
impl crate::RegisterSpec for MBS_MIR2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [mbs_mir2::R](R) reader structure"]
impl crate::Readable for MBS_MIR2_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets MBS_MIR2 to value 0"]
impl crate::Resettable for MBS_MIR2_SPEC {
