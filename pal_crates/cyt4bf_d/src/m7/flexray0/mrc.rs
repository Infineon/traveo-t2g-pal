...
pub type FDB_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FDB` writer - N/A"]
pub type FDB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MRC_SPEC, u8, u8, 8, O>;
...
pub type FFB_R = crate::FieldReader<u8, u8>;
