#[doc = "Register `RDHS2_MIR` reader"]
pub struct R(crate::R<RDHS2_MIR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RDHS2_MIR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RDHS2_MIR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RDHS2_MIR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Read Header Section 2 (mirror)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rdhs2_mir](index.html) module"]
pub struct RDHS2_MIR_SPEC;
impl crate::RegisterSpec for RDHS2_MIR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rdhs2_mir::R](R) reader structure"]
impl crate::Readable for RDHS2_MIR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RDHS2_MIR to value 0"]
impl crate::Resettable for RDHS2_MIR_SPEC {
