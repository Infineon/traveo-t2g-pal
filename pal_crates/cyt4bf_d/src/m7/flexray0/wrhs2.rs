#[doc = "Register `WRHS2` reader"]
pub struct R(crate::R<WRHS2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<WRHS2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<WRHS2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<WRHS2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `WRHS2` writer"]
pub struct W(crate::W<WRHS2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<WRHS2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<WRHS2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<WRHS2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CRC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WRHS2_SPEC, u16, u16, 11, O>;
...
defines the payload length for all static frames. If the payload length configured by PLC\\[6:0\\]
is shorter than this value padding bytes are inserted to ensure that frames have proper physical length. The padding pattern is logical zero (see also Section 5.8.3 Transmit Buffers)."]
pub type PLC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WRHS2_SPEC, u8, u8, 7, O>;
impl R {
...
#[doc = "Write Header Section 2\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [wrhs2](index.html) module"]
pub struct WRHS2_SPEC;
impl crate::RegisterSpec for WRHS2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [wrhs2::R](R) reader structure"]
impl crate::Readable for WRHS2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [wrhs2::W](W) writer structure"]
impl crate::Writable for WRHS2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets WRHS2 to value 0"]
impl crate::Resettable for WRHS2_SPEC {
