...
pub type CARD_IS_EMMC_W<'a, const O: u8> = crate::BitWriter<'a, u16, EMMC_CTRL_R_SPEC, bool, O>;
...
pub type DISABLE_DATA_CRC_CHK_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, EMMC_CTRL_R_SPEC, bool, O>;
...
pub type EMMC_RST_N_W<'a, const O: u8> = crate::BitWriter<'a, u16, EMMC_CTRL_R_SPEC, bool, O>;
...
pub type EMMC_RST_N_OE_W<'a, const O: u8> = crate::BitWriter<'a, u16, EMMC_CTRL_R_SPEC, bool, O>;
...
pub type CQE_ALGO_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u16, EMMC_CTRL_R_SPEC, bool, O>;
