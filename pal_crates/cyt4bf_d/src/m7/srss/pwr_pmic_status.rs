...
#[doc = "Field `PMIC_ENABLED` reader - Indicates the state of the PMIC enable/disable sequencer. This bit is only valid when PMIC_SEQ_BUSY==0. 0: PMIC sequencer indicates PMIC is disabled. 1: PMIC sequencer indicates PMIC is enabled."]
...
#[doc = "Field `PMIC_SEQ_BUSY` reader - Indicates the PMIC enable/disable sequencer is busy transitioning to/from PMIC. 0: Sequencer is not busy; 1: Sequencer is busy either enabling or disabling PMIC."]
pub type PMIC_SEQ_BUSY_R = crate::BitReader<bool>;
impl R {
    #[doc = "Bit 0 - Indicates the state of the PMIC enable/disable sequencer. This bit is only valid when PMIC_SEQ_BUSY==0. 0: PMIC sequencer indicates PMIC is disabled. 1: PMIC sequencer indicates PMIC is enabled."]
    #[inline(always)]
    ...
    #[doc = "Bit 31 - Indicates the PMIC enable/disable sequencer is busy transitioning to/from PMIC. 0: Sequencer is not busy; 1: Sequencer is busy either enabling or disabling PMIC."]
    #[inline(always)]
