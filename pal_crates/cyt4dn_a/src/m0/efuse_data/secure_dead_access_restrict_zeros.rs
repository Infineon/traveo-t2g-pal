#[doc = "Register `SECURE_DEAD_ACCESS_RESTRICT_ZEROS` reader"]
pub struct R(crate::R<SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SECURE_DEAD_ACCESS_RESTRICT_ZEROS` writer"]
pub struct W(crate::W<SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type AP_CTL_CM0_DISABLE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC, u8, u8, 2, O>;
...
pub type SYS_AP_MPU_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC, bool, O>;
...
pub type FLASH_ALLOWED_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC, u8, u8, 3, O>;
...
pub type SMIF_XIP_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC, bool, O>;
#[doc = "Field `SECURE_GROUP_ZEROS` reader - number of zeros for Secure fuse group covers secure hash, secure access restriction, secure hash zeros, secure dead access restriction"]
pub type SECURE_GROUP_ZEROS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SECURE_GROUP_ZEROS` writer - number of zeros for Secure fuse group covers secure hash, secure access restriction, secure hash zeros, secure dead access restriction"]
pub type SECURE_GROUP_ZEROS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC, u8, u8, 8, O>;
impl R {
    ...
    #[doc = "Bits 24:31 - number of zeros for Secure fuse group covers secure hash, secure access restriction, secure hash zeros, secure dead access restriction"]
    #[inline(always)]
    pub fn secure_group_zeros(&self) -> SECURE_GROUP_ZEROS_R {
        SECURE_GROUP_ZEROS_R::new(((self.bits >> 24) & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - goes to CPUSS.AP_CTL"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn secure_group_zeros(&mut self) -> SECURE_GROUP_ZEROS_W<24> {
        SECURE_GROUP_ZEROS_W::new(self)
    }
...
#[doc = "Dead access restriction in SECURE lifecycle and number of zeros for Secure fuse group\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [secure_dead_access_restrict_zeros](index.html) module"]
pub struct SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC;
impl crate::RegisterSpec for SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [secure_dead_access_restrict_zeros::R](R) reader structure"]
impl crate::Readable for SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [secure_dead_access_restrict_zeros::W](W) writer structure"]
impl crate::Writable for SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SECURE_DEAD_ACCESS_RESTRICT_ZEROS to value 0"]
impl crate::Resettable for SECURE_DEAD_ACCESS_RESTRICT_ZEROS_SPEC {
