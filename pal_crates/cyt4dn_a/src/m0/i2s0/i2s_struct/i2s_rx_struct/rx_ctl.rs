...
#[doc = "Field `MS` reader - Master/slave setting: '0': Slave. - External receiver 'i2s_rx_sck_in' and receiver 'i2s_rx_ws_in'. '1': Master. - Interface clock 'clk_if_srss' is used to generate receiver 'i2s_rx_sck_out' and receiver 'i2s_rx_ws_out'."]
pub type MS_R = crate::BitReader<MS_A>;
#[doc = "Master/slave setting: '0': Slave. - External receiver 'i2s_rx_sck_in' and receiver 'i2s_rx_ws_in'. '1': Master. - Interface clock 'clk_if_srss' is used to generate receiver 'i2s_rx_sck_out' and receiver 'i2s_rx_ws_out'.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MS_A {
    #[doc = "0: N/A"]
    SLAVE = 0,
...
#[doc = "Field `MS` writer - Master/slave setting: '0': Slave. - External receiver 'i2s_rx_sck_in' and receiver 'i2s_rx_ws_in'. '1': Master. - Interface clock 'clk_if_srss' is used to generate receiver 'i2s_rx_sck_out' and receiver 'i2s_rx_ws_out'."]
...
impl R {
    ...
    #[doc = "Bit 16 - Master/slave setting: '0': Slave. - External receiver 'i2s_rx_sck_in' and receiver 'i2s_rx_ws_in'. '1': Master. - Interface clock 'clk_if_srss' is used to generate receiver 'i2s_rx_sck_out' and receiver 'i2s_rx_ws_out'."]
    #[inline(always)]
    pub fn ms(&self) -> MS_R {
