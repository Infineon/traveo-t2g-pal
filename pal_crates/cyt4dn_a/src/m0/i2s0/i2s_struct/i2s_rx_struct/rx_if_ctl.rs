...
#[doc = "Field `CLOCK_DIV` reader - Interface clock divider (legal range \\[1, 255\\]). The I2S interface 'i2s_rx_sck_out' output signal is defined as clk_if / (CLOCK_DIV + 1). CLOCK_DIV should be set to an odd value ({1, 3, 5, ..., 255}), to ensure a 50/50 percent duty cycle clock. Note: Used in master configuration only."]
pub type CLOCK_DIV_R = crate::FieldReader<u8, CLOCK_DIV_A>;
#[doc = "Interface clock divider (legal range \\[1, 255\\]). The I2S interface 'i2s_rx_sck_out' output signal is defined as clk_if / (CLOCK_DIV + 1). CLOCK_DIV should be set to an odd value ({1, 3, 5, ..., 255}), to ensure a 50/50 percent duty cycle clock. Note: Used in master configuration only.\n\nValue on reset: 7"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum CLOCK_DIV_A {
    #[doc = "0: N/A"]
    DIV_BY_1 = 0,
    #[doc = "1: N/A"]
    DIV_BY_2 = 1,
...
impl From<CLOCK_DIV_A> for u8 {
    #[inline(always)]
    fn from(variant: CLOCK_DIV_A) -> Self {
        variant as _
    }
}
impl CLOCK_DIV_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<CLOCK_DIV_A> {
        match self.bits {
            0 => Some(CLOCK_DIV_A::DIV_BY_1),
            1 => Some(CLOCK_DIV_A::DIV_BY_2),
            255 => Some(CLOCK_DIV_A::DIV_BY_256),
            _ => None,
        }
    }
    ...
    pub fn is_div_by_1(&self) -> bool {
        *self == CLOCK_DIV_A::DIV_BY_1
    }
    #[doc = "Checks if the value of the field is `DIV_BY_2`"]
    #[inline(always)]
    pub fn is_div_by_2(&self) -> bool {
        *self == CLOCK_DIV_A::DIV_BY_2
    }
    #[doc = "Checks if the value of the field is `DIV_BY_256`"]
    #[inline(always)]
    pub fn is_div_by_256(&self) -> bool {
        *self == CLOCK_DIV_A::DIV_BY_256
    }
}
#[doc = "Field `CLOCK_DIV` writer - Interface clock divider (legal range \\[1, 255\\]). The I2S interface 'i2s_rx_sck_out' output signal is defined as clk_if / (CLOCK_DIV + 1). CLOCK_DIV should be set to an odd value ({1, 3, 5, ..., 255}), to ensure a 50/50 percent duty cycle clock. Note: Used in master configuration only."]
pub type CLOCK_DIV_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RX_IF_CTL_SPEC, u8, CLOCK_DIV_A, 8, O>;
impl<'a, const O: u8> CLOCK_DIV_W<'a, O> {
    #[doc = "N/A"]
    #[inline(always)]
    pub fn div_by_1(self) -> &'a mut W {
        self.variant(CLOCK_DIV_A::DIV_BY_1)
    }
    #[doc = "N/A"]
    #[inline(always)]
    pub fn div_by_2(self) -> &'a mut W {
        self.variant(CLOCK_DIV_A::DIV_BY_2)
    }
    #[doc = "N/A"]
    #[inline(always)]
    pub fn div_by_256(self) -> &'a mut W {
        self.variant(CLOCK_DIV_A::DIV_BY_256)
    }
}
#[doc = "Field `CLOCK_SEL` reader - Interface clock 'clk_if' selection: '0': SRSS clock clk_if_srss\\[0\\]. '1': SRSS clock clk_if_srss\\[1\\]. '2': SRSS clock clk_if_srss\\[2\\]. '3': SRSS clock clk_if_srss\\[3\\]. '4': Master interface clock 'i2s_rx_mck_in'. '5'-'7': SRSS clock clk_if_srss\\[0\\]. Note: intent was to have '5'-'7' as 'clock off'. Current behavior is as described above. May fix this in future IP release."]
...
impl CLOCK_SEL_R {
    ...
    pub fn variant(&self) -> Option<CLOCK_SEL_A> {
        match self.bits {
            ...
            4 => Some(CLOCK_SEL_A::SEL_I2S_RX_MCK_IN),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `SEL_I2S_RX_MCK_IN`"]
    #[inline(always)]
    pub fn is_sel_i2s_rx_mck_in(&self) -> bool {
        *self == CLOCK_SEL_A::SEL_I2S_RX_MCK_IN
    }
}
...
impl<'a, const O: u8> CLOCK_SEL_W<'a, O> {
    ...
    #[doc = "N/A"]
    #[inline(always)]
    pub fn sel_i2s_rx_mck_in(self) -> &'a mut W {
        self.variant(CLOCK_SEL_A::SEL_I2S_RX_MCK_IN)
    }
}
...
#[doc = "Field `WS_POLARITY` reader - Word select polarity: '0': Word select signal is used 'as is'. '1': Word select signal is inverted. Note: Applies in BOTH master and slave configurations."]
pub type WS_POLARITY_R = crate::BitReader<bool>;
#[doc = "Field `WS_POLARITY` writer - Word select polarity: '0': Word select signal is used 'as is'. '1': Word select signal is inverted. Note: Applies in BOTH master and slave configurations."]
pub type WS_POLARITY_W<'a, const O: u8> = crate::BitWriter<'a, u32, RX_IF_CTL_SPEC, bool, O>;
...
#[doc = "Field `CH0_EN` reader - Channel 0 enable: '0': Disabled. The RX FIFO does not consume channel 0 words and the transmitted channel 0 words on the interface are not driven (the output enable of the 'i2s_tx_sd_out' output signal is not driven). '1': Enabled."]
pub type CH0_EN_R = crate::BitReader<bool>;
#[doc = "Field `CH0_EN` writer - Channel 0 enable: '0': Disabled. The RX FIFO does not consume channel 0 words and the transmitted channel 0 words on the interface are not driven (the output enable of the 'i2s_tx_sd_out' output signal is not driven). '1': Enabled."]
pub type CH0_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RX_IF_CTL_SPEC, bool, O>;
#[doc = "Field `CH1_EN` reader - Channel 1 enable: '0': Disabled. The RX FIFO does not consume channel 1 words and the transmitted channel 1 words on the interface are not driven (the output enable of the 'i2s_tx_sd_out' output signal is not driven). '1': Enabled."]
pub type CH1_EN_R = crate::BitReader<bool>;
#[doc = "Field `CH1_EN` writer - Channel 1 enable: '0': Disabled. The RX FIFO does not consume channel 1 words and the transmitted channel 1 words on the interface are not driven (the output enable of the 'i2s_tx_sd_out' output signal is not driven). '1': Enabled."]
pub type CH1_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RX_IF_CTL_SPEC, bool, O>;
...
impl R {
    #[doc = "Bits 0:7 - Interface clock divider (legal range \\[1, 255\\]). The I2S interface 'i2s_rx_sck_out' output signal is defined as clk_if / (CLOCK_DIV + 1). CLOCK_DIV should be set to an odd value ({1, 3, 5, ..., 255}), to ensure a 50/50 percent duty cycle clock. Note: Used in master configuration only."]
    #[inline(always)]
    ...
    #[doc = "Bit 13 - Word select polarity: '0': Word select signal is used 'as is'. '1': Word select signal is inverted. Note: Applies in BOTH master and slave configurations."]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - Channel 0 enable: '0': Disabled. The RX FIFO does not consume channel 0 words and the transmitted channel 0 words on the interface are not driven (the output enable of the 'i2s_tx_sd_out' output signal is not driven). '1': Enabled."]
    #[inline(always)]
    pub fn ch0_en(&self) -> CH0_EN_R {
        CH0_EN_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - Channel 1 enable: '0': Disabled. The RX FIFO does not consume channel 1 words and the transmitted channel 1 words on the interface are not driven (the output enable of the 'i2s_tx_sd_out' output signal is not driven). '1': Enabled."]
    #[inline(always)]
...
#[doc = "`reset()` method sets RX_IF_CTL to value 0x1f00_0707"]
