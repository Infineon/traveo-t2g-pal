...
#[doc = "Field `ENABLED` reader - Test mode enable. '0': Disabled. Functional mode. - Transmitter tx_sck_in = IOSS i2s_tx_sck_in. - Transmitter tx_ws_in = IOSS i2s_tx_ws_in. - Receiver rx_sd_in = IOSS i2s_rx_sd_in. '1': Enabled. Test mode (intended to be used with (slave transmitter, master receiver) configuration). - Transmitter tx_sck_in = Receiver i2s_rx_sck_out. - Transmitter tx_ws_in = Receiver i2s_rx_ws_out. - Receiver rx_sd_in = Transmitter i2s_tx_sd_out. Note: TX_TEST_CTL.ENABLED and RX_TEST_CTL.ENABLED should not be set to '1' simultaneously."]
