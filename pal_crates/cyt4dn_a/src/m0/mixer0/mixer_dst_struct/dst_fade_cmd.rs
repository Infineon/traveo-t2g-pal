#[doc = "Register `DST_FADE_CMD` reader"]
pub struct R(crate::R<DST_FADE_CMD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DST_FADE_CMD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DST_FADE_CMD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DST_FADE_CMD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DST_FADE_CMD` writer"]
pub struct W(crate::W<DST_FADE_CMD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DST_FADE_CMD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DST_FADE_CMD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DST_FADE_CMD_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FADE_IN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DST_FADE_CMD_SPEC, bool, O>;
...
pub type FADE_OUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DST_FADE_CMD_SPEC, bool, O>;
#[doc = "Field `AUTO_DEACTIVATE` reader - Specifies behavior when 'fade out' has completed: '0': Source does NOT get deactivated. '1': Source gets deactivated; i.e. HW clears DST_FIFO_CTL.ACTIVE to '0'."]
pub type AUTO_DEACTIVATE_R = crate::BitReader<bool>;
#[doc = "Field `AUTO_DEACTIVATE` writer - Specifies behavior when 'fade out' has completed: '0': Source does NOT get deactivated. '1': Source gets deactivated; i.e. HW clears DST_FIFO_CTL.ACTIVE to '0'."]
pub type AUTO_DEACTIVATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DST_FADE_CMD_SPEC, bool, O>;
...
#[doc = "Field `PACE` writer - Specifies the pace/speed of 'fade in' and 'fade out': '0': The same CODE value is used (0+1) times. '1': The same CODE value is used (1+1) times. ... '1023': The same CODE value is used (1023+1) times. A fade in from 'mute' to 0 dB takes 1024*116 = 118,784 PCM samples. At a PCM sample frequency Fs of 48 kHz, this translates into 118,784/48,000 = 2.474 seconds."]
pub type PACE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DST_FADE_CMD_SPEC, u16, PACE_A, 10, O>;
impl<'a, const O: u8> PACE_W<'a, O> {
    #[doc = "N/A"]
    #[inline(always)]
    pub fn pace_min(self) -> &'a mut W {
        self.variant(PACE_A::PACE_MIN)
    }
    #[doc = "N/A"]
    #[inline(always)]
    pub fn pace_max(self) -> &'a mut W {
        self.variant(PACE_A::PACE_MAX)
    }
}
impl R {
    ...
    #[doc = "Bit 8 - Specifies behavior when 'fade out' has completed: '0': Source does NOT get deactivated. '1': Source gets deactivated; i.e. HW clears DST_FIFO_CTL.ACTIVE to '0'."]
    #[inline(always)]
...
#[doc = "Destination fade command\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dst_fade_cmd](index.html) module"]
pub struct DST_FADE_CMD_SPEC;
impl crate::RegisterSpec for DST_FADE_CMD_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dst_fade_cmd::R](R) reader structure"]
impl crate::Readable for DST_FADE_CMD_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dst_fade_cmd::W](W) writer structure"]
impl crate::Writable for DST_FADE_CMD_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DST_FADE_CMD to value 0x01ff_0000"]
impl crate::Resettable for DST_FADE_CMD_SPEC {
