...
#[doc = "Field `WARN_LIMIT` reader - Warn limit for watchdog. See WARN_ACTION."]
pub type WARN_LIMIT_R = crate::FieldReader<u32, u32>;
#[doc = "Field `WARN_LIMIT` writer - Warn limit for watchdog. See WARN_ACTION."]
pub type WARN_LIMIT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, WARN_LIMIT_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Warn limit for watchdog. See WARN_ACTION."]
    #[inline(always)]
    pub fn warn_limit(&self) -> WARN_LIMIT_R {
        WARN_LIMIT_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Warn limit for watchdog. See WARN_ACTION."]
