...
#[doc = "`reset()` method sets COLORCOMPONENTBITS to value 0x0506_0500"]
impl crate::Resettable for COLORCOMPONENTBITS_SPEC {
    const RESET_VALUE: Self::Ux = 0x0506_0500;
}
