...
#[doc = "Field `SLICEWIDTH` reader - Returns the maximum width that can be rendert in LBO mode minus one."]
...
impl R {
    ...
    #[doc = "Bits 16:29 - Returns the maximum width that can be rendert in LBO mode minus one."]
    #[inline(always)]
...
#[doc = "`reset()` method sets DESIGNATTRIBUTES0 to value 0x063f_0207"]
impl crate::Resettable for DESIGNATTRIBUTES0_SPEC {
    const RESET_VALUE: Self::Ux = 0x063f_0207;
}
