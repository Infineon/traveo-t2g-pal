...
#[doc = "Field `LBHLINK4FRAMELINES` reader - Height of the frame (programmed with -1). This setting must be identical to the display fetch and BlitEng value."]
pub type LBHLINK4FRAMELINES_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LBHLINK4FRAMELINES` writer - Height of the frame (programmed with -1). This setting must be identical to the display fetch and BlitEng value."]
