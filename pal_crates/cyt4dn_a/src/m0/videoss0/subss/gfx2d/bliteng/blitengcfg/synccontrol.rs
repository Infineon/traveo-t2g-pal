...
#[doc = "Field `SEQUENCECOMPLETE` writer - Trigger SeqComplete interrupt if BlitEng is idle or the last oparation has been completed."]
...
into SyncIdStatus\\[0:7\\]. Is executed after store operation is completed or no operation is active on the corresponding TB."]
    ...
    #[doc = "Bit 8 - Trigger SeqComplete interrupt if BlitEng is idle or the last oparation has been completed."]
    #[inline(always)]
    #[must_use]
