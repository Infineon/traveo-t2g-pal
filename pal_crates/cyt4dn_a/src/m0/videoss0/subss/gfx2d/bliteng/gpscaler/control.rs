...
#[doc = "Field `MODE` reader - Controls the sequence of horizontal and vertical operation for all operation modes."]
pub type MODE_R = crate::FieldReader<u8, MODE_A>;
#[doc = "Controls the sequence of horizontal and vertical operation for all operation modes.\n\nValue on reset: 0"]
...
pub enum MODE_A {
    ...
    ACTIVE_HOR_ONLY = 8,
    #[doc = "5: Only vertical operation os done."]
    ACTIVE_VER_ONLY = 5,
}
...
#[doc = "Field `MODE` writer - Controls the sequence of horizontal and vertical operation for all operation modes."]
...
impl<'a, const O: u8> MODE_W<'a, O> {
    ...
    #[doc = "Only vertical operation os done."]
    #[inline(always)]
    pub fn active_ver_only(self) -> &'a mut W {
        self.variant(MODE_A::ACTIVE_VER_ONLY)
    }
}
#[doc = "Field `OPERATION_MODE` reader - Selects the kind of operation to execute."]
pub type OPERATION_MODE_R = crate::BitReader<OPERATION_MODE_A>;
#[doc = "Selects the kind of operation to execute.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `OPERATION_MODE` writer - Selects the kind of operation to execute."]
...
impl R {
    #[doc = "Bits 0:3 - Controls the sequence of horizontal and vertical operation for all operation modes."]
    #[inline(always)]
    pub fn mode(&self) -> MODE_R {
        MODE_R::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bit 8 - Selects the kind of operation to execute."]
    #[inline(always)]
