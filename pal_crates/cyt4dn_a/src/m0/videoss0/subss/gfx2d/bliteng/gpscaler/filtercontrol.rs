...
#[doc = "Field `TAPS_H` reader - Defines the horizontal size of the FIR filter between 1 and 15 with increment of 2. Only odd filter width is supported. To program this field following formula has to be used: (filter width - 1)/2"]
pub type TAPS_H_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TAPS_H` writer - Defines the horizontal size of the FIR filter between 1 and 15 with increment of 2. Only odd filter width is supported. To program this field following formula has to be used: (filter width - 1)/2"]
pub type TAPS_H_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FILTERCONTROL_SPEC, u8, u8, 3, O>;
#[doc = "Field `TAPS_V` reader - Defines the vertical size of the FIR filter between 1 and 15 with increment of 2. Only odd filter width is supported. To program this field following formula has to be used: (filter height - 1)/2"]
pub type TAPS_V_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TAPS_V` writer - Defines the vertical size of the FIR filter between 1 and 15 with increment of 2. Only odd filter width is supported. To program this field following formula has to be used: (filter height - 1)/2"]
pub type TAPS_V_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FILTERCONTROL_SPEC, u8, u8, 3, O>;
#[doc = "Field `BYPASS_MODE_R` reader - Bypass configuration for red color components of every pixel."]
pub type BYPASS_MODE_R_R = crate::BitReader<BYPASS_MODE_R_A>;
#[doc = "Bypass configuration for red color components of every pixel.\n\nValue on reset: 0"]
...
#[doc = "Field `BYPASS_MODE_R` writer - Bypass configuration for red color components of every pixel."]
...
#[doc = "Field `BYPASS_MODE_G` reader - Bypass configuration for green color components of every pixel."]
pub type BYPASS_MODE_G_R = crate::BitReader<BYPASS_MODE_G_A>;
#[doc = "Bypass configuration for green color components of every pixel.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `BYPASS_MODE_G` writer - Bypass configuration for green color components of every pixel."]
...
#[doc = "Field `BYPASS_MODE_B` reader - Bypass configuration for blue color components of every pixel."]
pub type BYPASS_MODE_B_R = crate::BitReader<BYPASS_MODE_B_A>;
#[doc = "Bypass configuration for blue color components of every pixel.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `BYPASS_MODE_B` writer - Bypass configuration for blue color components of every pixel."]
...
#[doc = "Field `BYPASS_MODE_A` reader - Bypass configuration for alpha components of every pixel."]
pub type BYPASS_MODE_A_R = crate::BitReader<BYPASS_MODE_A_A>;
#[doc = "Bypass configuration for alpha components of every pixel.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `BYPASS_MODE_A` writer - Bypass configuration for alpha components of every pixel."]
...
#[doc = "Field `EXPONENT_FIR` reader - FIR product sum is divided by 2**FIR_exponent and rounded."]
pub type EXPONENT_FIR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EXPONENT_FIR` writer - FIR product sum is divided by 2**FIR_exponent and rounded."]
pub type EXPONENT_FIR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FILTERCONTROL_SPEC, u8, u8, 4, O>;
#[doc = "Field `TILE_MODE` reader - Selects the tile mode for pixels outside the source frame. In order to enable tiling tiling_at_begin_h or tiling_at_begin_v and the corresponding output frame dimension have to be set."]
pub type TILE_MODE_R = crate::FieldReader<u8, TILE_MODE_A>;
#[doc = "Selects the tile mode for pixels outside the source frame. In order to enable tiling tiling_at_begin_h or tiling_at_begin_v and the corresponding output frame dimension have to be set.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
...
#[doc = "Field `TILE_MODE` writer - Selects the tile mode for pixels outside the source frame. In order to enable tiling tiling_at_begin_h or tiling_at_begin_v and the corresponding output frame dimension have to be set."]
...
#[doc = "Field `TILING_AT_BEGIN_H` reader - If set to true, this bit enables tiling at the begin of the slice for horizontal direction. Tiling at the end occurs automatically by setting the corresponding output size."]
pub type TILING_AT_BEGIN_H_R = crate::BitReader<bool>;
#[doc = "Field `TILING_AT_BEGIN_H` writer - If set to true, this bit enables tiling at the begin of the slice for horizontal direction. Tiling at the end occurs automatically by setting the corresponding output size."]
pub type TILING_AT_BEGIN_H_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, FILTERCONTROL_SPEC, bool, O>;
#[doc = "Field `TILING_AT_BEGIN_V` reader - If set to true, this bit enables tiling at the begin of the slice for vertical direction. Tiling at the end occurs automatically by setting the corresponding output size."]
pub type TILING_AT_BEGIN_V_R = crate::BitReader<bool>;
#[doc = "Field `TILING_AT_BEGIN_V` writer - If set to true, this bit enables tiling at the begin of the slice for vertical direction. Tiling at the end occurs automatically by setting the corresponding output size."]
pub type TILING_AT_BEGIN_V_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, FILTERCONTROL_SPEC, bool, O>;
#[doc = "Field `TILE_COLOR_ALPHA` reader - Sets the alpha value for pixels outside of the slice."]
pub type TILE_COLOR_ALPHA_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TILE_COLOR_ALPHA` writer - Sets the alpha value for pixels outside of the slice."]
pub type TILE_COLOR_ALPHA_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FILTERCONTROL_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:2 - Defines the horizontal size of the FIR filter between 1 and 15 with increment of 2. Only odd filter width is supported. To program this field following formula has to be used: (filter width - 1)/2"]
    #[inline(always)]
    pub fn taps_h(&self) -> TAPS_H_R {
        TAPS_H_R::new((self.bits & 7) as u8)
    }
    #[doc = "Bits 4:6 - Defines the vertical size of the FIR filter between 1 and 15 with increment of 2. Only odd filter width is supported. To program this field following formula has to be used: (filter height - 1)/2"]
    #[inline(always)]
    pub fn taps_v(&self) -> TAPS_V_R {
        TAPS_V_R::new(((self.bits >> 4) & 7) as u8)
    }
    #[doc = "Bit 8 - Bypass configuration for red color components of every pixel."]
    #[inline(always)]
    pub fn bypass_mode_r(&self) -> BYPASS_MODE_R_R {
        BYPASS_MODE_R_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Bypass configuration for green color components of every pixel."]
    #[inline(always)]
    pub fn bypass_mode_g(&self) -> BYPASS_MODE_G_R {
        BYPASS_MODE_G_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - Bypass configuration for blue color components of every pixel."]
    #[inline(always)]
    pub fn bypass_mode_b(&self) -> BYPASS_MODE_B_R {
        BYPASS_MODE_B_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - Bypass configuration for alpha components of every pixel."]
    #[inline(always)]
    pub fn bypass_mode_a(&self) -> BYPASS_MODE_A_R {
        BYPASS_MODE_A_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bits 12:15 - FIR product sum is divided by 2**FIR_exponent and rounded."]
    #[inline(always)]
    pub fn exponent_fir(&self) -> EXPONENT_FIR_R {
        EXPONENT_FIR_R::new(((self.bits >> 12) & 0x0f) as u8)
    }
    #[doc = "Bits 16:17 - Selects the tile mode for pixels outside the source frame. In order to enable tiling tiling_at_begin_h or tiling_at_begin_v and the corresponding output frame dimension have to be set."]
    #[inline(always)]
    pub fn tile_mode(&self) -> TILE_MODE_R {
        TILE_MODE_R::new(((self.bits >> 16) & 3) as u8)
    }
    #[doc = "Bit 20 - If set to true, this bit enables tiling at the begin of the slice for horizontal direction. Tiling at the end occurs automatically by setting the corresponding output size."]
    #[inline(always)]
    pub fn tiling_at_begin_h(&self) -> TILING_AT_BEGIN_H_R {
        TILING_AT_BEGIN_H_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - If set to true, this bit enables tiling at the begin of the slice for vertical direction. Tiling at the end occurs automatically by setting the corresponding output size."]
    #[inline(always)]
    pub fn tiling_at_begin_v(&self) -> TILING_AT_BEGIN_V_R {
        TILING_AT_BEGIN_V_R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bits 24:31 - Sets the alpha value for pixels outside of the slice."]
    #[inline(always)]
