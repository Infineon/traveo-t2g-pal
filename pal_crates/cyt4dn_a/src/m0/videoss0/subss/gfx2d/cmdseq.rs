...
pub struct CMDSEQ {
    ...
    #[doc = "0x94 - GeneralPurpose Register. (Internal register with id = 0)"]
    pub gpr0: GPR0,
    #[doc = "0x98 - GeneralPurpose Register. (Internal register with id = 1)"]
    pub gpr1: GPR1,
    #[doc = "0x9c - GeneralPurpose Register. (Internal register with id = 2)"]
    pub gpr2: GPR2,
    #[doc = "0xa0 - GeneralPurpose Register. (Internal register with id = 3)"]
    pub gpr3: GPR3,
    #[doc = "0xa4 - GeneralPurpose Register. (Internal register with id = 4)"]
    pub gpr4: GPR4,
    #[doc = "0xa8 - GeneralPurpose Register. (Internal register with id = 5)"]
    pub gpr5: GPR5,
    #[doc = "0xac - GeneralPurpose Register. (Internal register with id = 6)"]
    pub gpr6: GPR6,
    #[doc = "0xb0 - GeneralPurpose Register. (Internal register with id = 7)"]
    pub gpr7: GPR7,
    #[doc = "0xb4 - GeneralPurpose Register. (Internal register with id = 8)"]
    pub gpr8: GPR8,
    #[doc = "0xb8 - GeneralPurpose Register. (Internal register with id = 9)"]
    pub gpr9: GPR9,
    #[doc = "0xbc - GeneralPurpose Register. (Internal register with id = 10)"]
    pub gpr10: GPR10,
    #[doc = "0xc0 - GeneralPurpose Register. (Internal register with id = 11)"]
    pub gpr11: GPR11,
    #[doc = "0xc4 - GeneralPurpose Register. (Internal register with id = 12)"]
    pub gpr12: GPR12,
    #[doc = "0xc8 - GeneralPurpose Register. (Internal register with id = 13)"]
    pub gpr13: GPR13,
    #[doc = "0xcc - GeneralPurpose Register. (Internal register with id = 14)"]
    pub gpr14: GPR14,
    #[doc = "0xd0 - GeneralPurpose Register. (Internal register with id = 15)"]
    pub gpr15: GPR15,
...
#[doc = "GeneralPurpose Register. (Internal register with id = 0)"]
pub mod gpr0;
#[doc = "GPR1 (r) register accessor: an alias for `Reg<GPR1_SPEC>`"]
pub type GPR1 = crate::Reg<gpr1::GPR1_SPEC>;
#[doc = "GeneralPurpose Register. (Internal register with id = 1)"]
pub mod gpr1;
...
#[doc = "GeneralPurpose Register. (Internal register with id = 14)"]
pub mod gpr14;
