...
#[doc = "Field `ERRORAXISLV` reader - AXI slave error has been occured. SchedulerAddress and ProgrammerAddress have to be evaluated"]
pub type ERRORAXISLV_R = crate::BitReader<bool>;
#[doc = "Field `ERRORAXIDEC` reader - AXI decoder error has been occured. SchedulerAddress and ProgrammerAddress have to be evaluated"]
...
impl R {
    ...
    #[doc = "Bit 4 - AXI slave error has been occured. SchedulerAddress and ProgrammerAddress have to be evaluated"]
    #[inline(always)]
    pub fn erroraxislv(&self) -> ERRORAXISLV_R {
        ERRORAXISLV_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - AXI decoder error has been occured. SchedulerAddress and ProgrammerAddress have to be evaluated"]
    #[inline(always)]
