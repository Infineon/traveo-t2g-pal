...
#[doc = "Field `LINECOUNTERTB0` reader - Holds the scheduled line of the frame that is beeing executed in TB0. The value of this register is routed outside CmdSeq."]
pub type LINECOUNTERTB0_R = crate::FieldReader<u16, u16>;
impl R {
    #[doc = "Bits 0:15 - Holds the scheduled line of the frame that is beeing executed in TB0. The value of this register is routed outside CmdSeq."]
    #[inline(always)]
