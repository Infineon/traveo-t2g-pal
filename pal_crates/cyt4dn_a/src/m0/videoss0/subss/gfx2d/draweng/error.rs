...
#[doc = "Field `FETCHERROR` reader - Indicates if an bus error occured while fetching the command list."]
...
#[doc = "Field `OVERFLOWERROR` reader - Indicates if an overflow occured when truncating to internal data width."]
pub type OVERFLOWERROR_R = crate::BitReader<bool>;
impl R {
    #[doc = "Bit 0 - Indicates if an bus error occured while fetching the command list."]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - Indicates if an overflow occured when truncating to internal data width."]
    #[inline(always)]
