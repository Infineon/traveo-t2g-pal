...
#[doc = "Field `TARGETBITSPERPIXEL` reader - Number of bits per pixel in the target buffer for the following blit operation. Must be 1, 2, 4, 8, 16, 18, 24 or 32. This field allows to obtain an aligned boundig box width."]
pub type TARGETBITSPERPIXEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TARGETBITSPERPIXEL` writer - Number of bits per pixel in the target buffer for the following blit operation. Must be 1, 2, 4, 8, 16, 18, 24 or 32. This field allows to obtain an aligned boundig box width."]
...
impl R {
    ...
    #[doc = "Bits 16:21 - Number of bits per pixel in the target buffer for the following blit operation. Must be 1, 2, 4, 8, 16, 18, 24 or 32. This field allows to obtain an aligned boundig box width."]
    #[inline(always)]
