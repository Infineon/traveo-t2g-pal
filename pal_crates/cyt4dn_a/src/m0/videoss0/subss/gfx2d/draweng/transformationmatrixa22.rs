...
#[doc = "Field `A22` reader - A22, given in signed fixed-point 26.6 two's complement notation."]
pub type A22_R = crate::FieldReader<u32, u32>;
#[doc = "Field `A22` writer - A22, given in signed fixed-point 26.6 two's complement notation."]
pub type A22_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TRANSFORMATIONMATRIXA22_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - A22, given in signed fixed-point 26.6 two's complement notation."]
    #[inline(always)]
