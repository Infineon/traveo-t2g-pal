...
pub struct FRAMEGEN1 {
    ...
    #[doc = "0x2c - Configuration register for controlling the behaviour of the SecSyncStat field in the FgSecChStat register."]
    ...
    pub fgsrftd: FGSRFTD,
    #[doc = "0x94 - Current (x,y) positions of the timing generator Register in FrameGen timing generator. Please don't use it due to lack of verification."]
