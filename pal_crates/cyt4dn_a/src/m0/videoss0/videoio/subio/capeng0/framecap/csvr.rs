...
#[doc = "Field `CSVTIMEOUT` reader - setting a time limitation for waiting the recovery of capture clock."]
pub type CSVTIMEOUT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CSVTIMEOUT` writer - setting a time limitation for waiting the recovery of capture clock."]
...
impl R {
    ...
    #[doc = "Bits 1:10 - setting a time limitation for waiting the recovery of capture clock."]
    #[inline(always)]
...
#[doc = "`reset()` method sets CSVR to value 0x0a"]
