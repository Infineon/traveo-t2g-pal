...
pub enum RASTERMODE_A {
    #[doc = "0: Input stream is RGB(A) or YUV 4_4_4."]
    NORMAL = 0,
    #[doc = "1: Input stream is packed YUV 4_2_2."]
    YUV422 = 1,
}
...
impl<'a, const O: u8> RASTERMODE_W<'a, O> {
    #[doc = "Input stream is RGB(A) or YUV 4_4_4."]
    #[inline(always)]
    pub fn normal(self) -> &'a mut W {
        self.variant(RASTERMODE_A::NORMAL)
    }
    #[doc = "Input stream is packed YUV 4_2_2."]
    #[inline(always)]
