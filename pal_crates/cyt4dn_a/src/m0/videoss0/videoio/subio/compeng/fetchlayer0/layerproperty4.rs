...
#[doc = "Field `PALETTEENABLE4` reader - See PaletteEnable0."]
pub type PALETTEENABLE4_R = crate::BitReader<bool>;
#[doc = "Field `PALETTEENABLE4` writer - See PaletteEnable0."]
pub type PALETTEENABLE4_W<'a, const O: u8> =
...
pub type GAMMAREMOVEENABLE4_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LAYERPROPERTY4_SPEC, bool, O>;
#[doc = "Field `PALETTEOFFSET4` reader - see PaletteOffset0."]
pub type PALETTEOFFSET4_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PALETTEOFFSET4` writer - see PaletteOffset0."]
pub type PALETTEOFFSET4_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYERPROPERTY4_SPEC, u16, u16, 11, O>;
#[doc = "Field `PALETTEIDWIDTH4` reader - see PaletteIdWidth0."]
pub type PALETTEIDWIDTH4_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PALETTEIDWIDTH4` writer - see PaletteIdWidth0."]
pub type PALETTEIDWIDTH4_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYERPROPERTY4_SPEC, u8, u8, 3, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn paletteenable4(&self) -> PALETTEENABLE4_R {
        PALETTEENABLE4_R::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn paletteoffset4(&self) -> PALETTEOFFSET4_R {
        PALETTEOFFSET4_R::new(((self.bits >> 16) & 0x07ff) as u16)
    }
    #[doc = "Bits 27:29 - see PaletteIdWidth0."]
    #[inline(always)]
    pub fn paletteidwidth4(&self) -> PALETTEIDWIDTH4_R {
        PALETTEIDWIDTH4_R::new(((self.bits >> 27) & 7) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn paletteenable4(&mut self) -> PALETTEENABLE4_W<0> {
        PALETTEENABLE4_W::new(self)
    }
    #[doc = "Bits 1:2 - See TileMode0."]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn paletteoffset4(&mut self) -> PALETTEOFFSET4_W<16> {
        PALETTEOFFSET4_W::new(self)
    }
    #[doc = "Bits 27:29 - see PaletteIdWidth0."]
    #[inline(always)]
    #[must_use]
    pub fn paletteidwidth4(&mut self) -> PALETTEIDWIDTH4_W<27> {
        PALETTEIDWIDTH4_W::new(self)
    }
    #[doc = "Bit 30 - See ClipWindowEnable0."]
    #[inline(always)]
    #[must_use]
...
#[doc = "`reset()` method sets LAYERPROPERTY4 to value 0x3800_0008"]
