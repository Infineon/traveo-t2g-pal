...
pub struct FETCHWARP1 {
    ...
    #[doc = "0x150 - Warping control options."]
    pub warpcontrol: WARPCONTROL,
    #[doc = "0x154 - Start value X for arbitrary warping."]
    pub arbstartx: ARBSTARTX,
    #[doc = "0x158 - Start value Y for arbitrary warping."]
    pub arbstarty: ARBSTARTY,
    #[doc = "0x15c - Start values for delta incrementation of arbitrary warping."]
    pub arbdelta: ARBDELTA,
    #[doc = "0x160 - FIR sequence control register."]
    pub firpositions: FIRPOSITIONS,
    #[doc = "0x164 - FIR coefficients register."]
    pub fircoefficients: FIRCOEFFICIENTS,
    #[doc = "0x168 - Shared common control settings for all layers."]
    pub control: CONTROL,
    #[doc = "0x16c - Shadow load enable flags for all layers."]
    pub triggerenable: TRIGGERENABLE,
    #[doc = "0x170 - Shadow load trigger."]
    pub controltrigger: CONTROLTRIGGER,
    #[doc = "0x174 - Frame start trigger."]
    pub start: START,
    #[doc = "0x178 - Fetch unit type."]
    pub fetchtype: FETCHTYPE,
    #[doc = "0x17c - Burst buffer properties."]
    pub burstbufferproperties: BURSTBUFFERPROPERTIES,
    #[doc = "0x180 - Status informations."]
    pub status: STATUS,
}
