...
#[doc = "Field `CLIPWINDOWXOFFSET2` reader - Horizontal position (X)."]
pub type CLIPWINDOWXOFFSET2_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWXOFFSET2` writer - Horizontal position (X)."]
pub type CLIPWINDOWXOFFSET2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLIPWINDOWOFFSET2_SPEC, u16, u16, 15, O>;
#[doc = "Field `CLIPWINDOWYOFFSET2` reader - Vertical position (Y)."]
pub type CLIPWINDOWYOFFSET2_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWYOFFSET2` writer - Vertical position (Y)."]
