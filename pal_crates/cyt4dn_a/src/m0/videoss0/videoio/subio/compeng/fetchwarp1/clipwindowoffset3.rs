...
#[doc = "Field `CLIPWINDOWXOFFSET3` reader - Horizontal position (X)."]
pub type CLIPWINDOWXOFFSET3_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWXOFFSET3` writer - Horizontal position (X)."]
pub type CLIPWINDOWXOFFSET3_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLIPWINDOWOFFSET3_SPEC, u16, u16, 15, O>;
#[doc = "Field `CLIPWINDOWYOFFSET3` reader - Vertical position (Y)."]
pub type CLIPWINDOWYOFFSET3_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWYOFFSET3` writer - Vertical position (Y)."]
