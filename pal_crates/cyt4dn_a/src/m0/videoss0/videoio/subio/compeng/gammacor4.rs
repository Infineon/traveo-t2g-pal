...
#[doc = "LUTSTART (rw) register accessor: an alias for `Reg<LUTSTART_SPEC>`"]
pub type LUTSTART = crate::Reg<lutstart::LUTSTART_SPEC>;
#[doc = "Start values for look-up table programming."]
pub mod lutstart;
#[doc = "LUTDELTAS (rw) register accessor: an alias for `Reg<LUTDELTAS_SPEC>`"]
