...
#[doc = "Field `SCALE_MODE_H` reader - Scale mode for horizontal scaling."]
pub type SCALE_MODE_H_R = crate::BitReader<SCALE_MODE_H_A>;
#[doc = "Scale mode for horizontal scaling.\n\nValue on reset: 0"]
...
#[doc = "Field `SCALE_MODE_H` writer - Scale mode for horizontal scaling."]
...
#[doc = "Field `SCALE_MODE_V` reader - Scale mode for vertical scaling."]
pub type SCALE_MODE_V_R = crate::BitReader<SCALE_MODE_V_A>;
#[doc = "Scale mode for vertical scaling.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `SCALE_MODE_V` writer - Scale mode for vertical scaling."]
...
#[doc = "Field `FILTER_MODE_H` reader - Selects sampling algorithm for horizontal scaling."]
pub type FILTER_MODE_H_R = crate::BitReader<FILTER_MODE_H_A>;
#[doc = "Selects sampling algorithm for horizontal scaling.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `FILTER_MODE_H` writer - Selects sampling algorithm for horizontal scaling."]
...
#[doc = "Field `FILTER_MODE_V` reader - Selects sampling algorithm for vertical scaling."]
pub type FILTER_MODE_V_R = crate::BitReader<FILTER_MODE_V_A>;
#[doc = "Selects sampling algorithm for vertical scaling.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `FILTER_MODE_V` writer - Selects sampling algorithm for vertical scaling."]
...
#[doc = "Field `FIELD_MODE` reader - Controls generation of output field polarity for vertical scaling."]
pub type FIELD_MODE_R = crate::FieldReader<u8, FIELD_MODE_A>;
#[doc = "Controls generation of output field polarity for vertical scaling.\n\nValue on reset: 2"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
...
#[doc = "Field `FIELD_MODE` writer - Controls generation of output field polarity for vertical scaling."]
...
#[doc = "Field `ALPHA_VALUE` reader - When 'mode' field is not 'NEUTRAL', then input alpha values are ignore and output alpha set to this constant value for all pixels. This restriction applies to GPScalerL derivative only."]
pub type ALPHA_VALUE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ALPHA_VALUE` writer - When 'mode' field is not 'NEUTRAL', then input alpha values are ignore and output alpha set to this constant value for all pixels. This restriction applies to GPScalerL derivative only."]
pub type ALPHA_VALUE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SCALERCONTROL_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bit 0 - Scale mode for horizontal scaling."]
    #[inline(always)]
    pub fn scale_mode_h(&self) -> SCALE_MODE_H_R {
        SCALE_MODE_H_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 4 - Scale mode for vertical scaling."]
    #[inline(always)]
    pub fn scale_mode_v(&self) -> SCALE_MODE_V_R {
        SCALE_MODE_V_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 8 - Selects sampling algorithm for horizontal scaling."]
    #[inline(always)]
    pub fn filter_mode_h(&self) -> FILTER_MODE_H_R {
        FILTER_MODE_H_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 12 - Selects sampling algorithm for vertical scaling."]
    #[inline(always)]
    pub fn filter_mode_v(&self) -> FILTER_MODE_V_R {
        FILTER_MODE_V_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bits 16:17 - Controls generation of output field polarity for vertical scaling."]
    #[inline(always)]
    pub fn field_mode(&self) -> FIELD_MODE_R {
        FIELD_MODE_R::new(((self.bits >> 16) & 3) as u8)
    }
    #[doc = "Bits 20:27 - When 'mode' field is not 'NEUTRAL', then input alpha values are ignore and output alpha set to this constant value for all pixels. This restriction applies to GPScalerL derivative only."]
    #[inline(always)]
