...
#[doc = "Field `SCALE_FACTOR_V` reader - Scale factor is greater than 0.0 and less than or equal to 1.0. If scale_mode is UPSCALE then the inverse scale factor have to be programmed."]
pub type SCALE_FACTOR_V_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SCALE_FACTOR_V` writer - Scale factor is greater than 0.0 and less than or equal to 1.0. If scale_mode is UPSCALE then the inverse scale factor have to be programmed."]
pub type SCALE_FACTOR_V_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SCALERSETUPV0_SPEC, u32, u32, 20, O>;
impl R {
    #[doc = "Bits 0:19 - Scale factor is greater than 0.0 and less than or equal to 1.0. If scale_mode is UPSCALE then the inverse scale factor have to be programmed."]
    #[inline(always)]
