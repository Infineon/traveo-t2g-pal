...
#[doc = "Field `TILE_COLOR_RED` reader - Sets the red color value for pixels outside of the slice."]
pub type TILE_COLOR_RED_R = crate::FieldReader<u16, u16>;
#[doc = "Field `TILE_COLOR_RED` writer - Sets the red color value for pixels outside of the slice."]
pub type TILE_COLOR_RED_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TILECOLORRGB_SPEC, u16, u16, 10, O>;
#[doc = "Field `TILE_COLOR_GREEN` reader - Sets the green color value for pixels outside of the slice."]
pub type TILE_COLOR_GREEN_R = crate::FieldReader<u16, u16>;
#[doc = "Field `TILE_COLOR_GREEN` writer - Sets the green color value for pixels outside of the slice."]
pub type TILE_COLOR_GREEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TILECOLORRGB_SPEC, u16, u16, 10, O>;
#[doc = "Field `TILE_COLOR_BLUE` reader - Sets the blue color value for pixels outside of the slice."]
pub type TILE_COLOR_BLUE_R = crate::FieldReader<u16, u16>;
#[doc = "Field `TILE_COLOR_BLUE` writer - Sets the blue color value for pixels outside of the slice."]
pub type TILE_COLOR_BLUE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TILECOLORRGB_SPEC, u16, u16, 10, O>;
impl R {
    #[doc = "Bits 0:9 - Sets the red color value for pixels outside of the slice."]
    #[inline(always)]
    pub fn tile_color_red(&self) -> TILE_COLOR_RED_R {
        TILE_COLOR_RED_R::new((self.bits & 0x03ff) as u16)
    }
    #[doc = "Bits 10:19 - Sets the green color value for pixels outside of the slice."]
    #[inline(always)]
    pub fn tile_color_green(&self) -> TILE_COLOR_GREEN_R {
        TILE_COLOR_GREEN_R::new(((self.bits >> 10) & 0x03ff) as u16)
    }
    #[doc = "Bits 20:29 - Sets the blue color value for pixels outside of the slice."]
    #[inline(always)]
