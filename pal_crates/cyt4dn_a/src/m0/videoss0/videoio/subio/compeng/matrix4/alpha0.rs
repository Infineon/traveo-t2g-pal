...
#[doc = "Field `A41` reader - Value for red input."]
pub type A41_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A41` writer - Value for red input."]
pub type A41_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ALPHA0_SPEC, u16, u16, 13, O>;
#[doc = "Field `A42` reader - Value for green input."]
pub type A42_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A42` writer - Value for green input."]
