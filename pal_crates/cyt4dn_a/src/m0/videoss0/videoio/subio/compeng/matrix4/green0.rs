...
#[doc = "Field `A21` reader - Value for red input."]
pub type A21_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A21` writer - Value for red input."]
pub type A21_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GREEN0_SPEC, u16, u16, 13, O>;
#[doc = "Field `A22` reader - Value for green input."]
pub type A22_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A22` writer - Value for green input."]
