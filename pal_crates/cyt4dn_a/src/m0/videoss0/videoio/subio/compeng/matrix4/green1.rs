...
#[doc = "Field `A23` reader - Value for blue input."]
pub type A23_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A23` writer - Value for blue input."]
pub type A23_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GREEN1_SPEC, u16, u16, 13, O>;
#[doc = "Field `A24` reader - Value for alpha input."]
pub type A24_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A24` writer - Value for alpha input."]
