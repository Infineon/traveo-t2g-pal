...
#[doc = "Field `C3` reader - Blue output offset."]
pub type C3_R = crate::FieldReader<u16, u16>;
#[doc = "Field `C3` writer - Blue output offset."]
pub type C3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OFFSETVECTOR1_SPEC, u16, u16, 13, O>;
#[doc = "Field `C4` reader - Alpha output offset. Note that the 8-bit alpha input is up-scaled to 10-bit, before the matrix and this offset is applied, and down-scaled to 8-bit for output afterwards."]
pub type C4_R = crate::FieldReader<u16, u16>;
#[doc = "Field `C4` writer - Alpha output offset. Note that the 8-bit alpha input is up-scaled to 10-bit, before the matrix and this offset is applied, and down-scaled to 8-bit for output afterwards."]
pub type C4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OFFSETVECTOR1_SPEC, u16, u16, 13, O>;
impl R {
    #[doc = "Bits 0:12 - Blue output offset."]
    #[inline(always)]
    pub fn c3(&self) -> C3_R {
        C3_R::new((self.bits & 0x1fff) as u16)
    }
    #[doc = "Bits 16:28 - Alpha output offset. Note that the 8-bit alpha input is up-scaled to 10-bit, before the matrix and this offset is applied, and down-scaled to 8-bit for output afterwards."]
    #[inline(always)]
    pub fn c4(&self) -> C4_R {
