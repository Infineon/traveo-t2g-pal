...
#[doc = "Field `FRAMEXOFFSET` reader - Horizontal offset (X)."]
pub type FRAMEXOFFSET_R = crate::FieldReader<u16, u16>;
#[doc = "Field `FRAMEXOFFSET` writer - Horizontal offset (X)."]
pub type FRAMEXOFFSET_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FRAMEOFFSET_SPEC, u16, u16, 15, O>;
#[doc = "Field `FRAMEYOFFSET` reader - Vertical offset (Y)."]
pub type FRAMEYOFFSET_R = crate::FieldReader<u16, u16>;
#[doc = "Field `FRAMEYOFFSET` writer - Vertical offset (Y)."]
