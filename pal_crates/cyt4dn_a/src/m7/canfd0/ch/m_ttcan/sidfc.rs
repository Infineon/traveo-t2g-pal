...
#[doc = "Field `FLSSA` reader - Filter List Standard Start Address Start address of standard Message ID filter list (32-bit word address, see Figure 2)."]
pub type FLSSA_R = crate::FieldReader<u16, u16>;
#[doc = "Field `FLSSA` writer - Filter List Standard Start Address Start address of standard Message ID filter list (32-bit word address, see Figure 2)."]
