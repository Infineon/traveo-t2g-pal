...
pub struct R(crate::R<TR_MON_AP_STATUS0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TR_MON_AP_STATUS0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TR_MON_AP_STATUS0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TR_MON_AP_STATUS0_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "True random monitor AP status 0\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tr_mon_ap_status0](index.html) module"]
pub struct TR_MON_AP_STATUS0_SPEC;
impl crate::RegisterSpec for TR_MON_AP_STATUS0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tr_mon_ap_status0::R](R) reader structure"]
impl crate::Readable for TR_MON_AP_STATUS0_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets TR_MON_AP_STATUS0 to value 0"]
impl crate::Resettable for TR_MON_AP_STATUS0_SPEC {
