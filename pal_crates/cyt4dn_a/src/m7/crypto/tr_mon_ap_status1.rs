...
#[doc = "Field `WINDOW_INDEX` reader - Counter to keep track of the current index in the window (counts down from TR_MON_AP_CTL.WINDOW_SIZE to '0')."]
...
impl R {
    ...
    #[doc = "Bits 16:31 - Counter to keep track of the current index in the window (counts down from TR_MON_AP_CTL.WINDOW_SIZE to '0')."]
    #[inline(always)]
