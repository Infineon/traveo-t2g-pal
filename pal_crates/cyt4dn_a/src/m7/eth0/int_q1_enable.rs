#[doc = "Register `INT_Q1_ENABLE` writer"]
pub struct W(crate::W<INT_Q1_ENABLE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INT_Q1_ENABLE_SPEC>;
    #[inline(always)]
...
impl From<crate::W<INT_Q1_ENABLE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INT_Q1_ENABLE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ENABLE_RECEIVE_COMPLETE_INTERRUPT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INT_Q1_ENABLE_SPEC, bool, O>;
...
pub struct INT_Q1_ENABLE_SPEC;
impl crate::RegisterSpec for INT_Q1_ENABLE_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [int_q1_enable::W](W) writer structure"]
impl crate::Writable for INT_Q1_ENABLE_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets INT_Q1_ENABLE to value 0"]
impl crate::Resettable for INT_Q1_ENABLE_SPEC {
