...
pub type RAM_ECC_EN_R = crate::BitReader<bool>;
#[doc = "Field `RAM_ECC_EN` writer - Enable ECC checking for cache accesses: 0: Disabled. 1: Enabled."]
pub type RAM_ECC_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CM0_CA_CTL0_SPEC, bool, O>;
#[doc = "Field `RAM_ECC_INJ_EN` reader - Enable error injection for cache. When '1', the parity (ECC_CTL.PARITY\\[6:0\\]) is used when a refill is done from the FLASH macro to the ECC_CTL.WORD_ADDR\\[24:0\\]
word address."]
pub type RAM_ECC_INJ_EN_R = crate::BitReader<bool>;
#[doc = "Field `RAM_ECC_INJ_EN` writer - Enable error injection for cache. When '1', the parity (ECC_CTL.PARITY\\[6:0\\]) is used when a refill is done from the FLASH macro to the ECC_CTL.WORD_ADDR\\[24:0\\]
word address."]
pub type RAM_ECC_INJ_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CM0_CA_CTL0_SPEC, bool, O>;
...
#[doc = "Field `CA_EN` reader - Cache enable: 0: Disabled. The cache tag valid bits are reset to '0's and the cache LRU information is set to '1's (making way 0 the LRU way and way 3 the MRU way). 1: Enabled.G269"]
pub type CA_EN_R = crate::BitReader<bool>;
#[doc = "Field `CA_EN` writer - Cache enable: 0: Disabled. The cache tag valid bits are reset to '0's and the cache LRU information is set to '1's (making way 0 the LRU way and way 3 the MRU way). 1: Enabled.G269"]
pub type CA_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CM0_CA_CTL0_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 1 - Enable error injection for cache. When '1', the parity (ECC_CTL.PARITY\\[6:0\\]) is used when a refill is done from the FLASH macro to the ECC_CTL.WORD_ADDR\\[24:0\\]
word address."]
    #[inline(always)]
    ...
    #[doc = "Bit 31 - Cache enable: 0: Disabled. The cache tag valid bits are reset to '0's and the cache LRU information is set to '1's (making way 0 the LRU way and way 3 the MRU way). 1: Enabled.G269"]
    #[inline(always)]
