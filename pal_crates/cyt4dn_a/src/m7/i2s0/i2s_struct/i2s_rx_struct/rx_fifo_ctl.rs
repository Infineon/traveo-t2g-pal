...
#[doc = "Trigger level. When the RX FIFO has more entries than the number of this field, a receiver trigger event is generated: - INTR_RX.FIFO_TRIGGER = (# FIFO entries > TRIGGER_LEVEL)\n\nValue on reset: 0"]
...
pub type TRIGGER_LEVEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RX_FIFO_CTL_SPEC, u8, TRIGGER_LEVEL_A, 6, O>;
...
impl R {
    #[doc = "Bits 0:5 - Trigger level. When the RX FIFO has more entries than the number of this field, a receiver trigger event is generated: - INTR_RX.FIFO_TRIGGER = (# FIFO entries > TRIGGER_LEVEL)"]
    #[inline(always)]
