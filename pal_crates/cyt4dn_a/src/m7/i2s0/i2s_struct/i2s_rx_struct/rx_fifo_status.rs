...
#[doc = "Field `USED` reader - Number of used/occupied entries in the RX FIFO. The field value is in the range \\[0, 64\\]. When '0', the FIFO is empty. When '64', the FIFO is full."]
pub type USED_R = crate::FieldReader<u8, USED_A>;
#[doc = "Number of used/occupied entries in the RX FIFO. The field value is in the range \\[0, 64\\]. When '0', the FIFO is empty. When '64', the FIFO is full.\n\nValue on reset: 0"]
...
impl R {
    #[doc = "Bits 0:6 - Number of used/occupied entries in the RX FIFO. The field value is in the range \\[0, 64\\]. When '0', the FIFO is empty. When '64', the FIFO is full."]
    #[inline(always)]
    pub fn used(&self) -> USED_R {
        USED_R::new((self.bits & 0x7f) as u8)
    }
    #[doc = "Bits 16:21 - RX FIFO read pointer: FIFO location from which a data is read. Note: This functionality is intended for debugging purposes."]
    #[inline(always)]
    pub fn rd_ptr(&self) -> RD_PTR_R {
        RD_PTR_R::new(((self.bits >> 16) & 0x3f) as u8)
    }
    #[doc = "Bits 24:29 - RX FIFO write pointer: FIFO location at which a new data is written by the hardware. Note: This functionality is intended for debugging purposes."]
    #[inline(always)]
