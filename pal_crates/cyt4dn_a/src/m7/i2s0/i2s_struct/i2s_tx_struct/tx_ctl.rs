...
#[doc = "Field `MS` reader - Master/slave setting: '0': Slave. - External transmitter 'i2s_tx_sck_in' and transmitter 'i2s_tx_ws_in'. '1': Master. - Interface clock 'clk_if' is used to generate transmitter 'i2s_tx_sck_out' and transmitter 'i2s_tx_ws_out'."]
pub type MS_R = crate::BitReader<MS_A>;
#[doc = "Master/slave setting: '0': Slave. - External transmitter 'i2s_tx_sck_in' and transmitter 'i2s_tx_ws_in'. '1': Master. - Interface clock 'clk_if' is used to generate transmitter 'i2s_tx_sck_out' and transmitter 'i2s_tx_ws_out'.\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum MS_A {
    #[doc = "0: N/A"]
    SLAVE = 0,
...
#[doc = "Field `MS` writer - Master/slave setting: '0': Slave. - External transmitter 'i2s_tx_sck_in' and transmitter 'i2s_tx_ws_in'. '1': Master. - Interface clock 'clk_if' is used to generate transmitter 'i2s_tx_sck_out' and transmitter 'i2s_tx_ws_out'."]
...
impl R {
    ...
    #[doc = "Bit 16 - Master/slave setting: '0': Slave. - External transmitter 'i2s_tx_sck_in' and transmitter 'i2s_tx_ws_in'. '1': Master. - Interface clock 'clk_if' is used to generate transmitter 'i2s_tx_sck_out' and transmitter 'i2s_tx_ws_out'."]
    #[inline(always)]
    pub fn ms(&self) -> MS_R {
