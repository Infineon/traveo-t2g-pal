...
(default setting). '1': data\\[31:16\\]. '2': Constant PCM data value of '0'; i.e. source FIFO data is not used. '3': Constant PCM data value of '0'; i.e. source FIFO data is not used. Note: CH0_SEL and CH1_SEL are used to specify mono and stereo audio formats."]
...
(default setting). '2': Constant PCM data value of '0'; i.e. source FIFO data is not used. '3': Constant PCM data value of '0'; i.e. source FIFO data is not used."]
...
#[doc = "Field `ENABLED` reader - Source enable: '0': Disabled. All non-retained MMIO registers (e.g. the SRC_STATUS, SRC_FIFO_STATUS and INTR_SRC registers) have their fields reset to their default value. '1': Enabled."]
pub type ENABLED_R = crate::BitReader<bool>;
#[doc = "Field `ENABLED` writer - Source enable: '0': Disabled. All non-retained MMIO registers (e.g. the SRC_STATUS, SRC_FIFO_STATUS and INTR_SRC registers) have their fields reset to their default value. '1': Enabled."]
...
(default setting). '2': Constant PCM data value of '0'; i.e. source FIFO data is not used. '3': Constant PCM data value of '0'; i.e. source FIFO data is not used."]
    ...
    #[doc = "Bit 31 - Source enable: '0': Disabled. All non-retained MMIO registers (e.g. the SRC_STATUS, SRC_FIFO_STATUS and INTR_SRC registers) have their fields reset to their default value. '1': Enabled."]
    #[inline(always)]
