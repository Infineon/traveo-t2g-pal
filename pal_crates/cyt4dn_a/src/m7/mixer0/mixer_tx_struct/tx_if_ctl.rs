...
#[doc = "Interface clock divider (legal range \\[1, 255\\]). The I2S interface 'i2s_tx_sck_out' output signal is defined as clk_if / (CLOCK_DIV + 1). CLOCK_DIV should be set to an odd value ({1, 3, 5, ..., 255}), to ensure a 50/50 percent duty cycle clock. Note: Used in master configuration only.\n\nValue on reset: 7"]
...
pub type CLOCK_DIV_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TX_IF_CTL_SPEC, u8, CLOCK_DIV_A, 8, O>;
...
#[doc = "Field `CLOCK_SEL` reader - Interface clock 'clk_if' selection: '0': SRSS clock clk_if_srss. '1'-'3': Clock 'clk_if' is off. '4': Master interface clock 'mixer_tx_mck_in'. '5'-'7': SRSS clock clk_if_srss. Note: intent was to have '5'-'7' as 'clock off'. Current behavior is as described above. May fix this in future IP release."]
pub type CLOCK_SEL_R = crate::FieldReader<u8, CLOCK_SEL_A>;
#[doc = "Interface clock 'clk_if' selection: '0': SRSS clock clk_if_srss. '1'-'3': Clock 'clk_if' is off. '4': Master interface clock 'mixer_tx_mck_in'. '5'-'7': SRSS clock clk_if_srss. Note: intent was to have '5'-'7' as 'clock off'. Current behavior is as described above. May fix this in future IP release.\n\nValue on reset: 7"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
...
impl CLOCK_SEL_R {
    ...
    pub fn variant(&self) -> Option<CLOCK_SEL_A> {
        match self.bits {
            ...
            4 => Some(CLOCK_SEL_A::SEL_MIXER_TX_MCK_IN),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `SEL_MIXER_TX_MCK_IN`"]
    #[inline(always)]
    pub fn is_sel_mixer_tx_mck_in(&self) -> bool {
        *self == CLOCK_SEL_A::SEL_MIXER_TX_MCK_IN
    }
}
#[doc = "Field `CLOCK_SEL` writer - Interface clock 'clk_if' selection: '0': SRSS clock clk_if_srss. '1'-'3': Clock 'clk_if' is off. '4': Master interface clock 'mixer_tx_mck_in'. '5'-'7': SRSS clock clk_if_srss. Note: intent was to have '5'-'7' as 'clock off'. Current behavior is as described above. May fix this in future IP release."]
...
impl<'a, const O: u8> CLOCK_SEL_W<'a, O> {
    ...
    #[doc = "N/A"]
    #[inline(always)]
    pub fn sel_mixer_tx_mck_in(self) -> &'a mut W {
        self.variant(CLOCK_SEL_A::SEL_MIXER_TX_MCK_IN)
    }
}
...
#[doc = "Field `CH0_EN` reader - Channel 0 enable: '0': Disabled. The TX FIFO does not produce channel 0 words and 'mixer_tx_sd_out' is not driven. '1': Enabled."]
pub type CH0_EN_R = crate::BitReader<bool>;
#[doc = "Field `CH0_EN` writer - Channel 0 enable: '0': Disabled. The TX FIFO does not produce channel 0 words and 'mixer_tx_sd_out' is not driven. '1': Enabled."]
pub type CH0_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, TX_IF_CTL_SPEC, bool, O>;
#[doc = "Field `CH1_EN` reader - Channel 1 enable: '0': Disabled. The TX FIFO does not produce channel 1 words and 'mixer_tx_sd_out' is not driven. '1': Enabled."]
pub type CH1_EN_R = crate::BitReader<bool>;
#[doc = "Field `CH1_EN` writer - Channel 1 enable: '0': Disabled. The TX FIFO does not produce channel 1 words and 'mixer_tx_sd_out' is not driven. '1': Enabled."]
...
impl R {
    ...
    #[doc = "Bits 8:10 - Interface clock 'clk_if' selection: '0': SRSS clock clk_if_srss. '1'-'3': Clock 'clk_if' is off. '4': Master interface clock 'mixer_tx_mck_in'. '5'-'7': SRSS clock clk_if_srss. Note: intent was to have '5'-'7' as 'clock off'. Current behavior is as described above. May fix this in future IP release."]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - Channel 0 enable: '0': Disabled. The TX FIFO does not produce channel 0 words and 'mixer_tx_sd_out' is not driven. '1': Enabled."]
    #[inline(always)]
    pub fn ch0_en(&self) -> CH0_EN_R {
        CH0_EN_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - Channel 1 enable: '0': Disabled. The TX FIFO does not produce channel 1 words and 'mixer_tx_sd_out' is not driven. '1': Enabled."]
    #[inline(always)]
