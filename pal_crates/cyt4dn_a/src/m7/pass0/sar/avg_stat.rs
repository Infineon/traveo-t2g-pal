...
#[doc = "Field `CUR_AVG_CNT` reader - the current value of the averaging counter. Note that the value shown is updated after the sample window and therefore runs ahead of the accumulator update."]
...
impl R {
    ...
    #[doc = "Bits 24:31 - the current value of the averaging counter. Note that the value shown is updated after the sample window and therefore runs ahead of the accumulator update."]
    #[inline(always)]
