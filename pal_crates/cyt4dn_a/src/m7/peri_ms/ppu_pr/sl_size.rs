...
pub type REGION_SIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SL_SIZE_SPEC, u8, u8, 5, O>;
...
pub type VALID_W<'a, const O: u8> = crate::BitWriter<'a, u32, SL_SIZE_SPEC, bool, O>;
impl R {
