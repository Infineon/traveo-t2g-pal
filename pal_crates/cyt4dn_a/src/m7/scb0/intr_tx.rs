...
#[doc = "Field `NOT_FULL` reader - TX FIFO is not full. Dependent on CTRL.MEM_WIDTH: MEM_WIDTH is '0': # entries != FF_DATA_NR. MEM_WIDTH is '1': # entries != FF_DATA_NR/2. MEM_WIDTH is '2': # entries != FF_DATA_NR/4. Only used in FIFO mode."]
pub type NOT_FULL_R = crate::BitReader<bool>;
#[doc = "Field `NOT_FULL` writer - TX FIFO is not full. Dependent on CTRL.MEM_WIDTH: MEM_WIDTH is '0': # entries != FF_DATA_NR. MEM_WIDTH is '1': # entries != FF_DATA_NR/2. MEM_WIDTH is '2': # entries != FF_DATA_NR/4. Only used in FIFO mode."]
...
impl R {
    ...
    #[doc = "Bit 1 - TX FIFO is not full. Dependent on CTRL.MEM_WIDTH: MEM_WIDTH is '0': # entries != FF_DATA_NR. MEM_WIDTH is '1': # entries != FF_DATA_NR/2. MEM_WIDTH is '2': # entries != FF_DATA_NR/4. Only used in FIFO mode."]
    #[inline(always)]
