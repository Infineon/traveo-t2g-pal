...
pub type TRIGGER_LEVEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RX_FIFO_CTRL_SPEC, u8, u8, 8, O>;
...
pub type FREEZE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RX_FIFO_CTRL_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:7 - Trigger level. When the receiver FIFO has more entries than the number of this field, a receiver trigger event is generated."]
    #[inline(always)]
