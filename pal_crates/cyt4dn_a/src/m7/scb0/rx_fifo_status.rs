...
#[doc = "Field `USED` reader - Amount of entries in the receiver FIFO. The value of this field ranges from 0 to FF_DATA_NR."]
...
impl R {
    #[doc = "Bits 0:8 - Amount of entries in the receiver FIFO. The value of this field ranges from 0 to FF_DATA_NR."]
    #[inline(always)]
