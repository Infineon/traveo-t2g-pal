...
#[doc = "Field `CC0_MATCH` reader - Logical and of corresponding request and mask bits."]
pub type CC0_MATCH_R = crate::BitReader<bool>;
#[doc = "Field `CC1_MATCH` reader - Logical and of corresponding request and mask bits."]
