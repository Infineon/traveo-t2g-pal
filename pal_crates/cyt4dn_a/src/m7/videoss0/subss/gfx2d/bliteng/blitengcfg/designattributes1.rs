...
#[doc = "Field `GPSCALERWIDTH` reader - Returns the maximum width that can be rendert in LBO mode minus one."]
pub type GPSCALERWIDTH_R = crate::FieldReader<u16, u16>;
impl R {
    #[doc = "Bits 0:13 - Returns the maximum width that can be rendert in LBO mode minus one."]
    #[inline(always)]
...
#[doc = "`reset()` method sets DESIGNATTRIBUTES1 to value 0x063f"]
impl crate::Resettable for DESIGNATTRIBUTES1_SPEC {
    const RESET_VALUE: Self::Ux = 0x063f;
}
