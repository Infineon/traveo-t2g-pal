...
#[doc = "Field `LBHLINK2MAXFREELINES` reader - The maximal number of free lines in the line buffer that can be written by the store. Writting to this register has no effect, reading provides the value and simultaneously resets the register."]
pub type LBHLINK2MAXFREELINES_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LBHLINK2MAXFREELINES` writer - The maximal number of free lines in the line buffer that can be written by the store. Writting to this register has no effect, reading provides the value and simultaneously resets the register."]
