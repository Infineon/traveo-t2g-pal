...
#[doc = "Field `LBHLINK3MAXFREELINES` reader - The maximal number of free lines in the line buffer that can be written by the store. Writting to this register has no effect, reading provides the value and simultaneously resets the register."]
pub type LBHLINK3MAXFREELINES_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LBHLINK3MAXFREELINES` writer - The maximal number of free lines in the line buffer that can be written by the store. Writting to this register has no effect, reading provides the value and simultaneously resets the register."]
