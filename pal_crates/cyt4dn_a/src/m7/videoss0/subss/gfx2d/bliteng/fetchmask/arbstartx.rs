...
#[doc = "Field `ARBSTARTX` reader - Start point for sample-point interpolation (X coordinate)."]
pub type ARBSTARTX_R = crate::FieldReader<u32, u32>;
#[doc = "Field `ARBSTARTX` writer - Start point for sample-point interpolation (X coordinate)."]
pub type ARBSTARTX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ARBSTARTX_SPEC, u32, u32, 21, O>;
impl R {
    #[doc = "Bits 0:20 - Start point for sample-point interpolation (X coordinate)."]
    #[inline(always)]
