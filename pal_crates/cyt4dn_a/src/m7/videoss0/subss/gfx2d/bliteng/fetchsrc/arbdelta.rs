...
#[doc = "Field `ARBDELTAXX` reader - X coordinate of vector between first and second sample point."]
pub type ARBDELTAXX_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ARBDELTAXX` writer - X coordinate of vector between first and second sample point."]
pub type ARBDELTAXX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ARBDELTA_SPEC, u8, u8, 8, O>;
#[doc = "Field `ARBDELTAXY` reader - Y coordinate of vector between first and second sample point."]
pub type ARBDELTAXY_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ARBDELTAXY` writer - Y coordinate of vector between first and second sample point."]
pub type ARBDELTAXY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ARBDELTA_SPEC, u8, u8, 8, O>;
#[doc = "Field `ARBDELTAYX` reader - X coordinate of vector between start and first sample point."]
pub type ARBDELTAYX_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ARBDELTAYX` writer - X coordinate of vector between start and first sample point."]
pub type ARBDELTAYX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ARBDELTA_SPEC, u8, u8, 8, O>;
#[doc = "Field `ARBDELTAYY` reader - Y coordinate of vector between start and first sample point."]
pub type ARBDELTAYY_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ARBDELTAYY` writer - Y coordinate of vector between start and first sample point."]
pub type ARBDELTAYY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ARBDELTA_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - X coordinate of vector between first and second sample point."]
    #[inline(always)]
    pub fn arbdeltaxx(&self) -> ARBDELTAXX_R {
        ARBDELTAXX_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - Y coordinate of vector between first and second sample point."]
    #[inline(always)]
    pub fn arbdeltaxy(&self) -> ARBDELTAXY_R {
        ARBDELTAXY_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - X coordinate of vector between start and first sample point."]
    #[inline(always)]
    pub fn arbdeltayx(&self) -> ARBDELTAYX_R {
        ARBDELTAYX_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - Y coordinate of vector between start and first sample point."]
    #[inline(always)]
