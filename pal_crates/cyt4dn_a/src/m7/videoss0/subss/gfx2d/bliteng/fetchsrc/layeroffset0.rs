...
#[doc = "Field `LAYERXOFFSET0` reader - Horizontal offset (X)."]
pub type LAYERXOFFSET0_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LAYERXOFFSET0` writer - Horizontal offset (X)."]
pub type LAYERXOFFSET0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYEROFFSET0_SPEC, u16, u16, 15, O>;
#[doc = "Field `LAYERYOFFSET0` reader - Vertical offset (Y)."]
pub type LAYERYOFFSET0_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LAYERYOFFSET0` writer - Vertical offset (Y)."]
