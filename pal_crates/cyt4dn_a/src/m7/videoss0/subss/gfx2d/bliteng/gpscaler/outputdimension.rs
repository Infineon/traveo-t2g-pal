...
#[doc = "Field `OUTPUT_WIDTH` reader - Number of output pixel per input line. This number is equal to the width of the output frame minus one."]
pub type OUTPUT_WIDTH_R = crate::FieldReader<u16, u16>;
#[doc = "Field `OUTPUT_WIDTH` writer - Number of output pixel per input line. This number is equal to the width of the output frame minus one."]
pub type OUTPUT_WIDTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OUTPUTDIMENSION_SPEC, u16, u16, 14, O>;
#[doc = "Field `OUTPUT_HEIGHT` reader - Number of output lines per input frame or slice. This number is equal to the height of the output frame minus one."]
pub type OUTPUT_HEIGHT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `OUTPUT_HEIGHT` writer - Number of output lines per input frame or slice. This number is equal to the height of the output frame minus one."]
pub type OUTPUT_HEIGHT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OUTPUTDIMENSION_SPEC, u16, u16, 14, O>;
impl R {
    #[doc = "Bits 0:13 - Number of output pixel per input line. This number is equal to the width of the output frame minus one."]
    #[inline(always)]
    pub fn output_width(&self) -> OUTPUT_WIDTH_R {
        OUTPUT_WIDTH_R::new((self.bits & 0x3fff) as u16)
    }
    #[doc = "Bits 16:29 - Number of output lines per input frame or slice. This number is equal to the height of the output frame minus one."]
    #[inline(always)]
