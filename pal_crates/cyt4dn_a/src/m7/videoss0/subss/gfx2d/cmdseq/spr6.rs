...
#[doc = "Field `LINECOUNTERTB6` reader - Holds the scheduled line of the frame that is beeing executed in TB6. The value of this register is routed outside CmdSeq."]
pub type LINECOUNTERTB6_R = crate::FieldReader<u16, u16>;
impl R {
    #[doc = "Bits 0:15 - Holds the scheduled line of the frame that is beeing executed in TB6. The value of this register is routed outside CmdSeq."]
    #[inline(always)]
