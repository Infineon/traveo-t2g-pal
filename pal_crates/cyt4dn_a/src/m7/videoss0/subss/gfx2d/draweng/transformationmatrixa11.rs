...
#[doc = "Field `A11` reader - A11, given in signed fixed-point 26.6 two's complement notation."]
pub type A11_R = crate::FieldReader<u32, u32>;
#[doc = "Field `A11` writer - A11, given in signed fixed-point 26.6 two's complement notation."]
pub type A11_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TRANSFORMATIONMATRIXA11_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - A11, given in signed fixed-point 26.6 two's complement notation."]
    #[inline(always)]
