...
#[doc = "Field `TRANSLATIONX` reader - Horizontal translation (X), given in signed 16.6 fixed-point format. Fractional part is used for processing. The integer part modifies the XOffset field of the LayerOffset register for subesequent Blit operation."]
pub type TRANSLATIONX_R = crate::FieldReader<u32, u32>;
#[doc = "Field `TRANSLATIONX` writer - Horizontal translation (X), given in signed 16.6 fixed-point format. Fractional part is used for processing. The integer part modifies the XOffset field of the LayerOffset register for subesequent Blit operation."]
pub type TRANSLATIONX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TRANSLATIONVECTORX_SPEC, u32, u32, 22, O>;
impl R {
    #[doc = "Bits 0:21 - Horizontal translation (X), given in signed 16.6 fixed-point format. Fractional part is used for processing. The integer part modifies the XOffset field of the LayerOffset register for subesequent Blit operation."]
    #[inline(always)]
