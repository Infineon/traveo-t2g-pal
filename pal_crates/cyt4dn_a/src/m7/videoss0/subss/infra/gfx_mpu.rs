...
#[repr(C)]
pub struct GFX_MPU {
    #[doc = "0x00 - Memory protection context for AXI read master with ID=1"]
    pub rd1_ctl: RD1_CTL,
    #[doc = "0x04 - Memory protection context for AXI read master with ID=2"]
    pub rd2_ctl: RD2_CTL,
    #[doc = "0x08 - Memory protection context for AXI read master with ID=3"]
    pub rd3_ctl: RD3_CTL,
    #[doc = "0x0c - Memory protection context for AXI read master with ID=4"]
    pub rd4_ctl: RD4_CTL,
    #[doc = "0x10 - Memory protection context for AXI read master with ID=5"]
    pub rd5_ctl: RD5_CTL,
    #[doc = "0x14 - Memory protection context for AXI read master with ID=6"]
    pub rd6_ctl: RD6_CTL,
    #[doc = "0x18 - Memory protection7context for AXI read master with ID=7"]
    pub rd7_ctl: RD7_CTL,
    #[doc = "0x1c - Memory protection7context for AXI read master with ID=8"]
    pub rd8_ctl: RD8_CTL,
    #[doc = "0x20 - Memory protection7context for AXI read master with ID=9"]
    pub rd9_ctl: RD9_CTL,
    #[doc = "0x24 - Memory protection7context for AXI read master with ID=10"]
    pub rd10_ctl: RD10_CTL,
    #[doc = "0x28 - Memory protection7context for AXI read master with ID=11"]
    pub rd11_ctl: RD11_CTL,
    #[doc = "0x2c - Memory protection7context for AXI read master with ID=12"]
    pub rd12_ctl: RD12_CTL,
    #[doc = "0x30 - Memory protection7context for AXI read master with ID=12"]
    pub rd13_ctl: RD13_CTL,
    #[doc = "0x34 - Memory protection7context for AXI read master with ID=12"]
    pub rd14_ctl: RD14_CTL,
    #[doc = "0x38 - Memory protection7context for AXI read master with ID=12"]
    pub rd15_ctl: RD15_CTL,
    #[doc = "0x3c - Memory protection context for AXI write master with ID=1"]
    pub wr1_ctl: WR1_CTL,
    #[doc = "0x40 - Memory protection context for AXI write master with ID=2"]
    pub wr2_ctl: WR2_CTL,
    #[doc = "0x44 - Memory protection context for AXI write master with ID=3"]
    pub wr3_ctl: WR3_CTL,
    #[doc = "0x48 - Memory protection context for AXI write master with ID=4"]
    pub wr4_ctl: WR4_CTL,
    #[doc = "0x4c - Memory protection context for AXI write master with ID=5"]
    pub wr5_ctl: WR5_CTL,
    #[doc = "0x50 - Memory protection context for AXI write master with ID=6"]
    pub wr6_ctl: WR6_CTL,
    #[doc = "0x54 - Memory protection7context for AXI write master with ID=7"]
    pub wr7_ctl: WR7_CTL,
    #[doc = "0x58 - Memory protection7context for AXI write master with ID=8"]
    pub wr8_ctl: WR8_CTL,
    #[doc = "0x5c - Memory protection7context for AXI write master with ID=9"]
    pub wr9_ctl: WR9_CTL,
    #[doc = "0x60 - Memory protection7context for AXI write master with ID=10"]
    pub wr10_ctl: WR10_CTL,
    #[doc = "0x64 - Memory protection7context for AXI write master with ID=11"]
    pub wr11_ctl: WR11_CTL,
    #[doc = "0x68 - Memory protection7context for AXI write master with ID=12"]
    pub wr12_ctl: WR12_CTL,
    #[doc = "0x6c - Memory protection7context for AXI write master with ID=12"]
    pub wr13_ctl: WR13_CTL,
    #[doc = "0x70 - Memory protection7context for AXI write master with ID=12"]
    pub wr14_ctl: WR14_CTL,
    #[doc = "0x74 - Memory protection7context for AXI write master with ID=12"]
...
#[doc = "Memory protection context for AXI read master with ID=2"]
pub mod rd2_ctl;
...
#[doc = "Memory protection context for AXI read master with ID=5"]
pub mod rd5_ctl;
#[doc = "RD6_CTL (rw) register accessor: an alias for `Reg<RD6_CTL_SPEC>`"]
pub type RD6_CTL = crate::Reg<rd6_ctl::RD6_CTL_SPEC>;
#[doc = "Memory protection context for AXI read master with ID=6"]
pub mod rd6_ctl;
...
#[doc = "Memory protection7context for AXI read master with ID=8"]
pub mod rd8_ctl;
...
#[doc = "Memory protection7context for AXI read master with ID=11"]
pub mod rd11_ctl;
...
#[doc = "Memory protection7context for AXI write master with ID=10"]
pub mod wr10_ctl;
#[doc = "WR11_CTL (rw) register accessor: an alias for `Reg<WR11_CTL_SPEC>`"]
pub type WR11_CTL = crate::Reg<wr11_ctl::WR11_CTL_SPEC>;
#[doc = "Memory protection7context for AXI write master with ID=11"]
pub mod wr11_ctl;
