...
#[doc = "Field `FPDLINK0` reader - 1st FPD-Link Video Output Interface available (0 = no, 1 = yes)"]
pub type FPDLINK0_R = crate::BitReader<bool>;
#[doc = "Field `FPDLINK1` reader - 2nd FPD-Link Video Output Interface available (0 = no, 1 = yes)"]
...
impl R {
    ...
    #[doc = "Bit 2 - 1st FPD-Link Video Output Interface available (0 = no, 1 = yes)"]
    #[inline(always)]
    pub fn fpdlink0(&self) -> FPDLINK0_R {
        FPDLINK0_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - 2nd FPD-Link Video Output Interface available (0 = no, 1 = yes)"]
    #[inline(always)]
