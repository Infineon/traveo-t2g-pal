...
#[doc = "Field `LEVGOODFRAMES` reader - Number of continous correct frames that must be processed before SecSyncStat field goes 1 (in sync). Value of 0 is not allowed."]
pub type LEVGOODFRAMES_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LEVGOODFRAMES` writer - Number of continous correct frames that must be processed before SecSyncStat field goes 1 (in sync). Value of 0 is not allowed."]
...
pub type LEVBADFRAMES_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SECSTATCONFIG_SPEC, u8, u8, 4, O>;
#[doc = "Field `LEVSKEWINRANGE` reader - Number of continous frames the measured skew value shall be within the range defined by SyncRangeLow and SyncRangeHigh. If this condition is true, additionally LevGoodFrames valid frames must be processed before the status line of the sec. channel and the SecSyncStat status field goes to 1 indicating synchronized status. Value of 0 is not allowed."]
pub type LEVSKEWINRANGE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LEVSKEWINRANGE` writer - Number of continous frames the measured skew value shall be within the range defined by SyncRangeLow and SyncRangeHigh. If this condition is true, additionally LevGoodFrames valid frames must be processed before the status line of the sec. channel and the SecSyncStat status field goes to 1 indicating synchronized status. Value of 0 is not allowed."]
pub type LEVSKEWINRANGE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SECSTATCONFIG_SPEC, u8, u8, 4, O>;
impl R {
    #[doc = "Bits 0:3 - Number of continous correct frames that must be processed before SecSyncStat field goes 1 (in sync). Value of 0 is not allowed."]
    #[inline(always)]
    ...
    #[doc = "Bits 8:11 - Number of continous frames the measured skew value shall be within the range defined by SyncRangeLow and SyncRangeHigh. If this condition is true, additionally LevGoodFrames valid frames must be processed before the status line of the sec. channel and the SecSyncStat status field goes to 1 indicating synchronized status. Value of 0 is not allowed."]
    #[inline(always)]
