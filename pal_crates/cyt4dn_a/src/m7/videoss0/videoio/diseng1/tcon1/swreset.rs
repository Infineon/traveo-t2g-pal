...
#[doc = "Field `RESETWORDEND` reader - 8-Bits Value, that will be blent on falling edge of tsig\\[11\\]
into miniLVDS stream"]
pub type RESETWORDEND_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RESETWORDEND` writer - 8-Bits Value, that will be blent on falling edge of tsig\\[11\\]
into miniLVDS stream"]
pub type RESETWORDEND_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SWRESET_SPEC, u8, u8, 8, O>;
#[doc = "Field `RESETWORDSTART` reader - 8-Bits Value, that will be blent on rising edge of tsig\\[11\\]
into miniLVDS stream"]
pub type RESETWORDSTART_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RESETWORDSTART` writer - 8-Bits Value, that will be blent on rising edge of tsig\\[11\\]
into miniLVDS stream"]
...
mapped to enable Blending Reset Pulse to \\[LLV5.LLV0\\]."]
    ...
    #[doc = "Bits 16:23 - 8-Bits Value, that will be blent on falling edge of tsig\\[11\\]
into miniLVDS stream"]
    #[inline(always)]
    pub fn resetwordend(&self) -> RESETWORDEND_R {
        RESETWORDEND_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - 8-Bits Value, that will be blent on rising edge of tsig\\[11\\]
into miniLVDS stream"]
    #[inline(always)]
...
pulse=n*pixel_period, (n-1)*0xFF will be blent between ResetWordStart and ResetWordEnd into miniLVDS stream Note 2/ if( EnResetWord=0) Reset-Pulse (ResetWordStart,ResetWordEnd) won't be blent into miniLVDS stream. Pixels will be transfered unchanged\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [swreset](index.html) module"]
