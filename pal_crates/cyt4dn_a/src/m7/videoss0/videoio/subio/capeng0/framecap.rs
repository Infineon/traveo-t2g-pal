...
pub mod sts;
#[doc = "MDSTS0 (rw) register accessor: an alias for `Reg<MDSTS0_SPEC>`"]
...
pub mod mdsts0;
#[doc = "MDSTS1 (rw) register accessor: an alias for `Reg<MDSTS1_SPEC>`"]
