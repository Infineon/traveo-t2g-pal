...
#[doc = "Field `HEIGHT` reader - Expected frame heigth of video frames and fields with id 0 (value is Heigth - 1). It could be configured after mode detection."]
pub type HEIGHT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `HEIGHT` writer - Expected frame heigth of video frames and fields with id 0 (value is Heigth - 1). It could be configured after mode detection."]
...
impl R {
    ...
    #[doc = "Bits 16:29 - Expected frame heigth of video frames and fields with id 0 (value is Heigth - 1). It could be configured after mode detection."]
    #[inline(always)]
