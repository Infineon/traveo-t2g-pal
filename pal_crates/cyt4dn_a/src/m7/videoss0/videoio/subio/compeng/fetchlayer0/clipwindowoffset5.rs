...
#[doc = "Field `CLIPWINDOWXOFFSET5` reader - Horizontal position (X)."]
pub type CLIPWINDOWXOFFSET5_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWXOFFSET5` writer - Horizontal position (X)."]
pub type CLIPWINDOWXOFFSET5_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLIPWINDOWOFFSET5_SPEC, u16, u16, 15, O>;
#[doc = "Field `CLIPWINDOWYOFFSET5` reader - Vertical position (Y)."]
pub type CLIPWINDOWYOFFSET5_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWYOFFSET5` writer - Vertical position (Y)."]
