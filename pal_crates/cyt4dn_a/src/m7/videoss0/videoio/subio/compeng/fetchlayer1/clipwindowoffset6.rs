...
#[doc = "Field `CLIPWINDOWXOFFSET6` reader - Horizontal position (X)."]
pub type CLIPWINDOWXOFFSET6_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWXOFFSET6` writer - Horizontal position (X)."]
pub type CLIPWINDOWXOFFSET6_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLIPWINDOWOFFSET6_SPEC, u16, u16, 15, O>;
#[doc = "Field `CLIPWINDOWYOFFSET6` reader - Vertical position (Y)."]
pub type CLIPWINDOWYOFFSET6_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWYOFFSET6` writer - Vertical position (Y)."]
