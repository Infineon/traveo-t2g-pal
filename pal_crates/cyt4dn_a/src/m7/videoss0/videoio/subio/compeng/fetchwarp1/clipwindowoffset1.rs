...
#[doc = "Field `CLIPWINDOWXOFFSET1` reader - Horizontal position (X)."]
pub type CLIPWINDOWXOFFSET1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWXOFFSET1` writer - Horizontal position (X)."]
pub type CLIPWINDOWXOFFSET1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLIPWINDOWOFFSET1_SPEC, u16, u16, 15, O>;
#[doc = "Field `CLIPWINDOWYOFFSET1` reader - Vertical position (Y)."]
pub type CLIPWINDOWYOFFSET1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWYOFFSET1` writer - Vertical position (Y)."]
