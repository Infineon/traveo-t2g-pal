...
#[doc = "Field `LAYERXOFFSET1` reader - Horizontal offset (X)."]
pub type LAYERXOFFSET1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LAYERXOFFSET1` writer - Horizontal offset (X)."]
pub type LAYERXOFFSET1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYEROFFSET1_SPEC, u16, u16, 15, O>;
#[doc = "Field `LAYERYOFFSET1` reader - Vertical offset (Y)."]
pub type LAYERYOFFSET1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LAYERYOFFSET1` writer - Vertical offset (Y)."]
