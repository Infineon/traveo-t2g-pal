...
#[doc = "Field `SCALE_FACTOR_H` reader - Scale factor has to be greater than 0.0 and less than or equal to 1.0. If scale_mode is UPSCALE then the inverse scale factor has to be programmed."]
pub type SCALE_FACTOR_H_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SCALE_FACTOR_H` writer - Scale factor has to be greater than 0.0 and less than or equal to 1.0. If scale_mode is UPSCALE then the inverse scale factor has to be programmed."]
pub type SCALE_FACTOR_H_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SCALERSETUPH0_SPEC, u32, u32, 20, O>;
impl R {
    #[doc = "Bits 0:19 - Scale factor has to be greater than 0.0 and less than or equal to 1.0. If scale_mode is UPSCALE then the inverse scale factor has to be programmed."]
    #[inline(always)]
