...
#[doc = "Field `CLIP_WIDTH` reader - Width of clip window, given minus one."]
pub type CLIP_WIDTH_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIP_WIDTH` writer - Width of clip window, given minus one."]
pub type CLIP_WIDTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLIPWINSIZE_SPEC, u16, u16, 14, O>;
#[doc = "Field `CLIP_HEIGHT` reader - Height of clip window, given minus one."]
pub type CLIP_HEIGHT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIP_HEIGHT` writer - Height of clip window, given minus one."]
pub type CLIP_HEIGHT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLIPWINSIZE_SPEC, u16, u16, 14, O>;
impl R {
    #[doc = "Bits 0:13 - Width of clip window, given minus one."]
    #[inline(always)]
    pub fn clip_width(&self) -> CLIP_WIDTH_R {
        CLIP_WIDTH_R::new((self.bits & 0x3fff) as u16)
    }
    #[doc = "Bits 16:29 - Height of clip window, given minus one."]
    #[inline(always)]
