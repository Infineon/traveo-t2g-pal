...
#[doc = "Field `MSRMNT_STRT_TRIG` writer - Writing value 1 into this field initiates the measurement of the next frame."]
pub type MSRMNT_STRT_TRIG_W<'a, const O: u8> = crate::BitWriter<'a, u32, FRMSTRTTRIG_SPEC, bool, O>;
impl W {
    #[doc = "Bit 0 - Writing value 1 into this field initiates the measurement of the next frame."]
    #[inline(always)]
    #[must_use]
