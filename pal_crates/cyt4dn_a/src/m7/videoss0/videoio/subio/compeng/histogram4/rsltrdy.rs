...
#[doc = "Field `RSLT_RDY` reader - A one indicates that measurement results (in registers Rslt...) are valid and can be read."]
pub type RSLT_RDY_R = crate::BitReader<bool>;
impl R {
    #[doc = "Bit 0 - A one indicates that measurement results (in registers Rslt...) are valid and can be read."]
    #[inline(always)]
