...
#[doc = "Field `A31` reader - Value for red input."]
pub type A31_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A31` writer - Value for red input."]
pub type A31_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BLUE0_SPEC, u16, u16, 13, O>;
#[doc = "Field `A32` reader - Value for green input."]
pub type A32_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A32` writer - Value for green input."]
