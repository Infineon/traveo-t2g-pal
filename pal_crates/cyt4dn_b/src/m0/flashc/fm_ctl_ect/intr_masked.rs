...
#[doc = "Field `INTR_MASKED` reader - Logical and of corresponding request and mask fields."]
pub type INTR_MASKED_R = crate::BitReader<bool>;
impl R {
    #[doc = "Bit 0 - Logical and of corresponding request and mask fields."]
    #[inline(always)]
    pub fn intr_masked(&self) -> INTR_MASKED_R {
        INTR_MASKED_R::new((self.bits & 1) != 0)
    }
}
