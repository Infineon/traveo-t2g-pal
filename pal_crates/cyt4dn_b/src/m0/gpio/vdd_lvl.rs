...
#[doc = "Field `VDDIO_LVL` reader - The VDD_LVL circuit detects the VDDIO supply level and writes the detected value in this register. '0' indicates the VDDIO supply is at 1.2V and '1' indicates VDDIO supply is at 1.8V."]
pub type VDDIO_LVL_R = crate::FieldReader<u16, u16>;
impl R {
    #[doc = "Bits 0:15 - The VDD_LVL circuit detects the VDDIO supply level and writes the detected value in this register. '0' indicates the VDDIO supply is at 1.2V and '1' indicates VDDIO supply is at 1.8V."]
    #[inline(always)]
