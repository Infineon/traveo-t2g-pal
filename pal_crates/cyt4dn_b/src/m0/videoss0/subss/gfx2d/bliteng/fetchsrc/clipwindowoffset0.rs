...
#[doc = "Field `CLIPWINDOWXOFFSET0` reader - Horizontal position (X). (format is signed integer)"]
pub type CLIPWINDOWXOFFSET0_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWXOFFSET0` writer - Horizontal position (X). (format is signed integer)"]
pub type CLIPWINDOWXOFFSET0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLIPWINDOWOFFSET0_SPEC, u16, u16, 15, O>;
#[doc = "Field `CLIPWINDOWYOFFSET0` reader - Vertical position (Y). (format is signed integer)"]
pub type CLIPWINDOWYOFFSET0_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLIPWINDOWYOFFSET0` writer - Vertical position (Y). (format is signed integer)"]
