...
#[doc = "Field `SYNCRANGELOW` reader - Sync range of horizontal and vertical skew regulation. Lower value (signed value). If skew stays within programmed sync range, frame status is assumed synchronized. (format is signed integer)"]
pub type SYNCRANGELOW_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SYNCRANGELOW` writer - Sync range of horizontal and vertical skew regulation. Lower value (signed value). If skew stays within programmed sync range, frame status is assumed synchronized. (format is signed integer)"]
pub type SYNCRANGELOW_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FGSRCR5_SPEC, u32, u32, 29, O>;
impl R {
    #[doc = "Bits 0:28 - Sync range of horizontal and vertical skew regulation. Lower value (signed value). If skew stays within programmed sync range, frame status is assumed synchronized. (format is signed integer)"]
    #[inline(always)]
