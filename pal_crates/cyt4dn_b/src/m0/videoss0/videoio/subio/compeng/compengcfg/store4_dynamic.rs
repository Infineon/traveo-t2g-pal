...
#[doc = "Field `STORE4_SRC_SEL` reader - Selection of the source for the src input of the store4 module Value matrix4 is only supported for IPVersion 1 IPPhase 2 or higher."]
pub type STORE4_SRC_SEL_R = crate::FieldReader<u8, STORE4_SRC_SEL_A>;
#[doc = "Selection of the source for the src input of the store4 module Value matrix4 is only supported for IPVersion 1 IPPhase 2 or higher.\n\nValue on reset: 9"]
...
pub enum STORE4_SRC_SEL_A {
    ...
    EXTSRC4 = 9,
    #[doc = "19: Unit store4 input port src is connected to output of unit matrix4"]
    MATRIX4 = 19,
}
...
impl STORE4_SRC_SEL_R {
    ...
    pub fn variant(&self) -> Option<STORE4_SRC_SEL_A> {
        match self.bits {
            ...
            19 => Some(STORE4_SRC_SEL_A::MATRIX4),
            _ => None,
        }
    }
    ...
    pub fn is_matrix4(&self) -> bool {
        *self == STORE4_SRC_SEL_A::MATRIX4
    }
}
#[doc = "Field `STORE4_SRC_SEL` writer - Selection of the source for the src input of the store4 module Value matrix4 is only supported for IPVersion 1 IPPhase 2 or higher."]
...
impl<'a, const O: u8> STORE4_SRC_SEL_W<'a, O> {
    ...
    #[doc = "Unit store4 input port src is connected to output of unit matrix4"]
    #[inline(always)]
    pub fn matrix4(self) -> &'a mut W {
        self.variant(STORE4_SRC_SEL_A::MATRIX4)
    }
}
impl R {
    #[doc = "Bits 0:4 - Selection of the source for the src input of the store4 module Value matrix4 is only supported for IPVersion 1 IPPhase 2 or higher."]
    #[inline(always)]
