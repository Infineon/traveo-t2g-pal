...
#[doc = "Field `PALETTEENABLE6` reader - See PaletteEnable0."]
pub type PALETTEENABLE6_R = crate::BitReader<bool>;
#[doc = "Field `PALETTEENABLE6` writer - See PaletteEnable0."]
pub type PALETTEENABLE6_W<'a, const O: u8> =
...
pub type GAMMAREMOVEENABLE6_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LAYERPROPERTY6_SPEC, bool, O>;
#[doc = "Field `PALETTEOFFSET6` reader - see PaletteOffset0."]
pub type PALETTEOFFSET6_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PALETTEOFFSET6` writer - see PaletteOffset0."]
pub type PALETTEOFFSET6_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYERPROPERTY6_SPEC, u16, u16, 11, O>;
#[doc = "Field `PALETTEIDWIDTH6` reader - see PaletteIdWidth0."]
pub type PALETTEIDWIDTH6_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PALETTEIDWIDTH6` writer - see PaletteIdWidth0."]
pub type PALETTEIDWIDTH6_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYERPROPERTY6_SPEC, u8, u8, 3, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn paletteenable6(&self) -> PALETTEENABLE6_R {
        PALETTEENABLE6_R::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn paletteoffset6(&self) -> PALETTEOFFSET6_R {
        PALETTEOFFSET6_R::new(((self.bits >> 16) & 0x07ff) as u16)
    }
    #[doc = "Bits 27:29 - see PaletteIdWidth0."]
    #[inline(always)]
    pub fn paletteidwidth6(&self) -> PALETTEIDWIDTH6_R {
        PALETTEIDWIDTH6_R::new(((self.bits >> 27) & 7) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn paletteenable6(&mut self) -> PALETTEENABLE6_W<0> {
        PALETTEENABLE6_W::new(self)
    }
    #[doc = "Bits 1:2 - See TileMode0."]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn paletteoffset6(&mut self) -> PALETTEOFFSET6_W<16> {
        PALETTEOFFSET6_W::new(self)
    }
    #[doc = "Bits 27:29 - see PaletteIdWidth0."]
    #[inline(always)]
    #[must_use]
    pub fn paletteidwidth6(&mut self) -> PALETTEIDWIDTH6_W<27> {
        PALETTEIDWIDTH6_W::new(self)
    }
    #[doc = "Bit 30 - See ClipWindowEnable0."]
    #[inline(always)]
    #[must_use]
...
#[doc = "`reset()` method sets LAYERPROPERTY6 to value 0x3800_0008"]
