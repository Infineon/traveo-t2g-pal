...
#[doc = "Field `C1` reader - Red output offset. (format is signed integer)"]
pub type C1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `C1` writer - Red output offset. (format is signed integer)"]
pub type C1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OFFSETVECTOR0_SPEC, u16, u16, 13, O>;
#[doc = "Field `C2` reader - Green output offset. (format is signed integer)"]
pub type C2_R = crate::FieldReader<u16, u16>;
#[doc = "Field `C2` writer - Green output offset. (format is signed integer)"]
pub type C2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OFFSETVECTOR0_SPEC, u16, u16, 13, O>;
impl R {
    #[doc = "Bits 0:12 - Red output offset. (format is signed integer)"]
    #[inline(always)]
    pub fn c1(&self) -> C1_R {
        C1_R::new((self.bits & 0x1fff) as u16)
    }
    #[doc = "Bits 16:28 - Green output offset. (format is signed integer)"]
    #[inline(always)]
    pub fn c2(&self) -> C2_R {
