...
#[doc = "Field `INTR_VIDEOIO0_SAFETY` reader - Interrupt status vector. A bit is set when the related event occurs or the corresponding bit of INTR_VIDEOIO0_SET is written. By writing 1 the corresponding bit is cleared."]
pub type INTR_VIDEOIO0_SAFETY_R = crate::FieldReader<u32, u32>;
#[doc = "Field `INTR_VIDEOIO0_SAFETY` writer - Interrupt status vector. A bit is set when the related event occurs or the corresponding bit of INTR_VIDEOIO0_SET is written. By writing 1 the corresponding bit is cleared."]
pub type INTR_VIDEOIO0_SAFETY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, INTR_VIDEOIO0_SAFETY_SPEC, u32, u32, 24, O>;
impl R {
    #[doc = "Bits 0:23 - Interrupt status vector. A bit is set when the related event occurs or the corresponding bit of INTR_VIDEOIO0_SET is written. By writing 1 the corresponding bit is cleared."]
    #[inline(always)]
