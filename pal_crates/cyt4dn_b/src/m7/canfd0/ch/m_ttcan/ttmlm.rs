...
#[doc = "Field `CCM` reader - N/A"]
pub type CCM_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CCM` writer - N/A"]
pub type CCM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TTMLM_SPEC, u8, u8, 6, O>;
#[doc = "Field `CSS` reader - N/A"]
pub type CSS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CSS` writer - N/A"]
pub type CSS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TTMLM_SPEC, u8, u8, 2, O>;
#[doc = "Field `TXEW` reader - Tx Enable Window 0x0-F Length of Tx enable window, 1-16 NTU cycles"]
pub type TXEW_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TXEW` writer - Tx Enable Window 0x0-F Length of Tx enable window, 1-16 NTU cycles"]
pub type TXEW_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TTMLM_SPEC, u8, u8, 4, O>;
#[doc = "Field `ENTT` reader - Expected Number of Tx Triggers 0x000-FFF Expected number of Tx Triggers in one Matrix Cycle"]
pub type ENTT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `ENTT` writer - Expected Number of Tx Triggers 0x000-FFF Expected number of Tx Triggers in one Matrix Cycle"]
...
impl R {
    ...
    #[doc = "Bits 8:11 - Tx Enable Window 0x0-F Length of Tx enable window, 1-16 NTU cycles"]
    #[inline(always)]
    pub fn txew(&self) -> TXEW_R {
        TXEW_R::new(((self.bits >> 8) & 0x0f) as u8)
    }
    #[doc = "Bits 16:27 - Expected Number of Tx Triggers 0x000-FFF Expected number of Tx Triggers in one Matrix Cycle"]
    #[inline(always)]
