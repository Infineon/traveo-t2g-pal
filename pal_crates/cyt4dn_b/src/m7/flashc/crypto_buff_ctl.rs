...
#[doc = "Field `PREF_EN` reader - Prefetch enable: 0: Disabled. 1: Enabled."]
pub type PREF_EN_R = crate::BitReader<bool>;
#[doc = "Field `PREF_EN` writer - Prefetch enable: 0: Disabled. 1: Enabled."]
pub type PREF_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRYPTO_BUFF_CTL_SPEC, bool, O>;
impl R {
    #[doc = "Bit 30 - Prefetch enable: 0: Disabled. 1: Enabled."]
    #[inline(always)]
