...
#[doc = "Field `FREEZE` reader - Freeze functionality: '0': HW reads from the TX FIFO and advances the FIFO read pointer. '1': HW repeats the previous TX FIFO sample. Freeze does NOT advance the FIFO read pointer. Note: This functionality is intended for debugging purposes. Note: This functionality can also be controlled by the 'tr_dbg_freeze' input signal."]
pub type FREEZE_R = crate::BitReader<bool>;
#[doc = "Field `FREEZE` writer - Freeze functionality: '0': HW reads from the TX FIFO and advances the FIFO read pointer. '1': HW repeats the previous TX FIFO sample. Freeze does NOT advance the FIFO read pointer. Note: This functionality is intended for debugging purposes. Note: This functionality can also be controlled by the 'tr_dbg_freeze' input signal."]
...
impl R {
    ...
    #[doc = "Bit 17 - Freeze functionality: '0': HW reads from the TX FIFO and advances the FIFO read pointer. '1': HW repeats the previous TX FIFO sample. Freeze does NOT advance the FIFO read pointer. Note: This functionality is intended for debugging purposes. Note: This functionality can also be controlled by the 'tr_dbg_freeze' input signal."]
    #[inline(always)]
