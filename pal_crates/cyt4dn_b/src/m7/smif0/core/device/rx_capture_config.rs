...
pub type SDR_SWAP_BYTES_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RX_CAPTURE_CONFIG_SPEC, bool, O>;
#[doc = "Field `DDR_PIPELINE_POS_DAT` reader - 0: Does not pipeline DDR receive data captured relative to the posedge of the receive clock 1: Does pipeline"]
pub type DDR_PIPELINE_POS_DAT_R = crate::BitReader<bool>;
#[doc = "Field `DDR_PIPELINE_POS_DAT` writer - 0: Does not pipeline DDR receive data captured relative to the posedge of the receive clock 1: Does pipeline"]
pub type DDR_PIPELINE_POS_DAT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RX_CAPTURE_CONFIG_SPEC, bool, O>;
#[doc = "Field `DDR_SWAP_BYTES` reader - 0: Does not swap DDR receive data captured relative to the negedge of the receive clock with the data captured relative to the posedge of the receive clock 1: Does swap"]
pub type DDR_SWAP_BYTES_R = crate::BitReader<bool>;
#[doc = "Field `DDR_SWAP_BYTES` writer - 0: Does not swap DDR receive data captured relative to the negedge of the receive clock with the data captured relative to the posedge of the receive clock 1: Does swap"]
...
impl R {
    ...
    #[doc = "Bit 24 - 0: Does not pipeline DDR receive data captured relative to the posedge of the receive clock 1: Does pipeline"]
    #[inline(always)]
    pub fn ddr_pipeline_pos_dat(&self) -> DDR_PIPELINE_POS_DAT_R {
        DDR_PIPELINE_POS_DAT_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - 0: Does not swap DDR receive data captured relative to the negedge of the receive clock with the data captured relative to the posedge of the receive clock 1: Does swap"]
    #[inline(always)]
