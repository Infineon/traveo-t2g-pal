...
#[doc = "Field `LVDS_TX_EN` reader - Enable the serializers and TX drivers for all lanes of FPDLink"]
pub type LVDS_TX_EN_R = crate::BitReader<LVDS_TX_EN_A>;
#[doc = "Enable the serializers and TX drivers for all lanes of FPDLink\n\nValue on reset: 0"]
...
#[doc = "Field `LVDS_TX_EN` writer - Enable the serializers and TX drivers for all lanes of FPDLink"]
...
impl R {
    #[doc = "Bit 0 - Enable the serializers and TX drivers for all lanes of FPDLink"]
    #[inline(always)]
