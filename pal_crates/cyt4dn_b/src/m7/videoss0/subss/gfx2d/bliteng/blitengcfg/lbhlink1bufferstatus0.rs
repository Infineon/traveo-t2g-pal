...
#[doc = "Field `LBHLINK1MAXFREELINES` reader - The maximal number of free lines in the line buffer that can be scheduled by CmdSeq."]
pub type LBHLINK1MAXFREELINES_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LBHLINK1MAXFREELINES` writer - The maximal number of free lines in the line buffer that can be scheduled by CmdSeq."]
pub type LBHLINK1MAXFREELINES_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LBHLINK1BUFFERSTATUS0_SPEC, u16, u16, 15, O>;
#[doc = "Field `LBHLINK1MAXFREELINESSTORE` reader - The maximal number of free lines in the line buffer that can be written by the store."]
pub type LBHLINK1MAXFREELINESSTORE_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LBHLINK1MAXFREELINESSTORE` writer - The maximal number of free lines in the line buffer that can be written by the store."]
pub type LBHLINK1MAXFREELINESSTORE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LBHLINK1BUFFERSTATUS0_SPEC, u16, u16, 15, O>;
impl R {
    ...
    #[inline(always)]
    pub fn lbhlink1maxfreelinesstore(&self) -> LBHLINK1MAXFREELINESSTORE_R {
        LBHLINK1MAXFREELINESSTORE_R::new(((self.bits >> 16) & 0x7fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:14 - The maximal number of free lines in the line buffer that can be scheduled by CmdSeq."]
    ...
    #[inline(always)]
    #[must_use]
    pub fn lbhlink1maxfreelinesstore(&mut self) -> LBHLINK1MAXFREELINESSTORE_W<16> {
        LBHLINK1MAXFREELINESSTORE_W::new(self)
    }
