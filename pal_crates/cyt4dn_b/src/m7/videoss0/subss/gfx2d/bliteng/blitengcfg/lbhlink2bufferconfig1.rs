...
#[doc = "Field `LBHLINK2FRAMELINES` reader - Height of the frame (programmed with -1). This setting must be identical to the display fetch and BlitEng value."]
pub type LBHLINK2FRAMELINES_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LBHLINK2FRAMELINES` writer - Height of the frame (programmed with -1). This setting must be identical to the display fetch and BlitEng value."]
