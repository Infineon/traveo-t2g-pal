...
#[doc = "Field `PERSPDELTAYW` reader - Increment of homogenous W coordinate for vertical step (Y) in destination frame. (format is floating-point 1e8m23)"]
pub type PERSPDELTAYW_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PERSPDELTAYW` writer - Increment of homogenous W coordinate for vertical step (Y) in destination frame. (format is floating-point 1e8m23)"]
pub type PERSPDELTAYW_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PERSPDELTAYW_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Increment of homogenous W coordinate for vertical step (Y) in destination frame. (format is floating-point 1e8m23)"]
    #[inline(always)]
