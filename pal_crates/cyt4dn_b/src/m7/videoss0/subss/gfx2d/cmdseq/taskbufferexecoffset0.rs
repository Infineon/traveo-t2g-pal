...
#[doc = "Field `EXECOFFSETTB0` reader - Task buffer 0 execution offset in multiple of 32-bit words. Offset of the scheduling instruction that is to be executed next. Instruction at address = AddressTB0 has offset zero."]
pub type EXECOFFSETTB0_R = crate::FieldReader<u16, u16>;
impl R {
    #[doc = "Bits 0:15 - Task buffer 0 execution offset in multiple of 32-bit words. Offset of the scheduling instruction that is to be executed next. Instruction at address = AddressTB0 has offset zero."]
    #[inline(always)]
