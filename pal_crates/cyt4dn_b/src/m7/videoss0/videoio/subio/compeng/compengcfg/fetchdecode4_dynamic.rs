...
#[doc = "Field `FETCHDECODE4_SRC_SEL` reader - Selection of the source for the src input of the fetchdecode4 module Value gpscaler4 is only supported for IPVersion 1 IPPhase 2 or higher."]
pub type FETCHDECODE4_SRC_SEL_R = crate::FieldReader<u8, FETCHDECODE4_SRC_SEL_A>;
#[doc = "Selection of the source for the src input of the fetchdecode4 module Value gpscaler4 is only supported for IPVersion 1 IPPhase 2 or higher.\n\nValue on reset: 0"]
...
#[doc = "Field `FETCHDECODE4_SRC_SEL` writer - Selection of the source for the src input of the fetchdecode4 module Value gpscaler4 is only supported for IPVersion 1 IPPhase 2 or higher."]
...
impl R {
    #[doc = "Bits 0:4 - Selection of the source for the src input of the fetchdecode4 module Value gpscaler4 is only supported for IPVersion 1 IPPhase 2 or higher."]
    #[inline(always)]
