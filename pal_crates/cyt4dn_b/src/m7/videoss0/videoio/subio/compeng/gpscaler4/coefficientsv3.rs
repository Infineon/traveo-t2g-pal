...
#[doc = "Field `COEFF_V14` reader - Vertical coefficient 14. The bottommost coefficient regardless of the filter height. In contrast to the coeff_v0 this coefficient has to be always programmed. (format is signed integer)"]
pub type COEFF_V14_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COEFF_V14` writer - Vertical coefficient 14. The bottommost coefficient regardless of the filter height. In contrast to the coeff_v0 this coefficient has to be always programmed. (format is signed integer)"]
pub type COEFF_V14_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, COEFFICIENTSV3_SPEC, u8, u8, 8, O>;
#[doc = "Field `COEFF_V13` reader - Vertical coefficient 13. (format is signed integer)"]
pub type COEFF_V13_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COEFF_V13` writer - Vertical coefficient 13. (format is signed integer)"]
pub type COEFF_V13_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, COEFFICIENTSV3_SPEC, u8, u8, 8, O>;
#[doc = "Field `COEFF_V12` reader - Vertical coefficient 12. (format is signed integer)"]
pub type COEFF_V12_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COEFF_V12` writer - Vertical coefficient 12. (format is signed integer)"]
pub type COEFF_V12_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, COEFFICIENTSV3_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 8:15 - Vertical coefficient 14. The bottommost coefficient regardless of the filter height. In contrast to the coeff_v0 this coefficient has to be always programmed. (format is signed integer)"]
    #[inline(always)]
    pub fn coeff_v14(&self) -> COEFF_V14_R {
        COEFF_V14_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - Vertical coefficient 13. (format is signed integer)"]
    #[inline(always)]
    pub fn coeff_v13(&self) -> COEFF_V13_R {
        COEFF_V13_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - Vertical coefficient 12. (format is signed integer)"]
    #[inline(always)]
