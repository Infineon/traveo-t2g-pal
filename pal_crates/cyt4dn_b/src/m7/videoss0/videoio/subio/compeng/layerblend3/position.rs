...
#[doc = "Field `XPOS` reader - horizontal position, first pixel is at 0, format s15 (twos complement) (format is signed integer)"]
pub type XPOS_R = crate::FieldReader<u16, u16>;
#[doc = "Field `XPOS` writer - horizontal position, first pixel is at 0, format s15 (twos complement) (format is signed integer)"]
pub type XPOS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, POSITION_SPEC, u16, u16, 16, O>;
#[doc = "Field `YPOS` reader - vertical position, first pixel is at 0, format s15 (twos complement) (format is signed integer)"]
pub type YPOS_R = crate::FieldReader<u16, u16>;
#[doc = "Field `YPOS` writer - vertical position, first pixel is at 0, format s15 (twos complement) (format is signed integer)"]
pub type YPOS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, POSITION_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - horizontal position, first pixel is at 0, format s15 (twos complement) (format is signed integer)"]
    #[inline(always)]
    pub fn xpos(&self) -> XPOS_R {
        XPOS_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - vertical position, first pixel is at 0, format s15 (twos complement) (format is signed integer)"]
    #[inline(always)]
