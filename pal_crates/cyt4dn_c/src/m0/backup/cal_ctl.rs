...
pub enum CAL_COMP_PER_MIN_A {
    ...
    _2 = 0,
    #[doc = "1: Calibration of 64 each is performed four times per minute for 4*CALIB_VAL per hour for TVIICE4M , 2*CALIB_VAL per hour for all others"]
    _4 = 1,
    #[doc = "2: Calibration of 64 each is performed eight times per minute for 8*CALIB_VAL per hour for TVIICE4M , 2*CALIB_VAL per hour for all others"]
    _8 = 2,
    #[doc = "3: Calibration of 64 each is performed sixteen times per minute for 16*CALIB_VAL per hour for TVIICE4M , 2*CALIB_VAL per hour for all others"]
    _16 = 3,
}
...
impl<'a, const O: u8> CAL_COMP_PER_MIN_W<'a, O> {
    ...
    #[doc = "Calibration of 64 each is performed four times per minute for 4*CALIB_VAL per hour for TVIICE4M , 2*CALIB_VAL per hour for all others"]
    #[inline(always)]
    pub fn _4(self) -> &'a mut W {
        self.variant(CAL_COMP_PER_MIN_A::_4)
    }
    #[doc = "Calibration of 64 each is performed eight times per minute for 8*CALIB_VAL per hour for TVIICE4M , 2*CALIB_VAL per hour for all others"]
    #[inline(always)]
    pub fn _8(self) -> &'a mut W {
        self.variant(CAL_COMP_PER_MIN_A::_8)
    }
    #[doc = "Calibration of 64 each is performed sixteen times per minute for 16*CALIB_VAL per hour for TVIICE4M , 2*CALIB_VAL per hour for all others"]
    #[inline(always)]
