...
#[doc = "Field `CM7_ENABLE` reader - Enables the CM7_0 and CM7_1 AP interface: '0': Disabled. '1': Enabled."]
pub type CM7_ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `CM7_ENABLE` writer - Enables the CM7_0 and CM7_1 AP interface: '0': Disabled. '1': Enabled."]
...
#[doc = "Field `CM7_DISABLE` reader - Disables the CM7_0 and CM7_1 AP interface: '0': Enabled. '1': Disabled. Typically, this field is set by the Cypress boot code with information from eFUSE. The access port is only enabled when CM7_DISABLE is '0' and CM7_ENABLE is '1'."]
pub type CM7_DISABLE_R = crate::BitReader<bool>;
#[doc = "Field `CM7_DISABLE` writer - Disables the CM7_0 and CM7_1 AP interface: '0': Enabled. '1': Disabled. Typically, this field is set by the Cypress boot code with information from eFUSE. The access port is only enabled when CM7_DISABLE is '0' and CM7_ENABLE is '1'."]
...
impl R {
    ...
    #[doc = "Bit 1 - Enables the CM7_0 and CM7_1 AP interface: '0': Disabled. '1': Enabled."]
    #[inline(always)]
    ...
    #[doc = "Bit 17 - Disables the CM7_0 and CM7_1 AP interface: '0': Enabled. '1': Disabled. Typically, this field is set by the Cypress boot code with information from eFUSE. The access port is only enabled when CM7_DISABLE is '0' and CM7_ENABLE is '1'."]
    #[inline(always)]
