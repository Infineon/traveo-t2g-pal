#[doc = "Register `RX_DATA_MMIO_FIFO_RD4` reader"]
pub struct R(crate::R<RX_DATA_MMIO_FIFO_RD4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RX_DATA_MMIO_FIFO_RD4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RX_DATA_MMIO_FIFO_RD4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RX_DATA_MMIO_FIFO_RD4_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Receiver data MMIO FIFO read\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rx_data_mmio_fifo_rd4](index.html) module"]
pub struct RX_DATA_MMIO_FIFO_RD4_SPEC;
impl crate::RegisterSpec for RX_DATA_MMIO_FIFO_RD4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rx_data_mmio_fifo_rd4::R](R) reader structure"]
impl crate::Readable for RX_DATA_MMIO_FIFO_RD4_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RX_DATA_MMIO_FIFO_RD4 to value 0"]
impl crate::Resettable for RX_DATA_MMIO_FIFO_RD4_SPEC {
