...
#[doc = "Field `INPUT` reader - Plaintext PT\\[95:64\\]
= CRYPTO_INPUT2.INPUT\\[31:0\\]."]
pub type INPUT_R = crate::FieldReader<u32, u32>;
#[doc = "Field `INPUT` writer - Plaintext PT\\[95:64\\]
= CRYPTO_INPUT2.INPUT\\[31:0\\]."]
pub type INPUT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CRYPTO_INPUT2_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Plaintext PT\\[95:64\\]
= CRYPTO_INPUT2.INPUT\\[31:0\\]."]
    #[inline(always)]
