...
#[repr(C)]
pub struct VRPU {
    #[doc = "0x00 - VRAM Protection for read master with ID=0"]
    pub rd0_ctl: RD0_CTL,
    #[doc = "0x04 - VRAM Protection for read master with ID=1"]
    pub rd1_ctl: RD1_CTL,
    #[doc = "0x08 - VRAM Protection for read master with ID=2"]
    pub rd2_ctl: RD2_CTL,
    #[doc = "0x0c - VRAM Protection for read master with ID=3"]
    pub rd3_ctl: RD3_CTL,
    #[doc = "0x10 - VRAM Protection for read master with ID=4"]
    pub rd4_ctl: RD4_CTL,
    #[doc = "0x14 - VRAM Protection for read master with ID=5"]
    pub rd5_ctl: RD5_CTL,
    #[doc = "0x18 - VRAM Protection for read master with ID=6"]
    pub rd6_ctl: RD6_CTL,
    #[doc = "0x1c - VRAM Protection for read master with ID=7"]
    pub rd7_ctl: RD7_CTL,
    #[doc = "0x20 - VRAM Protection for read master with ID=8"]
    pub rd8_ctl: RD8_CTL,
    #[doc = "0x24 - VRAM Protection for read master with ID=9"]
    pub rd9_ctl: RD9_CTL,
    #[doc = "0x28 - VRAM Protection for read master with ID=10"]
    pub rd10_ctl: RD10_CTL,
    #[doc = "0x2c - VRAM Protection for read master with ID=11"]
    pub rd11_ctl: RD11_CTL,
    #[doc = "0x30 - VRAM Protection for read master with ID=12"]
    pub rd12_ctl: RD12_CTL,
    #[doc = "0x34 - VRAM Protection for read master with ID=13"]
    pub rd13_ctl: RD13_CTL,
    #[doc = "0x38 - VRAM Protection for read master with ID=14"]
    pub rd14_ctl: RD14_CTL,
    #[doc = "0x3c - VRAM Protection for read master with ID=15"]
    pub rd15_ctl: RD15_CTL,
    #[doc = "0x40 - VRAM Protection for write master with ID=0"]
    pub wr0_ctl: WR0_CTL,
    #[doc = "0x44 - VRAM Protection for write master with ID=1"]
    pub wr1_ctl: WR1_CTL,
    #[doc = "0x48 - VRAM Protection for write master with ID=2"]
    pub wr2_ctl: WR2_CTL,
    #[doc = "0x4c - VRAM Protection for write master with ID=3"]
    pub wr3_ctl: WR3_CTL,
    #[doc = "0x50 - VRAM Protection for write master with ID=4"]
    pub wr4_ctl: WR4_CTL,
    #[doc = "0x54 - VRAM Protection for write master with ID=5"]
    pub wr5_ctl: WR5_CTL,
    #[doc = "0x58 - VRAM Protection for write master with ID=6"]
    pub wr6_ctl: WR6_CTL,
    #[doc = "0x5c - VRAM Protection for write master with ID=7"]
    pub wr7_ctl: WR7_CTL,
    #[doc = "0x60 - VRAM Protection for write master with ID=8"]
    pub wr8_ctl: WR8_CTL,
    #[doc = "0x64 - VRAM Protection for write master with ID=9"]
    pub wr9_ctl: WR9_CTL,
    #[doc = "0x68 - VRAM Protection for write master with ID=10"]
    pub wr10_ctl: WR10_CTL,
    #[doc = "0x6c - VRAM Protection for write master with ID=11"]
    pub wr11_ctl: WR11_CTL,
    #[doc = "0x70 - VRAM Protection for write master with ID=12"]
    pub wr12_ctl: WR12_CTL,
    #[doc = "0x74 - VRAM Protection for write master with ID=13"]
    pub wr13_ctl: WR13_CTL,
    #[doc = "0x78 - VRAM Protection for write master with ID=14"]
    pub wr14_ctl: WR14_CTL,
    #[doc = "0x7c - VRAM Protection for write master with ID=15"]
    pub wr15_ctl: WR15_CTL,
    _reserved32: [u8; 0x1f80],
    #[doc = "0x2000..0x2028 - VRPU structures."]
    pub vrpu_struct0: VRPU_STRUCT,
    _reserved33: [u8; 0x18],
    #[doc = "0x2040..0x2068 - VRPU structures."]
    pub vrpu_struct1: VRPU_STRUCT,
    _reserved34: [u8; 0x18],
    #[doc = "0x2080..0x20a8 - VRPU structures."]
    pub vrpu_struct2: VRPU_STRUCT,
    _reserved35: [u8; 0x18],
    #[doc = "0x20c0..0x20e8 - VRPU structures."]
    pub vrpu_struct3: VRPU_STRUCT,
    _reserved36: [u8; 0x18],
    #[doc = "0x2100..0x2128 - VRPU structures."]
    pub vrpu_struct4: VRPU_STRUCT,
    _reserved37: [u8; 0x18],
    #[doc = "0x2140..0x2168 - VRPU structures."]
    pub vrpu_struct5: VRPU_STRUCT,
    _reserved38: [u8; 0x18],
    #[doc = "0x2180..0x21a8 - VRPU structures."]
    pub vrpu_struct6: VRPU_STRUCT,
    _reserved39: [u8; 0x18],
    #[doc = "0x21c0..0x21e8 - VRPU structures."]
    pub vrpu_struct7: VRPU_STRUCT,
}
#[doc = "RD0_CTL (rw) register accessor: an alias for `Reg<RD0_CTL_SPEC>`"]
pub type RD0_CTL = crate::Reg<rd0_ctl::RD0_CTL_SPEC>;
#[doc = "VRAM Protection for read master with ID=0"]
pub mod rd0_ctl;
...
pub mod rd15_ctl;
#[doc = "WR0_CTL (rw) register accessor: an alias for `Reg<WR0_CTL_SPEC>`"]
