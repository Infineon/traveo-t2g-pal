...
#[doc = "Field `BLUE_RANGE_SELECT` reader - Mode which sets the reduction of component widths. (format is unsigned integer)"]
pub type BLUE_RANGE_SELECT_R = crate::FieldReader<u8, BLUE_RANGE_SELECT_A>;
#[doc = "Mode which sets the reduction of component widths. (format is unsigned integer)\n\nValue on reset: 2"]
...
#[doc = "Field `BLUE_RANGE_SELECT` writer - Mode which sets the reduction of component widths. (format is unsigned integer)"]
...
#[doc = "Field `GREEN_RANGE_SELECT` reader - Mode which sets the reduction of component widths. (format is unsigned integer)"]
...
#[doc = "Field `GREEN_RANGE_SELECT` writer - Mode which sets the reduction of component widths. (format is unsigned integer)"]
...
#[doc = "Field `RED_RANGE_SELECT` reader - Mode which sets the reduction of component widths. (format is unsigned integer)"]
...
#[doc = "Field `RED_RANGE_SELECT` writer - Mode which sets the reduction of component widths. (format is unsigned integer)"]
...
#[doc = "Field `OFFSET_SELECT` reader - Selects the method how the dither offset is calculated. (format is unsigned integer)"]
pub type OFFSET_SELECT_R = crate::BitReader<OFFSET_SELECT_A>;
#[doc = "Selects the method how the dither offset is calculated. (format is unsigned integer)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `OFFSET_SELECT` writer - Selects the method how the dither offset is calculated. (format is unsigned integer)"]
...
#[doc = "Field `ALGO_SELECT` reader - The number of output colors that can virtually be displayed by dithering is slightly lower than the number of physical input colors. This field selects how the mapping is done. (format is unsigned integer)"]
pub type ALGO_SELECT_R = crate::FieldReader<u8, ALGO_SELECT_A>;
#[doc = "The number of output colors that can virtually be displayed by dithering is slightly lower than the number of physical input colors. This field selects how the mapping is done. (format is unsigned integer)\n\nValue on reset: 3"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
...
#[doc = "Field `ALGO_SELECT` writer - The number of output colors that can virtually be displayed by dithering is slightly lower than the number of physical input colors. This field selects how the mapping is done. (format is unsigned integer)"]
...
#[doc = "Field `ALPHA_MODE` reader - Enables/disables that dithering can be switched by alpha bit. (format is unsigned integer)"]
pub type ALPHA_MODE_R = crate::FieldReader<u8, ALPHA_MODE_A>;
#[doc = "Enables/disables that dithering can be switched by alpha bit. (format is unsigned integer)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
...
#[doc = "Field `ALPHA_MODE` writer - Enables/disables that dithering can be switched by alpha bit. (format is unsigned integer)"]
...
impl R {
    #[doc = "Bits 0:2 - Mode which sets the reduction of component widths. (format is unsigned integer)"]
    #[inline(always)]
    pub fn blue_range_select(&self) -> BLUE_RANGE_SELECT_R {
        BLUE_RANGE_SELECT_R::new((self.bits & 7) as u8)
    }
    #[doc = "Bits 4:6 - Mode which sets the reduction of component widths. (format is unsigned integer)"]
    #[inline(always)]
    pub fn green_range_select(&self) -> GREEN_RANGE_SELECT_R {
        GREEN_RANGE_SELECT_R::new(((self.bits >> 4) & 7) as u8)
    }
    #[doc = "Bits 8:10 - Mode which sets the reduction of component widths. (format is unsigned integer)"]
    #[inline(always)]
    pub fn red_range_select(&self) -> RED_RANGE_SELECT_R {
        RED_RANGE_SELECT_R::new(((self.bits >> 8) & 7) as u8)
    }
    #[doc = "Bit 16 - Selects the method how the dither offset is calculated. (format is unsigned integer)"]
    #[inline(always)]
    pub fn offset_select(&self) -> OFFSET_SELECT_R {
        OFFSET_SELECT_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bits 20:21 - The number of output colors that can virtually be displayed by dithering is slightly lower than the number of physical input colors. This field selects how the mapping is done. (format is unsigned integer)"]
    #[inline(always)]
    pub fn algo_select(&self) -> ALGO_SELECT_R {
        ALGO_SELECT_R::new(((self.bits >> 20) & 3) as u8)
    }
    #[doc = "Bits 24:25 - Enables/disables that dithering can be switched by alpha bit. (format is unsigned integer)"]
    #[inline(always)]
