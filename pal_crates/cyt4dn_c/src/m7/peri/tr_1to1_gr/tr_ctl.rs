...
pub type TR_SEL_R = crate::BitReader<bool>;
#[doc = "Field `TR_SEL` writer - Specifies input trigger: '0'': constant signal level '0'. '1': input trigger."]
pub type TR_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, TR_CTL_SPEC, bool, O>;
...
pub type TR_INV_W<'a, const O: u8> = crate::BitWriter<'a, u32, TR_CTL_SPEC, bool, O>;
...
pub type TR_EDGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TR_CTL_SPEC, bool, O>;
...
pub type DBG_FREEZE_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, TR_CTL_SPEC, bool, O>;
impl R {
