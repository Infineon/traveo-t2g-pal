...
#[doc = "Field `DLP_FAIL` reader - Data Learning Failed (no DLP match found on at least one of the input data lines when CTL2.RX_CAPTURE_MODE=1)."]
pub type DLP_FAIL_R = crate::BitReader<bool>;
#[doc = "Field `DLP_FAIL` writer - Data Learning Failed (no DLP match found on at least one of the input data lines when CTL2.RX_CAPTURE_MODE=1)."]
pub type DLP_FAIL_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SPEC, bool, O>;
#[doc = "Field `DLP_WARNING` reader - Data Learning Warning (for at least one input data line less then DLP.DLP_WARNING_LEVEL delay line taps resulted in a correct DLP capturing when CTL2.RX_CAPTURE_MODE=1). This interrupt will be suppressed, though, if DLP_FAIL also occurs during the same DLP evaluation cycle."]
pub type DLP_WARNING_R = crate::BitReader<bool>;
#[doc = "Field `DLP_WARNING` writer - Data Learning Warning (for at least one input data line less then DLP.DLP_WARNING_LEVEL delay line taps resulted in a correct DLP capturing when CTL2.RX_CAPTURE_MODE=1). This interrupt will be suppressed, though, if DLP_FAIL also occurs during the same DLP evaluation cycle."]
pub type DLP_WARNING_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SPEC, bool, O>;
#[doc = "Field `DLL_LOCK` reader - DLL lock (edge detected)"]
pub type DLL_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `DLL_LOCK` writer - DLL lock (edge detected)"]
pub type DLL_LOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SPEC, bool, O>;
#[doc = "Field `DLL_UNLOCK` reader - DLL unlock (edge detected)"]
pub type DLL_UNLOCK_R = crate::BitReader<bool>;
#[doc = "Field `DLL_UNLOCK` writer - DLL unlock (edge detected)"]
pub type DLL_UNLOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 8 - Data Learning Failed (no DLP match found on at least one of the input data lines when CTL2.RX_CAPTURE_MODE=1)."]
    #[inline(always)]
    pub fn dlp_fail(&self) -> DLP_FAIL_R {
        DLP_FAIL_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 12 - Data Learning Warning (for at least one input data line less then DLP.DLP_WARNING_LEVEL delay line taps resulted in a correct DLP capturing when CTL2.RX_CAPTURE_MODE=1). This interrupt will be suppressed, though, if DLP_FAIL also occurs during the same DLP evaluation cycle."]
    #[inline(always)]
    pub fn dlp_warning(&self) -> DLP_WARNING_R {
        DLP_WARNING_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - DLL lock (edge detected)"]
    #[inline(always)]
    pub fn dll_lock(&self) -> DLL_LOCK_R {
        DLL_LOCK_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - DLL unlock (edge detected)"]
    #[inline(always)]
