...
#[doc = "Field `WDT_LOCK` reader - Prohibits writing control and configuration registers related to this WDT when not equal 0 (as specified in the other register descriptions). Requires at least two different writes to unlock. Note that this field is 2 bits to force multiple writes only. This register also locks the clk_ilo0 settings."]
pub type WDT_LOCK_R = crate::FieldReader<u8, WDT_LOCK_A>;
#[doc = "Prohibits writing control and configuration registers related to this WDT when not equal 0 (as specified in the other register descriptions). Requires at least two different writes to unlock. Note that this field is 2 bits to force multiple writes only. This register also locks the clk_ilo0 settings.\n\nValue on reset: 3"]
...
#[doc = "Field `WDT_LOCK` writer - Prohibits writing control and configuration registers related to this WDT when not equal 0 (as specified in the other register descriptions). Requires at least two different writes to unlock. Note that this field is 2 bits to force multiple writes only. This register also locks the clk_ilo0 settings."]
pub type WDT_LOCK_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, LOCK_SPEC, u8, WDT_LOCK_A, 2, O>;
...
impl R {
    ...
    pub fn wdt_lock(&self) -> WDT_LOCK_R {
        WDT_LOCK_R::new((self.bits & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - Prohibits writing control and configuration registers related to this WDT when not equal 0 (as specified in the other register descriptions). Requires at least two different writes to unlock. Note that this field is 2 bits to force multiple writes only. This register also locks the clk_ilo0 settings."]
    #[inline(always)]
    #[must_use]
    pub fn wdt_lock(&mut self) -> WDT_LOCK_W<0> {
        WDT_LOCK_W::new(self)
    }
...
#[doc = "`reset()` method sets LOCK to value 0x03"]
