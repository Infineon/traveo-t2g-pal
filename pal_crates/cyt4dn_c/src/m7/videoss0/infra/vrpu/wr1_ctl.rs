...
on entry of the handler), it is NOT possible for SW to enter those protection contexts (SW modifies GFX_MPU_WRx WR_CTL.PC\\[3:0\\])."]
...
#[doc = "`reset()` method sets WR1_CTL to value 0x0302"]
