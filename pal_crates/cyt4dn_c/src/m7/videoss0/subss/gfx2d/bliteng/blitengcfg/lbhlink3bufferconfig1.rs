...
#[doc = "Field `LBHLINK3FRAMELINES` reader - Height of the frame in number of lines. The height must be identical to the related Blit and Composition Engine setups."]
pub type LBHLINK3FRAMELINES_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LBHLINK3FRAMELINES` writer - Height of the frame in number of lines. The height must be identical to the related Blit and Composition Engine setups."]
