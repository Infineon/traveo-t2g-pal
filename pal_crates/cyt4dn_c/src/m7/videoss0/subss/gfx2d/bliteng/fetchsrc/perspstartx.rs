...
#[doc = "Field `PERSPSTARTX` reader - Start value for homogenous X coordinate relative to origin. (format is floating-point 1e8m23)"]
pub type PERSPSTARTX_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PERSPSTARTX` writer - Start value for homogenous X coordinate relative to origin. (format is floating-point 1e8m23)"]
pub type PERSPSTARTX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PERSPSTARTX_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Start value for homogenous X coordinate relative to origin. (format is floating-point 1e8m23)"]
    #[inline(always)]
