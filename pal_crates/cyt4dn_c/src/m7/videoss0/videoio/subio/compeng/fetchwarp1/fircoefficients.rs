...
#[doc = "Field `FIR0COEFFICIENT` reader - First coefficient. (format is signed fix-point 3.5)"]
pub type FIR0COEFFICIENT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FIR0COEFFICIENT` writer - First coefficient. (format is signed fix-point 3.5)"]
pub type FIR0COEFFICIENT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FIRCOEFFICIENTS_SPEC, u8, u8, 8, O>;
#[doc = "Field `FIR1COEFFICIENT` reader - Second coefficient. (format is signed fix-point 3.5)"]
pub type FIR1COEFFICIENT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FIR1COEFFICIENT` writer - Second coefficient. (format is signed fix-point 3.5)"]
pub type FIR1COEFFICIENT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FIRCOEFFICIENTS_SPEC, u8, u8, 8, O>;
#[doc = "Field `FIR2COEFFICIENT` reader - Third coefficient. (format is signed fix-point 3.5)"]
pub type FIR2COEFFICIENT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FIR2COEFFICIENT` writer - Third coefficient. (format is signed fix-point 3.5)"]
pub type FIR2COEFFICIENT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FIRCOEFFICIENTS_SPEC, u8, u8, 8, O>;
#[doc = "Field `FIR3COEFFICIENT` reader - Fourth coefficient. (format is signed fix-point 3.5)"]
pub type FIR3COEFFICIENT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FIR3COEFFICIENT` writer - Fourth coefficient. (format is signed fix-point 3.5)"]
pub type FIR3COEFFICIENT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FIRCOEFFICIENTS_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - First coefficient. (format is signed fix-point 3.5)"]
    #[inline(always)]
    pub fn fir0coefficient(&self) -> FIR0COEFFICIENT_R {
        FIR0COEFFICIENT_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - Second coefficient. (format is signed fix-point 3.5)"]
    #[inline(always)]
    pub fn fir1coefficient(&self) -> FIR1COEFFICIENT_R {
        FIR1COEFFICIENT_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - Third coefficient. (format is signed fix-point 3.5)"]
    #[inline(always)]
    pub fn fir2coefficient(&self) -> FIR2COEFFICIENT_R {
        FIR2COEFFICIENT_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - Fourth coefficient. (format is signed fix-point 3.5)"]
    #[inline(always)]
