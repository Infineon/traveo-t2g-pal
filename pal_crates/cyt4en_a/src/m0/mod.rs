#![doc = "Peripheral access API for TVIIC2D6MDDR microcontrollers (generated using svd2rust v0.28.0 (54a7f49 2023-02-14))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
unsafe impl Send for LPDDR40 {}
impl LPDDR40 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const lpddr40::RegisterBlock = 0x404a_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const lpddr40::RegisterBlock {
        Self::PTR
    }
}
impl Deref for LPDDR40 {
    type Target = lpddr40::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
}
impl core::fmt::Debug for LPDDR40 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("LPDDR40").finish()
    }
}
#[doc = "LPDDR4"]
pub mod lpddr40;
