...
#[doc = "Field `GCE_STE` reader - General Crypto Error interrupt status enable Values: - 0x1 (INT_STS_ENABLE): CQIS.GCE is set when its interrupt condition is active - 0x0 (INT_STS_DISABLE): CQIS.GCE is disabled Bit only available if DWC_MSHC_CRYPTO_SUPPORT = 1"]
pub type GCE_STE_R = crate::BitReader<bool>;
#[doc = "Field `GCE_STE` writer - General Crypto Error interrupt status enable Values: - 0x1 (INT_STS_ENABLE): CQIS.GCE is set when its interrupt condition is active - 0x0 (INT_STS_DISABLE): CQIS.GCE is disabled Bit only available if DWC_MSHC_CRYPTO_SUPPORT = 1"]
pub type GCE_STE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CQISE_SPEC, bool, O>;
#[doc = "Field `ICCE_STE` reader - Invalid Crypto Configuration Error interrupt status enable Values: - 0x1 (INT_STS_ENABLE): CQIS.ICCE is set when its interrupt condition is active - 0x0 (INT_STS_DISABLE): CQIS.ICCE is disabled Bit only available if DWC_MSHC_CRYPTO_SUPPORT = 1"]
pub type ICCE_STE_R = crate::BitReader<bool>;
#[doc = "Field `ICCE_STE` writer - Invalid Crypto Configuration Error interrupt status enable Values: - 0x1 (INT_STS_ENABLE): CQIS.ICCE is set when its interrupt condition is active - 0x0 (INT_STS_DISABLE): CQIS.ICCE is disabled Bit only available if DWC_MSHC_CRYPTO_SUPPORT = 1"]
pub type ICCE_STE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CQISE_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 4 - General Crypto Error interrupt status enable Values: - 0x1 (INT_STS_ENABLE): CQIS.GCE is set when its interrupt condition is active - 0x0 (INT_STS_DISABLE): CQIS.GCE is disabled Bit only available if DWC_MSHC_CRYPTO_SUPPORT = 1"]
    #[inline(always)]
    pub fn gce_ste(&self) -> GCE_STE_R {
        GCE_STE_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Invalid Crypto Configuration Error interrupt status enable Values: - 0x1 (INT_STS_ENABLE): CQIS.ICCE is set when its interrupt condition is active - 0x0 (INT_STS_DISABLE): CQIS.ICCE is disabled Bit only available if DWC_MSHC_CRYPTO_SUPPORT = 1"]
    #[inline(always)]
