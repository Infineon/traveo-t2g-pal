...
pub type LED_CTRL_W<'a, const O: u8> = crate::BitWriter<'a, u8, HOST_CTRL1_R_SPEC, bool, O>;
...
pub type DAT_XFER_WIDTH_W<'a, const O: u8> = crate::BitWriter<'a, u8, HOST_CTRL1_R_SPEC, bool, O>;
...
pub type HIGH_SPEED_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, HOST_CTRL1_R_SPEC, bool, O>;
#[doc = "Field `DMA_SEL` reader - N/A"]
pub type DMA_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DMA_SEL` writer - N/A"]
pub type DMA_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u8, HOST_CTRL1_R_SPEC, u8, u8, 2, O>;
...
pub type EXT_DAT_XFER_W<'a, const O: u8> = crate::BitWriter<'a, u8, HOST_CTRL1_R_SPEC, bool, O>;
...
pub type CARD_DETECT_TEST_LVL_R = crate::BitReader<bool>;
...
pub type CARD_DETECT_TEST_LVL_W<'a, const O: u8> =
    crate::BitWriter<'a, u8, HOST_CTRL1_R_SPEC, bool, O>;
...
pub type CARD_DETECT_SIG_SEL_R = crate::BitReader<bool>;
#[doc = "Field `CARD_DETECT_SIG_SEL` writer - Card Detect Signal Selection This bit selects a source for card detection. When the source for the card detection is switched, the interrupt must be disabled during the switching period. Values: - 0x1 (CARD_DT_TEST_LEVEL): Card Detect Test Level is selected (for test purpose) - 0x0 (card_detect_n): card_detect_n signal is selected (for normal use)"]
pub type CARD_DETECT_SIG_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u8, HOST_CTRL1_R_SPEC, bool, O>;
impl R {
