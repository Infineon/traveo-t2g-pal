...
pub type WIDTH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RD_DATA_CTL_SPEC, u8, u8, 2, O>;
...
pub type DDR_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RD_DATA_CTL_SPEC, bool, O>;
impl R {
