...
pub type CODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WR_CMD_CTL_SPEC, u8, u8, 8, O>;
...
pub type CODEH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WR_CMD_CTL_SPEC, u8, u8, 8, O>;
#[doc = "Field `WIDTH` reader - Width of transfer."]
pub type WIDTH_R = crate::FieldReader<u8, u8>;
#[doc = "Field `WIDTH` writer - Width of transfer."]
pub type WIDTH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WR_CMD_CTL_SPEC, u8, u8, 2, O>;
...
pub type DDR_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, WR_CMD_CTL_SPEC, bool, O>;
...
pub type PRESENT2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WR_CMD_CTL_SPEC, u8, u8, 2, O>;
impl R {
