...
pub type RESET_OCD_DPSLP_LINREG_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RES_CAUSE_SPEC, bool, O>;
#[doc = "Field `RESET_OCD_REGHC` reader - Overcurrent detection from REGHC (if present). REGHC_STATUS_TIMEOUT expiration will set this bit without issuing reset, which will be observed by a subsequent WDT reset. If REGHC is not present, hardware will never set this bit. This is a high-voltage cause bit that blocks recording of other high-voltage cause bits, except RESET_PORVDDD. Hardware clears this bit during POR."]
pub type RESET_OCD_REGHC_R = crate::BitReader<bool>;
#[doc = "Field `RESET_OCD_REGHC` writer - Overcurrent detection from REGHC (if present). REGHC_STATUS_TIMEOUT expiration will set this bit without issuing reset, which will be observed by a subsequent WDT reset. If REGHC is not present, hardware will never set this bit. This is a high-voltage cause bit that blocks recording of other high-voltage cause bits, except RESET_PORVDDD. Hardware clears this bit during POR."]
pub type RESET_OCD_REGHC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RES_CAUSE_SPEC, bool, O>;
#[doc = "Field `RESET_PMIC` reader - PMIC status triggered a reset. PMIC_STATUS_TIMEOUT expiration will set this bit without issuing reset, which will be observed by a subsequent WDT reset. If PMIC control is not present, hardware will never set this bit. This is a high-voltage cause bit that blocks recording of other high-voltage cause bits, except RESET_PORVDDD. Hardware clears this bit during POR."]
pub type RESET_PMIC_R = crate::BitReader<bool>;
#[doc = "Field `RESET_PMIC` writer - PMIC status triggered a reset. PMIC_STATUS_TIMEOUT expiration will set this bit without issuing reset, which will be observed by a subsequent WDT reset. If PMIC control is not present, hardware will never set this bit. This is a high-voltage cause bit that blocks recording of other high-voltage cause bits, except RESET_PORVDDD. Hardware clears this bit during POR."]
...
impl R {
    ...
    #[doc = "Bit 25 - Overcurrent detection from REGHC (if present). REGHC_STATUS_TIMEOUT expiration will set this bit without issuing reset, which will be observed by a subsequent WDT reset. If REGHC is not present, hardware will never set this bit. This is a high-voltage cause bit that blocks recording of other high-voltage cause bits, except RESET_PORVDDD. Hardware clears this bit during POR."]
    #[inline(always)]
    pub fn reset_ocd_reghc(&self) -> RESET_OCD_REGHC_R {
        RESET_OCD_REGHC_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - PMIC status triggered a reset. PMIC_STATUS_TIMEOUT expiration will set this bit without issuing reset, which will be observed by a subsequent WDT reset. If PMIC control is not present, hardware will never set this bit. This is a high-voltage cause bit that blocks recording of other high-voltage cause bits, except RESET_PORVDDD. Hardware clears this bit during POR."]
    #[inline(always)]
