...
#[doc = "Field `HVLVD2` reader - Set interrupt for low voltage detector HVLVD2"]
pub type HVLVD2_R = crate::BitReader<bool>;
#[doc = "Field `HVLVD2` writer - Set interrupt for low voltage detector HVLVD2"]
pub type HVLVD2_W<'a, const O: u8> = crate::BitWriter<'a, u32, SRSS_INTR_SET_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 2 - Set interrupt for low voltage detector HVLVD2"]
    #[inline(always)]
