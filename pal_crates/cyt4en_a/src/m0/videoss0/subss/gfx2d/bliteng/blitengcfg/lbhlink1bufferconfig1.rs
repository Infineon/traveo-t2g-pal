...
#[doc = "Field `LBHLINK1FRAMELINES` reader - Height of the frame in number of lines. The height must be identical to the related Blit and Composition Engine setups."]
pub type LBHLINK1FRAMELINES_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LBHLINK1FRAMELINES` writer - Height of the frame in number of lines. The height must be identical to the related Blit and Composition Engine setups."]
