...
#[doc = "Field `SHDEN` reader - Obsolete. Field value has no effect, shadow registers are always enabled."]
pub type SHDEN_R = crate::BitReader<bool>;
#[doc = "Field `SHDEN` writer - Obsolete. Field value has no effect, shadow registers are always enabled."]
...
pub type DESTINATIONPIXELMEASUREMENTEN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, STATICCONTROL_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - Obsolete. Field value has no effect, shadow registers are always enabled."]
    #[inline(always)]
