...
#[doc = "Field `SUBVERSION` reader - Dither Unit subversion. (format is unsigned integer)"]
pub type SUBVERSION_R = crate::FieldReader<u8, u8>;
#[doc = "Field `VERSION` reader - Dither Unit version. (format is unsigned integer)"]
pub type VERSION_R = crate::FieldReader<u8, u8>;
impl R {
    #[doc = "Bits 0:7 - Dither Unit subversion. (format is unsigned integer)"]
    #[inline(always)]
    pub fn subversion(&self) -> SUBVERSION_R {
        SUBVERSION_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:15 - Dither Unit version. (format is unsigned integer)"]
    #[inline(always)]
...
#[doc = "`reset()` method sets RELEASE to value 0x01"]
