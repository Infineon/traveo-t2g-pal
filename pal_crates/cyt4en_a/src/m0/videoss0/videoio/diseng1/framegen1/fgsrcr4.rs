...
#[doc = "Field `TARGETSKEW` reader - Horizontal target skew value for horizontal and vertical skew regulation (signed value). (format is signed integer)"]
pub type TARGETSKEW_R = crate::FieldReader<u32, u32>;
#[doc = "Field `TARGETSKEW` writer - Horizontal target skew value for horizontal and vertical skew regulation (signed value). (format is signed integer)"]
pub type TARGETSKEW_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FGSRCR4_SPEC, u32, u32, 29, O>;
impl R {
    #[doc = "Bits 0:28 - Horizontal target skew value for horizontal and vertical skew regulation (signed value). (format is signed integer)"]
    #[inline(always)]
