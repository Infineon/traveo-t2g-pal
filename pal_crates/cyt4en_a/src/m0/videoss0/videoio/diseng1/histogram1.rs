...
#[doc = "RSLTCOMP0BINCNT (r) register accessor: an alias for `Reg<RSLTCOMP0BINCNT_SPEC>`"]
...
#[doc = "RSLTCOMP1BINCNT (r) register accessor: an alias for `Reg<RSLTCOMP1BINCNT_SPEC>`"]
...
#[doc = "RSLTCOMP2BINCNT (r) register accessor: an alias for `Reg<RSLTCOMP2BINCNT_SPEC>`"]
