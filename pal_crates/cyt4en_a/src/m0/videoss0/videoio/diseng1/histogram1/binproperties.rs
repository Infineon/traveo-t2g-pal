...
#[doc = "Field `BINNUM_WIDTH` reader - 2**binnum_width is the number of bins in a histogram. (format is unsigned integer)"]
pub type BINNUM_WIDTH_R = crate::FieldReader<u8, BINNUM_WIDTH_A>;
#[doc = "2**binnum_width is the number of bins in a histogram. (format is unsigned integer)\n\nValue on reset: 3"]
...
#[doc = "Field `BINNUM_WIDTH` writer - 2**binnum_width is the number of bins in a histogram. (format is unsigned integer)"]
...
#[doc = "Field `CNT_MODE` reader - Counter mode, which controls the way the bin values are accumulated. (format is unsigned integer)"]
pub type CNT_MODE_R = crate::BitReader<CNT_MODE_A>;
#[doc = "Counter mode, which controls the way the bin values are accumulated. (format is unsigned integer)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CNT_MODE_A {
...
#[doc = "Field `CNT_MODE` writer - Counter mode, which controls the way the bin values are accumulated. (format is unsigned integer)"]
...
#[doc = "Field `BINCNT_RD_MODE` reader - The field controls if the actual bin count or the sum of all bin counts up to actual bin count is provided in registers RsltComp0Bincnt, RsltComp1Bincnt and RsltComp2Bincnt. (format is unsigned integer)"]
pub type BINCNT_RD_MODE_R = crate::BitReader<BINCNT_RD_MODE_A>;
#[doc = "The field controls if the actual bin count or the sum of all bin counts up to actual bin count is provided in registers RsltComp0Bincnt, RsltComp1Bincnt and RsltComp2Bincnt. (format is unsigned integer)\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `BINCNT_RD_MODE` writer - The field controls if the actual bin count or the sum of all bin counts up to actual bin count is provided in registers RsltComp0Bincnt, RsltComp1Bincnt and RsltComp2Bincnt. (format is unsigned integer)"]
...
impl R {
    #[doc = "Bits 0:2 - 2**binnum_width is the number of bins in a histogram. (format is unsigned integer)"]
    #[inline(always)]
    pub fn binnum_width(&self) -> BINNUM_WIDTH_R {
        BINNUM_WIDTH_R::new((self.bits & 7) as u8)
    }
    #[doc = "Bit 4 - Counter mode, which controls the way the bin values are accumulated. (format is unsigned integer)"]
    #[inline(always)]
    pub fn cnt_mode(&self) -> CNT_MODE_R {
        CNT_MODE_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 8 - The field controls if the actual bin count or the sum of all bin counts up to actual bin count is provided in registers RsltComp0Bincnt, RsltComp1Bincnt and RsltComp2Bincnt. (format is unsigned integer)"]
    #[inline(always)]
