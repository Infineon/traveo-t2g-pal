...
#[doc = "Field `PALETTEENABLE7` reader - See PaletteEnable0."]
pub type PALETTEENABLE7_R = crate::BitReader<bool>;
#[doc = "Field `PALETTEENABLE7` writer - See PaletteEnable0."]
pub type PALETTEENABLE7_W<'a, const O: u8> =
...
pub type GAMMAREMOVEENABLE7_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LAYERPROPERTY7_SPEC, bool, O>;
#[doc = "Field `PALETTEOFFSET7` reader - see PaletteOffset0."]
pub type PALETTEOFFSET7_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PALETTEOFFSET7` writer - see PaletteOffset0."]
pub type PALETTEOFFSET7_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYERPROPERTY7_SPEC, u16, u16, 11, O>;
#[doc = "Field `PALETTEIDWIDTH7` reader - see PaletteIdWidth0."]
pub type PALETTEIDWIDTH7_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PALETTEIDWIDTH7` writer - see PaletteIdWidth0."]
pub type PALETTEIDWIDTH7_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYERPROPERTY7_SPEC, u8, u8, 3, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn paletteenable7(&self) -> PALETTEENABLE7_R {
        PALETTEENABLE7_R::new((self.bits & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn paletteoffset7(&self) -> PALETTEOFFSET7_R {
        PALETTEOFFSET7_R::new(((self.bits >> 16) & 0x07ff) as u16)
    }
    #[doc = "Bits 27:29 - see PaletteIdWidth0."]
    #[inline(always)]
    pub fn paletteidwidth7(&self) -> PALETTEIDWIDTH7_R {
        PALETTEIDWIDTH7_R::new(((self.bits >> 27) & 7) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn paletteenable7(&mut self) -> PALETTEENABLE7_W<0> {
        PALETTEENABLE7_W::new(self)
    }
    #[doc = "Bits 1:2 - See TileMode0."]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn paletteoffset7(&mut self) -> PALETTEOFFSET7_W<16> {
        PALETTEOFFSET7_W::new(self)
    }
    #[doc = "Bits 27:29 - see PaletteIdWidth0."]
    #[inline(always)]
    #[must_use]
    pub fn paletteidwidth7(&mut self) -> PALETTEIDWIDTH7_W<27> {
        PALETTEIDWIDTH7_W::new(self)
    }
    #[doc = "Bit 30 - See ClipWindowEnable0."]
    #[inline(always)]
    #[must_use]
...
#[doc = "`reset()` method sets LAYERPROPERTY7 to value 0x3800_0008"]
