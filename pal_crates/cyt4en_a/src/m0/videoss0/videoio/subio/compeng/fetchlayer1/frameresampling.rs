...
#[doc = "Field `STARTX` reader - X coordinate of first sample point relative to origin. (format is signed fix-point 4.2)"]
pub type STARTX_R = crate::FieldReader<u8, u8>;
#[doc = "Field `STARTX` writer - X coordinate of first sample point relative to origin. (format is signed fix-point 4.2)"]
pub type STARTX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FRAMERESAMPLING_SPEC, u8, u8, 6, O>;
#[doc = "Field `STARTY` reader - Y coordinate of first sample point relative to origin. (format is signed fix-point 4.2)"]
pub type STARTY_R = crate::FieldReader<u8, u8>;
#[doc = "Field `STARTY` writer - Y coordinate of first sample point relative to origin. (format is signed fix-point 4.2)"]
pub type STARTY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FRAMERESAMPLING_SPEC, u8, u8, 6, O>;
#[doc = "Field `DELTAX` reader - Increment of X coordinate for horizontal step in destination frame. (format is signed fix-point 4.2)"]
pub type DELTAX_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DELTAX` writer - Increment of X coordinate for horizontal step in destination frame. (format is signed fix-point 4.2)"]
pub type DELTAX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FRAMERESAMPLING_SPEC, u8, u8, 6, O>;
#[doc = "Field `DELTAY` reader - Increment of Y coordinate for vertical step in destination frame. (format is signed fix-point 4.2)"]
pub type DELTAY_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DELTAY` writer - Increment of Y coordinate for vertical step in destination frame. (format is signed fix-point 4.2)"]
...
impl R {
    #[doc = "Bits 0:5 - X coordinate of first sample point relative to origin. (format is signed fix-point 4.2)"]
    #[inline(always)]
    pub fn startx(&self) -> STARTX_R {
        STARTX_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 6:11 - Y coordinate of first sample point relative to origin. (format is signed fix-point 4.2)"]
    #[inline(always)]
    pub fn starty(&self) -> STARTY_R {
        STARTY_R::new(((self.bits >> 6) & 0x3f) as u8)
    }
    #[doc = "Bits 12:17 - Increment of X coordinate for horizontal step in destination frame. (format is signed fix-point 4.2)"]
    #[inline(always)]
    pub fn deltax(&self) -> DELTAX_R {
        DELTAX_R::new(((self.bits >> 12) & 0x3f) as u8)
    }
    #[doc = "Bits 18:23 - Increment of Y coordinate for vertical step in destination frame. (format is signed fix-point 4.2)"]
    #[inline(always)]
