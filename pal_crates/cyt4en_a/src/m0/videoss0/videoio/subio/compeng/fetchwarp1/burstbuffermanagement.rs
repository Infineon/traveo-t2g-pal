...
#[doc = "Field `CACHEENABLE` reader - If enabled, all AXI transactions are marked to be cacheable."]
pub type CACHEENABLE_R = crate::BitReader<bool>;
#[doc = "Field `CACHEENABLE` writer - If enabled, all AXI transactions are marked to be cacheable."]
pub type CACHEENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, BURSTBUFFERMANAGEMENT_SPEC, bool, O>;
#[doc = "Field `ENCACHEINVALIDATION` reader - If enabled (value 1) and if a GfxCache instance is connected to this unit, the cache is invalidated before start of generating a new frame. This is required for operations with the CacheEnable field activiated."]
pub type ENCACHEINVALIDATION_R = crate::BitReader<bool>;
#[doc = "Field `ENCACHEINVALIDATION` writer - If enabled (value 1) and if a GfxCache instance is connected to this unit, the cache is invalidated before start of generating a new frame. This is required for operations with the CacheEnable field activiated."]
pub type ENCACHEINVALIDATION_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, BURSTBUFFERMANAGEMENT_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 29 - If enabled, all AXI transactions are marked to be cacheable."]
    #[inline(always)]
    pub fn cacheenable(&self) -> CACHEENABLE_R {
        CACHEENABLE_R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - If enabled (value 1) and if a GfxCache instance is connected to this unit, the cache is invalidated before start of generating a new frame. This is required for operations with the CacheEnable field activiated."]
    #[inline(always)]
    pub fn encacheinvalidation(&self) -> ENCACHEINVALIDATION_R {
        ENCACHEINVALIDATION_R::new(((self.bits >> 30) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cacheenable(&mut self) -> CACHEENABLE_W<29> {
        CACHEENABLE_W::new(self)
    }
    #[doc = "Bit 30 - If enabled (value 1) and if a GfxCache instance is connected to this unit, the cache is invalidated before start of generating a new frame. This is required for operations with the CacheEnable field activiated."]
    #[inline(always)]
    #[must_use]
    pub fn encacheinvalidation(&mut self) -> ENCACHEINVALIDATION_W<30> {
        ENCACHEINVALIDATION_W::new(self)
    }
    #[doc = "Bit 31 - Fetch buffer cache control."]
    #[inline(always)]
    #[must_use]
