...
#[doc = "Field `LAYERXOFFSET4` reader - Horizontal offset (X). (format is signed integer)"]
pub type LAYERXOFFSET4_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LAYERXOFFSET4` writer - Horizontal offset (X). (format is signed integer)"]
pub type LAYERXOFFSET4_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYEROFFSET4_SPEC, u16, u16, 15, O>;
#[doc = "Field `LAYERYOFFSET4` reader - Vertical offset (Y). (format is signed integer)"]
pub type LAYERYOFFSET4_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LAYERYOFFSET4` writer - Vertical offset (Y). (format is signed integer)"]
