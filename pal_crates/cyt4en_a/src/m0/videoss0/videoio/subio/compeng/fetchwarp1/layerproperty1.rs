...
pub type ALPHACONSTENABLE1_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LAYERPROPERTY1_SPEC, bool, O>;
#[doc = "Field `ALPHAMASKENABLE1` reader - See AlphaMaskSelect0."]
pub type ALPHAMASKENABLE1_R = crate::BitReader<bool>;
#[doc = "Field `ALPHAMASKENABLE1` writer - See AlphaMaskSelect0."]
pub type ALPHAMASKENABLE1_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LAYERPROPERTY1_SPEC, bool, O>;
...
pub type RGBALPHACONSTENABLE1_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LAYERPROPERTY1_SPEC, bool, O>;
#[doc = "Field `RGBALPHAMASKENABLE1` reader - See RGBAlphaMaskSelect0."]
pub type RGBALPHAMASKENABLE1_R = crate::BitReader<bool>;
#[doc = "Field `RGBALPHAMASKENABLE1` writer - See RGBAlphaMaskSelect0."]
pub type RGBALPHAMASKENABLE1_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, LAYERPROPERTY1_SPEC, bool, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn alphamaskenable1(&self) -> ALPHAMASKENABLE1_R {
        ALPHAMASKENABLE1_R::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn rgbalphamaskenable1(&self) -> RGBALPHAMASKENABLE1_R {
        RGBALPHAMASKENABLE1_R::new(((self.bits >> 9) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alphamaskenable1(&mut self) -> ALPHAMASKENABLE1_W<5> {
        ALPHAMASKENABLE1_W::new(self)
    }
    #[doc = "Bit 6 - See AlphaTransSelect0."]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn rgbalphamaskenable1(&mut self) -> RGBALPHAMASKENABLE1_W<9> {
        RGBALPHAMASKENABLE1_W::new(self)
    }
    #[doc = "Bit 10 - See RGBAlphaTransSelect0."]
    #[inline(always)]
    #[must_use]
...
#[doc = "`reset()` method sets LAYERPROPERTY1 to value 0x08"]
