...
#[doc = "Field `A11` reader - Value for red input. (format is signed fix-point 3.10)"]
pub type A11_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A11` writer - Value for red input. (format is signed fix-point 3.10)"]
pub type A11_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RED0_SPEC, u16, u16, 13, O>;
#[doc = "Field `A12` reader - Value for green input. (format is signed fix-point 3.10)"]
pub type A12_R = crate::FieldReader<u16, u16>;
#[doc = "Field `A12` writer - Value for green input. (format is signed fix-point 3.10)"]
