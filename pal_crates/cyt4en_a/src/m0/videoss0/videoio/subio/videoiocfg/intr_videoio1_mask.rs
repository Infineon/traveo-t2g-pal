...
pub type INTR_VIDEOIO1_MASK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, INTR_VIDEOIO1_MASK_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Interrupt mask vector. When a bit is set in this field, the related INTR_VIDEOIO1 status activates the interrupt signal."]
    #[inline(always)]
    pub fn intr_videoio1_mask(&self) -> INTR_VIDEOIO1_MASK_R {
        INTR_VIDEOIO1_MASK_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Interrupt mask vector. When a bit is set in this field, the related INTR_VIDEOIO1 status activates the interrupt signal."]
