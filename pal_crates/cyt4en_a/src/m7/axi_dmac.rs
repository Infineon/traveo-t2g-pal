...
pub struct RegisterBlock {
    ...
    pub ch3: CH,
    _reserved8: [u8; 0x70],
    #[doc = "0x1400..0x1490 - AXI DMA controller channel"]
    pub ch4: CH,
    _reserved9: [u8; 0x70],
    #[doc = "0x1500..0x1590 - AXI DMA controller channel"]
    pub ch5: CH,
    _reserved10: [u8; 0x70],
    #[doc = "0x1600..0x1690 - AXI DMA controller channel"]
    pub ch6: CH,
    _reserved11: [u8; 0x70],
    #[doc = "0x1700..0x1790 - AXI DMA controller channel"]
    pub ch7: CH,
}
