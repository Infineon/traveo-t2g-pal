...
#[doc = "Field `DATA_BYTE` reader - Available EFUSE bits for customer usage.They can be programmed in NORMAL protection state via CMx/DAP and in SECURE protection state via CMx."]
pub type DATA_BYTE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DATA_BYTE` writer - Available EFUSE bits for customer usage.They can be programmed in NORMAL protection state via CMx/DAP and in SECURE protection state via CMx."]
pub type DATA_BYTE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CUSTOMER_DATA_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Available EFUSE bits for customer usage.They can be programmed in NORMAL protection state via CMx/DAP and in SECURE protection state via CMx."]
    #[inline(always)]
