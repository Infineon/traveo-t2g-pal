#[doc = "Register `TRANSMIT_Q_PTR` reader"]
pub struct R(crate::R<TRANSMIT_Q_PTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TRANSMIT_Q_PTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TRANSMIT_Q_PTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TRANSMIT_Q_PTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TRANSMIT_Q_PTR` writer"]
pub struct W(crate::W<TRANSMIT_Q_PTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TRANSMIT_Q_PTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TRANSMIT_Q_PTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TRANSMIT_Q_PTR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DMA_TX_DIS_Q_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRANSMIT_Q_PTR_SPEC, bool, O>;
#[doc = "Field `DMA_TX_Q_PTR` reader - Transmit buffer queue base address - written with the address of the start of the transmit queue."]
pub type DMA_TX_Q_PTR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DMA_TX_Q_PTR` writer - Transmit buffer queue base address - written with the address of the start of the transmit queue."]
pub type DMA_TX_Q_PTR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TRANSMIT_Q_PTR_SPEC, u32, u32, 30, O>;
impl R {
    ...
    #[doc = "Bits 2:31 - Transmit buffer queue base address - written with the address of the start of the transmit queue."]
    #[inline(always)]
