#[doc = "Register `DLLCTLDQ_SL1` reader"]
pub struct R(crate::R<DLLCTLDQ_SL1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DLLCTLDQ_SL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DLLCTLDQ_SL1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DLLCTLDQ_SL1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DLLCTLDQ_SL1` writer"]
pub struct W(crate::W<DLLCTLDQ_SL1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DLLCTLDQ_SL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DLLCTLDQ_SL1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DLLCTLDQ_SL1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type LIMIT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DLLCTLDQ_SL1_SPEC, u8, u8, 5, O>;
...
pub type EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DLLCTLDQ_SL1_SPEC, bool, O>;
...
pub type UPD_W<'a, const O: u8> = crate::BitWriter<'a, u32, DLLCTLDQ_SL1_SPEC, bool, O>;
...
pub type BYP_W<'a, const O: u8> = crate::BitWriter<'a, u32, DLLCTLDQ_SL1_SPEC, bool, O>;
#[doc = "Field `BYPC` reader - DLL bypass code."]
pub type BYPC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `BYPC` writer - DLL bypass code."]
pub type BYPC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DLLCTLDQ_SL1_SPEC, u8, u8, 8, O>;
impl R {
...
#[doc = "DLL Control Register for PHY Data Module\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dllctldq_sl1](index.html) module"]
pub struct DLLCTLDQ_SL1_SPEC;
impl crate::RegisterSpec for DLLCTLDQ_SL1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dllctldq_sl1::R](R) reader structure"]
impl crate::Readable for DLLCTLDQ_SL1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dllctldq_sl1::W](W) writer structure"]
impl crate::Writable for DLLCTLDQ_SL1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DLLCTLDQ_SL1 to value 0"]
impl crate::Resettable for DLLCTLDQ_SL1_SPEC {
