...
#[doc = "Field `GCE_SGE` reader - General Crypto Error interrupt signal enable Values: - 0x1 (INT_SIG_ENABLE): CQIS.GCE interrupt signal generation is active - 0x0 (INT_SIG_DISABLE): CQIS.GCE interrupt signal generation is disabled Bit only available if DWC_MSHC_CRYPTO_SUPPORT = 1"]
pub type GCE_SGE_R = crate::BitReader<bool>;
#[doc = "Field `GCE_SGE` writer - General Crypto Error interrupt signal enable Values: - 0x1 (INT_SIG_ENABLE): CQIS.GCE interrupt signal generation is active - 0x0 (INT_SIG_DISABLE): CQIS.GCE interrupt signal generation is disabled Bit only available if DWC_MSHC_CRYPTO_SUPPORT = 1"]
pub type GCE_SGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CQISGE_SPEC, bool, O>;
#[doc = "Field `ICCE_SGE` reader - Invalid Crypto Configuration Error interrupt signal enable Values: - 0x1 (INT_SIG_ENABLE): CQIS.ICCE interrupt signal generation is active - 0x0 (INT_SIG_DISABLE): CQIS.ICCE interrupt signal generation is disabled Bit only available if DWC_MSHC_CRYPTO_SUPPORT = 1"]
pub type ICCE_SGE_R = crate::BitReader<bool>;
#[doc = "Field `ICCE_SGE` writer - Invalid Crypto Configuration Error interrupt signal enable Values: - 0x1 (INT_SIG_ENABLE): CQIS.ICCE interrupt signal generation is active - 0x0 (INT_SIG_DISABLE): CQIS.ICCE interrupt signal generation is disabled Bit only available if DWC_MSHC_CRYPTO_SUPPORT = 1"]
pub type ICCE_SGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CQISGE_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 4 - General Crypto Error interrupt signal enable Values: - 0x1 (INT_SIG_ENABLE): CQIS.GCE interrupt signal generation is active - 0x0 (INT_SIG_DISABLE): CQIS.GCE interrupt signal generation is disabled Bit only available if DWC_MSHC_CRYPTO_SUPPORT = 1"]
    #[inline(always)]
    pub fn gce_sge(&self) -> GCE_SGE_R {
        GCE_SGE_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Invalid Crypto Configuration Error interrupt signal enable Values: - 0x1 (INT_SIG_ENABLE): CQIS.ICCE interrupt signal generation is active - 0x0 (INT_SIG_DISABLE): CQIS.ICCE interrupt signal generation is disabled Bit only available if DWC_MSHC_CRYPTO_SUPPORT = 1"]
    #[inline(always)]
