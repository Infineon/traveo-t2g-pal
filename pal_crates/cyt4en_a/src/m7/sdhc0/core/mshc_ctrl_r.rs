...
pub type CMD_CONFLICT_CHECK_R = crate::BitReader<bool>;
...
pub type CMD_CONFLICT_CHECK_W<'a, const O: u8> =
    crate::BitWriter<'a, u8, MSHC_CTRL_R_SPEC, bool, O>;
...
pub type SW_CG_DIS_R = crate::BitReader<bool>;
...
pub type SW_CG_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u8, MSHC_CTRL_R_SPEC, bool, O>;
impl R {
