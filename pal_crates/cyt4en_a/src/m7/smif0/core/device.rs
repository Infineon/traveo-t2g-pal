...
pub struct DEVICE {
    ...
    _reserved4: [u8; 0x04],
    #[doc = "0x28 - RX capture configuration"]
    pub rx_capture_config: RX_CAPTURE_CONFIG,
    _reserved5: [u8; 0x04],
    #[doc = "0x30 - Read status"]
    ...
    #[doc = "0x54 - Read Bus CRC control"]
    pub rd_crc_ctl: RD_CRC_CTL,
    #[doc = "0x58 - Read boundary control"]
    pub rd_bound_ctl: RD_BOUND_CTL,
    _reserved13: [u8; 0x04],
    ...
    #[doc = "0x74 - Write Bus CRC control"]
    pub wr_crc_ctl: WR_CRC_CTL,
}
...
#[doc = "Address control"]
pub mod addr_ctl;
#[doc = "RX_CAPTURE_CONFIG (rw) register accessor: an alias for `Reg<RX_CAPTURE_CONFIG_SPEC>`"]
pub type RX_CAPTURE_CONFIG = crate::Reg<rx_capture_config::RX_CAPTURE_CONFIG_SPEC>;
#[doc = "RX capture configuration"]
pub mod rx_capture_config;
#[doc = "RD_STATUS (r) register accessor: an alias for `Reg<RD_STATUS_SPEC>`"]
...
pub mod rd_data_ctl;
#[doc = "RD_CRC_CTL (rw) register accessor: an alias for `Reg<RD_CRC_CTL_SPEC>`"]
pub type RD_CRC_CTL = crate::Reg<rd_crc_ctl::RD_CRC_CTL_SPEC>;
#[doc = "Read Bus CRC control"]
pub mod rd_crc_ctl;
#[doc = "RD_BOUND_CTL (rw) register accessor: an alias for `Reg<RD_BOUND_CTL_SPEC>`"]
pub type RD_BOUND_CTL = crate::Reg<rd_bound_ctl::RD_BOUND_CTL_SPEC>;
#[doc = "Read boundary control"]
pub mod rd_bound_ctl;
...
pub mod wr_data_ctl;
#[doc = "WR_CRC_CTL (rw) register accessor: an alias for `Reg<WR_CRC_CTL_SPEC>`"]
pub type WR_CRC_CTL = crate::Reg<wr_crc_ctl::WR_CRC_CTL_SPEC>;
