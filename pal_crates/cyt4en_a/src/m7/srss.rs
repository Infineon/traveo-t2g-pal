...
pub struct RegisterBlock {
    ...
    #[doc = "0x1400..0x14fc - Clock Supervisor (CSV) registers for Root clocks"]
    pub csv_hf: CSV_HF,
    _reserved35: [u8; 0x04],
    ...
    pub clk_dpll400m: CLK_DPLL400M,
    _reserved60: [u8; 0x1600],
