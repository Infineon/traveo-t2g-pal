...
#[doc = "Field `HVLVD1_OUT` reader - HVLVD1 output. 0: below voltage threshold 1: above voltage threshold"]
pub type HVLVD1_OUT_R = crate::BitReader<bool>;
impl R {
    #[doc = "Bit 0 - HVLVD1 output. 0: below voltage threshold 1: above voltage threshold"]
    #[inline(always)]
    pub fn hvlvd1_out(&self) -> HVLVD1_OUT_R {
        HVLVD1_OUT_R::new((self.bits & 1) != 0)
    }
}
