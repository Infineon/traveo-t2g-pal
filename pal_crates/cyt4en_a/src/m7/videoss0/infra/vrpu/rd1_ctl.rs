...
#[doc = "Field `PRIO` reader - Device wide bus arbitration priority setting ('0': highest priority, '3': lowest priority). Masters with the same priority setting form a 'priority group'. Within a 'priority group', roundrobin arbitration is performed."]
pub type PRIO_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PRIO` writer - Device wide bus arbitration priority setting ('0': highest priority, '3': lowest priority). Masters with the same priority setting form a 'priority group'. Within a 'priority group', roundrobin arbitration is performed."]
...
#[doc = "Field `PC_MASK_15_TO_1` reader - Protection context mask for protection contexts '7' downto '1' (note: field name prefix '15_TO_1' is inconsistent due to backward compatibility). Bit PC_MASK_15_TO_1\\[i\\]
...
#[doc = "Field `PC_MASK_15_TO_1` writer - Protection context mask for protection contexts '7' downto '1' (note: field name prefix '15_TO_1' is inconsistent due to backward compatibility). Bit PC_MASK_15_TO_1\\[i\\]
indicates if the GFX_MPU_RDx RD_CTL.PC\\[3:0\\]
protection context field can be set to the value 'i+1': - PC_MASK_15_TO_1\\[i\\]
is '0': GFX_MPU_RDx RD_CTL.PC\\[3:0\\]
can NOT be set to 'i+1'; and PC\\[3:0\\]
...
pub type PC_MASK_15_TO_1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RD1_CTL_SPEC, u8, u8, 7, O>;
impl R {
    ...
    #[doc = "Bits 17:23 - Protection context mask for protection contexts '7' downto '1' (note: field name prefix '15_TO_1' is inconsistent due to backward compatibility). Bit PC_MASK_15_TO_1\\[i\\]
indicates if the GFX_MPU_RDx RD_CTL.PC\\[3:0\\]
protection context field can be set to the value 'i+1': - PC_MASK_15_TO_1\\[i\\]
is '0': GFX_MPU_RDx RD_CTL.PC\\[3:0\\]
can NOT be set to 'i+1'; and PC\\[3:0\\]
