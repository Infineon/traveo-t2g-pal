...
#[doc = "Field `PERSPSTARTW` reader - Start value for homogenous W coordinate relative to origin. (format is floating-point 1e8m23)"]
pub type PERSPSTARTW_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PERSPSTARTW` writer - Start value for homogenous W coordinate relative to origin. (format is floating-point 1e8m23)"]
pub type PERSPSTARTW_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PERSPSTARTW_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Start value for homogenous W coordinate relative to origin. (format is floating-point 1e8m23)"]
    #[inline(always)]
