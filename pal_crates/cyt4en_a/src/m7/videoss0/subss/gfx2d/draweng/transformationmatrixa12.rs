...
#[doc = "Field `A12` reader - Matrix coefficient A12. (format is signed fix-point 16.16)"]
pub type A12_R = crate::FieldReader<u32, u32>;
#[doc = "Field `A12` writer - Matrix coefficient A12. (format is signed fix-point 16.16)"]
pub type A12_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TRANSFORMATIONMATRIXA12_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Matrix coefficient A12. (format is signed fix-point 16.16)"]
    #[inline(always)]
