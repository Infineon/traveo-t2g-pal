...
#[doc = "Field `A21` reader - Matrix coefficient A21. (format is signed fix-point 16.16)"]
pub type A21_R = crate::FieldReader<u32, u32>;
#[doc = "Field `A21` writer - Matrix coefficient A21. (format is signed fix-point 16.16)"]
pub type A21_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TRANSFORMATIONMATRIXA21_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Matrix coefficient A21. (format is signed fix-point 16.16)"]
    #[inline(always)]
