...
#[doc = "Field `TRANSLATIONY` reader - Vertical translation (Y). Fractional part is used for processing. The integer part modifies the YOffset field of the LayerOffset register for subsequent Blit operation. (format is signed fix-point 16.6)"]
pub type TRANSLATIONY_R = crate::FieldReader<u32, u32>;
#[doc = "Field `TRANSLATIONY` writer - Vertical translation (Y). Fractional part is used for processing. The integer part modifies the YOffset field of the LayerOffset register for subsequent Blit operation. (format is signed fix-point 16.6)"]
pub type TRANSLATIONY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TRANSLATIONVECTORY_SPEC, u32, u32, 22, O>;
impl R {
    #[doc = "Bits 0:21 - Vertical translation (Y). Fractional part is used for processing. The integer part modifies the YOffset field of the LayerOffset register for subsequent Blit operation. (format is signed fix-point 16.6)"]
    #[inline(always)]
