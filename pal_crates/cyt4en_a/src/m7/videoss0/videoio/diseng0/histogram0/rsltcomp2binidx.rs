...
#[doc = "Field `COMP2_BINIDX_MAXCNT` reader - The index of the bin of the component 2 histogram, which contains the highest counter value, which were read until now for the ongoing readout. In the case of RGB pixels, component 2 means the blue value. In the case of YUV pixels, component 2 means the Cr value. (format is unsigned integer)"]
pub type COMP2_BINIDX_MAXCNT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COMP2_BINIDX_NXT` reader - The index of the bin, that will be next accessed by register RsltComp2Bincnt. In the case of RGB pixels, component 2 means the blue value. In the case of YUV pixels, component 2 means the Cr value. (format is unsigned integer)"]
pub type COMP2_BINIDX_NXT_R = crate::FieldReader<u8, u8>;
impl R {
    #[doc = "Bits 0:5 - The index of the bin of the component 2 histogram, which contains the highest counter value, which were read until now for the ongoing readout. In the case of RGB pixels, component 2 means the blue value. In the case of YUV pixels, component 2 means the Cr value. (format is unsigned integer)"]
    #[inline(always)]
    pub fn comp2_binidx_maxcnt(&self) -> COMP2_BINIDX_MAXCNT_R {
        COMP2_BINIDX_MAXCNT_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 16:21 - The index of the bin, that will be next accessed by register RsltComp2Bincnt. In the case of RGB pixels, component 2 means the blue value. In the case of YUV pixels, component 2 means the Cr value. (format is unsigned integer)"]
    #[inline(always)]
