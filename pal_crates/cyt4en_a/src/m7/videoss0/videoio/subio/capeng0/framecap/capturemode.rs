...
pub enum CAPTUREMODE_A {
    #[doc = "0: Capture of 32-bit parallel or MIPI_CSI2 pixel input data with dedicated frame synchronization signals"]
    ENHSVS_32BIT = 0,
...
impl CAPTUREMODE_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<CAPTUREMODE_A> {
        match self.bits {
            0 => Some(CAPTUREMODE_A::ENHSVS_32BIT),
            1 => Some(CAPTUREMODE_A::ITU656_10BIT),
            2 => Some(CAPTUREMODE_A::ITU656_8BIT),
            _ => None,
        }
    }
...
pub type CAPTUREMODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CAPTUREMODE_SPEC, u8, CAPTUREMODE_A, 2, O>;
impl<'a, const O: u8> CAPTUREMODE_W<'a, O> {
    #[doc = "Capture of 32-bit parallel or MIPI_CSI2 pixel input data with dedicated frame synchronization signals"]
    #[inline(always)]
