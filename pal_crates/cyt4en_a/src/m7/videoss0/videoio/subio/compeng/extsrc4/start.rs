...
#[doc = "Field `START` writer - Writing a one starts processing, use this only for debug purposes."]
pub type START_W<'a, const O: u8> = crate::BitWriter<'a, u32, START_SPEC, bool, O>;
impl W {
    #[doc = "Bit 0 - Writing a one starts processing, use this only for debug purposes."]
    #[inline(always)]
    #[must_use]
