...
#[doc = "Field `LAYERXOFFSET5` reader - Horizontal offset (X). (format is signed integer)"]
pub type LAYERXOFFSET5_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LAYERXOFFSET5` writer - Horizontal offset (X). (format is signed integer)"]
pub type LAYERXOFFSET5_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYEROFFSET5_SPEC, u16, u16, 15, O>;
#[doc = "Field `LAYERYOFFSET5` reader - Vertical offset (Y). (format is signed integer)"]
pub type LAYERYOFFSET5_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LAYERYOFFSET5` writer - Vertical offset (Y). (format is signed integer)"]
