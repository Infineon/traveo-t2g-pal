...
#[doc = "Field `LBHSHDEN` reader - Enables shadowing of LBH configuration signals."]
pub type LBHSHDEN_R = crate::BitReader<bool>;
#[doc = "Field `LBHSHDEN` writer - Enables shadowing of LBH configuration signals."]
pub type LBHSHDEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, STATICCONTROL_SPEC, bool, O>;
...
#[doc = "Field `SHDLDREQSTICKY` reader - Shadow load request flags for each layer (always load). See description of register TriggerEnable for further information."]
pub type SHDLDREQSTICKY_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SHDLDREQSTICKY` writer - Shadow load request flags for each layer (always load). See description of register TriggerEnable for further information."]
pub type SHDLDREQSTICKY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, STATICCONTROL_SPEC, u8, u8, 8, O>;
impl R {
    ...
    #[doc = "Bit 1 - Enables shadowing of LBH configuration signals."]
    #[inline(always)]
    pub fn lbhshden(&self) -> LBHSHDEN_R {
        LBHSHDEN_R::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    #[doc = "Bits 24:31 - Shadow load request flags for each layer (always load). See description of register TriggerEnable for further information."]
    #[inline(always)]
    pub fn shdldreqsticky(&self) -> SHDLDREQSTICKY_R {
        SHDLDREQSTICKY_R::new(((self.bits >> 24) & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - Enables shadowing of all RWS type registers (0=write_through, 1=shadowed)."]
    ...
    #[inline(always)]
    #[must_use]
    pub fn lbhshden(&mut self) -> LBHSHDEN_W<1> {
        LBHSHDEN_W::new(self)
    }
    #[doc = "Bits 16:23 - Enable flag for continuous shadow load of BaseAddress field for each layer (layer index = bit index). When set to 1 the active BaseAddress configuration is loaded from shadow at start of each frame. This update is then executed independently from other RWS type fields. ShdEn must be enabled for this mode. When the flag is enabled for layer 0, also the FieldId0 shadow is automatically loaded."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn shdldreqsticky(&mut self) -> SHDLDREQSTICKY_W<24> {
        SHDLDREQSTICKY_W::new(self)
    }
...
#[doc = "`reset()` method sets STATICCONTROL to value 0xff00_0002"]
impl crate::Resettable for STATICCONTROL_SPEC {
    const RESET_VALUE: Self::Ux = 0xff00_0002;
}
