...
#[doc = "Field `COEFF_H14` reader - Horizontal coefficient 14. The rightmost coefficient regardless of the filter width. In contrast to the coeff_h0 this coefficient has to be always programmed. (format is signed integer)"]
pub type COEFF_H14_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COEFF_H14` writer - Horizontal coefficient 14. The rightmost coefficient regardless of the filter width. In contrast to the coeff_h0 this coefficient has to be always programmed. (format is signed integer)"]
pub type COEFF_H14_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, COEFFICIENTSH3_SPEC, u8, u8, 8, O>;
#[doc = "Field `COEFF_H13` reader - Horizontal coefficient 13. (format is signed integer)"]
pub type COEFF_H13_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COEFF_H13` writer - Horizontal coefficient 13. (format is signed integer)"]
pub type COEFF_H13_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, COEFFICIENTSH3_SPEC, u8, u8, 8, O>;
#[doc = "Field `COEFF_H12` reader - Horizontal coefficient 12. (format is signed integer)"]
pub type COEFF_H12_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COEFF_H12` writer - Horizontal coefficient 12. (format is signed integer)"]
pub type COEFF_H12_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, COEFFICIENTSH3_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 8:15 - Horizontal coefficient 14. The rightmost coefficient regardless of the filter width. In contrast to the coeff_h0 this coefficient has to be always programmed. (format is signed integer)"]
    #[inline(always)]
    pub fn coeff_h14(&self) -> COEFF_H14_R {
        COEFF_H14_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - Horizontal coefficient 13. (format is signed integer)"]
    #[inline(always)]
    pub fn coeff_h13(&self) -> COEFF_H13_R {
        COEFF_H13_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - Horizontal coefficient 12. (format is signed integer)"]
    #[inline(always)]
