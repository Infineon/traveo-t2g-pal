...
pub type INTR_VIDEOIO1_SAFETY_SET_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, INTR_VIDEOIO1_SAFETY_SET_SPEC, u32, u32, 32, O>;
impl W {
    #[doc = "Bits 0:31 - Interrupt set vector. Writing a 1 to this fields sets status in INTR_VIDEOIO1_SAFETY."]
    #[inline(always)]
    #[must_use]
