#[doc = "Register `CM7_2_VECTOR_TABLE_BASE` reader"]
pub struct R(crate::R<CM7_2_VECTOR_TABLE_BASE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CM7_2_VECTOR_TABLE_BASE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CM7_2_VECTOR_TABLE_BASE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CM7_2_VECTOR_TABLE_BASE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CM7_2_VECTOR_TABLE_BASE` writer"]
pub struct W(crate::W<CM7_2_VECTOR_TABLE_BASE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CM7_2_VECTOR_TABLE_BASE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CM7_2_VECTOR_TABLE_BASE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CM7_2_VECTOR_TABLE_BASE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADDR25_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CM7_2_VECTOR_TABLE_BASE_SPEC, u32, u32, 25, O>;
impl R {
...
#[doc = "CM7 2 vector table base\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cm7_2_vector_table_base](index.html) module"]
pub struct CM7_2_VECTOR_TABLE_BASE_SPEC;
impl crate::RegisterSpec for CM7_2_VECTOR_TABLE_BASE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cm7_2_vector_table_base::R](R) reader structure"]
impl crate::Readable for CM7_2_VECTOR_TABLE_BASE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cm7_2_vector_table_base::W](W) writer structure"]
impl crate::Writable for CM7_2_VECTOR_TABLE_BASE_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CM7_2_VECTOR_TABLE_BASE to value 0x0100_0000"]
impl crate::Resettable for CM7_2_VECTOR_TABLE_BASE_SPEC {
