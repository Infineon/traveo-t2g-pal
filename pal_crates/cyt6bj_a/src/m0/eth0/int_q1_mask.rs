#[doc = "Register `INT_Q1_MASK` reader"]
pub struct R(crate::R<INT_Q1_MASK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INT_Q1_MASK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INT_Q1_MASK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INT_Q1_MASK_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Field `AMBA_ERROR_INTERRUPT_MASK` reader - A read of this register returns the value of the AMBA (AXI/AHB) error interrupt mask. 0: Interrupt is enabled. 1: Interrupt is disabled. A write to this register directly affects the state of the corresponding bit in the interrupt status register, causing an interrupt to be generated if a 1 is written."]
...
impl R {
    ...
    #[doc = "Bit 6 - A read of this register returns the value of the AMBA (AXI/AHB) error interrupt mask. 0: Interrupt is enabled. 1: Interrupt is disabled. A write to this register directly affects the state of the corresponding bit in the interrupt status register, causing an interrupt to be generated if a 1 is written."]
    #[inline(always)]
