#[doc = "Register `RDHS1` reader"]
pub struct R(crate::R<RDHS1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RDHS1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RDHS1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RDHS1_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Read Header Section 1\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rdhs1](index.html) module"]
pub struct RDHS1_SPEC;
impl crate::RegisterSpec for RDHS1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rdhs1::R](R) reader structure"]
impl crate::Readable for RDHS1_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RDHS1 to value 0"]
impl crate::Resettable for RDHS1_SPEC {
