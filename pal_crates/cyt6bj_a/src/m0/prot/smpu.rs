...
pub struct SMPU {
    ...
    _reserved32: [u8; 0x18],
    #[doc = "0x2400..0x2428 - SMPU structure"]
    pub smpu_struct16: SMPU_STRUCT,
    _reserved33: [u8; 0x18],
    #[doc = "0x2440..0x2468 - SMPU structure"]
    pub smpu_struct17: SMPU_STRUCT,
    _reserved34: [u8; 0x18],
    #[doc = "0x2480..0x24a8 - SMPU structure"]
    pub smpu_struct18: SMPU_STRUCT,
    _reserved35: [u8; 0x18],
    #[doc = "0x24c0..0x24e8 - SMPU structure"]
    pub smpu_struct19: SMPU_STRUCT,
    _reserved36: [u8; 0x18],
    #[doc = "0x2500..0x2528 - SMPU structure"]
    pub smpu_struct20: SMPU_STRUCT,
    _reserved37: [u8; 0x18],
    #[doc = "0x2540..0x2568 - SMPU structure"]
    pub smpu_struct21: SMPU_STRUCT,
    _reserved38: [u8; 0x18],
    #[doc = "0x2580..0x25a8 - SMPU structure"]
    pub smpu_struct22: SMPU_STRUCT,
    _reserved39: [u8; 0x18],
    #[doc = "0x25c0..0x25e8 - SMPU structure"]
    pub smpu_struct23: SMPU_STRUCT,
    _reserved40: [u8; 0x18],
    #[doc = "0x2600..0x2628 - SMPU structure"]
    pub smpu_struct24: SMPU_STRUCT,
    _reserved41: [u8; 0x18],
    #[doc = "0x2640..0x2668 - SMPU structure"]
    pub smpu_struct25: SMPU_STRUCT,
    _reserved42: [u8; 0x18],
    #[doc = "0x2680..0x26a8 - SMPU structure"]
    pub smpu_struct26: SMPU_STRUCT,
    _reserved43: [u8; 0x18],
    #[doc = "0x26c0..0x26e8 - SMPU structure"]
    pub smpu_struct27: SMPU_STRUCT,
    _reserved44: [u8; 0x18],
    #[doc = "0x2700..0x2728 - SMPU structure"]
    pub smpu_struct28: SMPU_STRUCT,
    _reserved45: [u8; 0x18],
    #[doc = "0x2740..0x2768 - SMPU structure"]
    pub smpu_struct29: SMPU_STRUCT,
    _reserved46: [u8; 0x18],
    #[doc = "0x2780..0x27a8 - SMPU structure"]
    pub smpu_struct30: SMPU_STRUCT,
    _reserved47: [u8; 0x18],
    #[doc = "0x27c0..0x27e8 - SMPU structure"]
    pub smpu_struct31: SMPU_STRUCT,
}
