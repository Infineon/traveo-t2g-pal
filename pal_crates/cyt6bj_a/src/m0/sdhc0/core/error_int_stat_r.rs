...
pub type CMD_TOUT_ERR_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, ERROR_INT_STAT_R_SPEC, bool, O>;
...
pub type CMD_CRC_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u16, ERROR_INT_STAT_R_SPEC, bool, O>;
...
pub type CMD_IDX_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u16, ERROR_INT_STAT_R_SPEC, bool, O>;
...
pub type DATA_TOUT_ERR_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, ERROR_INT_STAT_R_SPEC, bool, O>;
...
pub type DATA_CRC_ERR_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, ERROR_INT_STAT_R_SPEC, bool, O>;
...
pub type DATA_END_BIT_ERR_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, ERROR_INT_STAT_R_SPEC, bool, O>;
...
pub type CUR_LMT_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u16, ERROR_INT_STAT_R_SPEC, bool, O>;
...
pub type AUTO_CMD_ERR_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, ERROR_INT_STAT_R_SPEC, bool, O>;
...
pub type ADMA_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u16, ERROR_INT_STAT_R_SPEC, bool, O>;
#[doc = "Field `TUNING_ERR` reader - N/A"]
pub type TUNING_ERR_R = crate::BitReader<bool>;
#[doc = "Field `TUNING_ERR` writer - N/A"]
pub type TUNING_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u16, ERROR_INT_STAT_R_SPEC, bool, O>;
...
pub type RESP_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u16, ERROR_INT_STAT_R_SPEC, bool, O>;
...
pub type BOOT_ACK_ERR_W<'a, const O: u8> =
    crate::BitWriter<'a, u16, ERROR_INT_STAT_R_SPEC, bool, O>;
impl R {
