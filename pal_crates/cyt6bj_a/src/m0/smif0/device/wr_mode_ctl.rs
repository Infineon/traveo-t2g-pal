...
pub type CODEH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WR_MODE_CTL_SPEC, u8, u8, 8, O>;
...
pub type DDR_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, WR_MODE_CTL_SPEC, bool, O>;
...
pub type PRESENT2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WR_MODE_CTL_SPEC, u8, u8, 2, O>;
impl R {
