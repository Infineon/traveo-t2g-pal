...
#[doc = "Field `CM7_ENABLE` reader - Enables the CM7_0 and CM7_1 and CM7_2 and CM7_3 AP interface: '0': Disabled. '1': Enabled."]
pub type CM7_ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `CM7_ENABLE` writer - Enables the CM7_0 and CM7_1 and CM7_2 and CM7_3 AP interface: '0': Disabled. '1': Enabled."]
pub type CM7_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, AP_CTL_SPEC, bool, O>;
...
#[doc = "Field `CM7_DISABLE` reader - Disables the CM7_0 and CM7_1 and CM7_2 and CM7_3 AP interface: '0': Enabled. '1': Disabled. Typically, this field is set by the Cypress boot code with information from eFUSE. The access port is only enabled when CM7_DISABLE is '0' and CM7_ENABLE is '1'."]
pub type CM7_DISABLE_R = crate::BitReader<bool>;
#[doc = "Field `CM7_DISABLE` writer - Disables the CM7_0 and CM7_1 and CM7_2 and CM7_3 AP interface: '0': Enabled. '1': Disabled. Typically, this field is set by the Cypress boot code with information from eFUSE. The access port is only enabled when CM7_DISABLE is '0' and CM7_ENABLE is '1'."]
pub type CM7_DISABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, AP_CTL_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 1 - Enables the CM7_0 and CM7_1 and CM7_2 and CM7_3 AP interface: '0': Disabled. '1': Enabled."]
    #[inline(always)]
    pub fn cm7_enable(&self) -> CM7_ENABLE_R {
        CM7_ENABLE_R::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    #[doc = "Bit 17 - Disables the CM7_0 and CM7_1 and CM7_2 and CM7_3 AP interface: '0': Enabled. '1': Disabled. Typically, this field is set by the Cypress boot code with information from eFUSE. The access port is only enabled when CM7_DISABLE is '0' and CM7_ENABLE is '1'."]
    #[inline(always)]
    pub fn cm7_disable(&self) -> CM7_DISABLE_R {
        CM7_DISABLE_R::new(((self.bits >> 17) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cm7_enable(&mut self) -> CM7_ENABLE_W<1> {
        CM7_ENABLE_W::new(self)
    }
    #[doc = "Bit 2 - Enables the system AP interface: '0': Disabled. '1': Enabled."]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn cm7_disable(&mut self) -> CM7_DISABLE_W<17> {
        CM7_DISABLE_W::new(self)
    }
    #[doc = "Bit 18 - Disables the system AP interface: '0': Enabled. '1': Disabled. Typically, this field is set by the Cypress boot code with information from eFUSE. The access port is only enabled when SYS_DISABLE is '0' and SYS_ENABLE is '1'."]
    #[inline(always)]
    #[must_use]
