...
#[doc = "Field `TCMC_CM7_2_MS` reader - Outstanding transactions from CM7 2. '0': There are no outstanding transactions to the CM7 I/D-TCM slave port (AHBS) from CM7 2. '1': There are outstanding transactions to the CM7 I/D-TCM slave port (AHBS) from CM7 2. Do not switch the CM7 power off."]
pub type TCMC_CM7_2_MS_R = crate::BitReader<bool>;
#[doc = "Field `TCMC_CM7_3_MS` reader - Outstanding transactions from CM7 3. '0': There are no outstanding transactions to the CM7 I/D-TCM slave port (AHBS) from CM7 3. '1': There are outstanding transactions to the CM7 I/D-TCM slave port (AHBS) from CM7 3. Do not switch the CM7 power off."]
pub type TCMC_CM7_3_MS_R = crate::BitReader<bool>;
impl R {
    ...
    #[doc = "Bit 16 - Outstanding transactions from CM7 2. '0': There are no outstanding transactions to the CM7 I/D-TCM slave port (AHBS) from CM7 2. '1': There are outstanding transactions to the CM7 I/D-TCM slave port (AHBS) from CM7 2. Do not switch the CM7 power off."]
    #[inline(always)]
    pub fn tcmc_cm7_2_ms(&self) -> TCMC_CM7_2_MS_R {
        TCMC_CM7_2_MS_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - Outstanding transactions from CM7 3. '0': There are no outstanding transactions to the CM7 I/D-TCM slave port (AHBS) from CM7 3. '1': There are outstanding transactions to the CM7 I/D-TCM slave port (AHBS) from CM7 3. Do not switch the CM7 power off."]
    #[inline(always)]
    pub fn tcmc_cm7_3_ms(&self) -> TCMC_CM7_3_MS_R {
        TCMC_CM7_3_MS_R::new(((self.bits >> 17) & 1) != 0)
    }
}
