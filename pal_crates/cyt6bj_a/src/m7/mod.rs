#![doc = "Peripheral access API for CYT6BJ microcontrollers (generated using svd2rust v0.28.0 (54a7f49 2023-02-14))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
unsafe impl Send for FLASHC1 {}
impl FLASHC1 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const flashc1::RegisterBlock = 0x4025_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const flashc1::RegisterBlock {
        Self::PTR
    }
}
impl Deref for FLASHC1 {
    type Target = flashc1::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
}
impl core::fmt::Debug for FLASHC1 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FLASHC1").finish()
    }
}
#[doc = "Flash controller"]
pub mod flashc1;
...
impl TCPWM1 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const tcpwm0::RegisterBlock = 0x4058_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const tcpwm0::RegisterBlock {
        Self::PTR
...
unsafe impl Send for ETH1 {}
impl ETH1 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const eth0::RegisterBlock = 0x4049_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const eth0::RegisterBlock {
        Self::PTR
...
impl core::fmt::Debug for ETH1 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ETH1").finish()
    }
}
#[doc = "Ethernet Interface"]
pub use self::eth0 as eth1;
#[doc = "LIN"]
pub struct LIN0 {
    _marker: PhantomData<*const ()>,
}
...
#[doc = "FlexRay Bus Interface"]
pub struct FLEXRAY0 {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for FLEXRAY0 {}
impl FLEXRAY0 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const flexray0::RegisterBlock = 0x4056_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const flexray0::RegisterBlock {
        Self::PTR
    }
}
impl Deref for FLEXRAY0 {
    type Target = flexray0::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
}
impl core::fmt::Debug for FLEXRAY0 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FLEXRAY0").finish()
    }
}
#[doc = "FlexRay Bus Interface"]
pub mod flexray0;
...
impl I2S0 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const i2s0::RegisterBlock = 0x4080_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
impl I2S1 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const i2s0::RegisterBlock = 0x4080_1000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const i2s0::RegisterBlock {
        Self::PTR
...
impl I2S2 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const i2s0::RegisterBlock = 0x4080_2000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const i2s0::RegisterBlock {
        Self::PTR
